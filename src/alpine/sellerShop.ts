...
const MOCK_CATEGORIES = [
  { name: 'karton-kutular', category_name: 'Karton Kutular', image: 'https://picsum.photos/seed/cat1/400/300' },
  { name: 'hediye-kutulari', category_name: 'Hediye Kutulari', image: 'https://picsum.photos/seed/cat2/400/300' },
  { name: 'ambalaj-malzemeleri', category_name: 'Ambalaj Malzemeleri', image: 'https://picsum.photos/seed/cat3/400/300' },
  { name: 'kagit-cantalar', category_name: 'Kagit Cantalar', image: 'https://picsum.photos/seed/cat4/400/300' },
];

const MOCK_PRODUCTS = [
  { name: 'p1', product_name: 'Ozel Tasarim Cevre Dostu Tisortler icin Karton Kutu', image: 'https://picsum.photos/seed/prod1/400/400', price_min: '7.35', price_max: '17.50', moq: 100, moq_unit: 'Adet', category: 'karton-kutular', sold_count: 40 },
  { name: 'p2', product_name: 'Ozellestirelmis Karton Sapka Ekran Standi', image: 'https://picsum.photos/seed/prod2/400/400', price_min: '6.35', price_max: '17.50', moq: 100, moq_unit: 'Adet', category: 'karton-kutular', sold_count: 28 },
  { name: 'p3', product_name: 'Raf Hazir Kutu Goz Yasi Uzakta Ambalaj Kagidi', image: 'https://picsum.photos/seed/prod3/400/400', price_min: '0.38', price_max: '1.02', moq: 100, moq_unit: 'Adet', category: 'ambalaj-malzemeleri', sold_count: 0, view_count: 18 },
  { name: 'p4', product_name: 'Ozel Tasarim Geri Donusturulebilir Kancali Kutu', image: 'https://picsum.photos/seed/prod4/400/400', price_min: '7.35', price_max: '17.50', moq: 100, moq_unit: 'Adet', category: 'karton-kutular', sold_count: 62 },
  { name: 'p5', product_name: 'Tebrik Karti Ozel Baski Karton Hediye Kutusu', image: 'https://picsum.photos/seed/prod5/400/400', price_min: '5.35', price_max: '12.00', moq: 100, moq_unit: 'Adet', category: 'hediye-kutulari', sold_count: 15 },
  { name: 'p6', product_name: 'Luks Kraft Kagit Alisveris Cantasi', image: 'https://picsum.photos/seed/prod6/400/400', price_min: '1.20', price_max: '3.50', moq: 500, moq_unit: 'Adet', category: 'kagit-cantalar', sold_count: 88 },
  { name: 'p7', product_name: 'Kucuk Beyaz Karton Posta Kutusu', image: 'https://picsum.photos/seed/prod7/400/400', price_min: '0.55', price_max: '1.80', moq: 200, moq_unit: 'Adet', category: 'karton-kutular', sold_count: 33 },
  { name: 'p8', product_name: 'Cevre Dostu Geri Donusum Ambalaj Dolgusu', image: 'https://picsum.photos/seed/prod8/400/400', price_min: '0.10', price_max: '0.45', moq: 1000, moq_unit: 'Adet', category: 'ambalaj-malzemeleri', sold_count: 120 },
];
...
Alpine.data('sellerShop', () => ({
  ...
  layout: { sections: DEFAULT_SECTIONS, theme: {} } as { sections: any[]; theme: Record<string, any> },
  categories: [] as any[],
  products: [] as any[],
    ...
    if (this.sellerCode) {
      try {
        const [sellerRes, layoutRes, catRes, prodRes] = await Promise.all([
          fetch(`${API_BASE}/method/tradehub_core.api.seller.get_seller?slug=${this.sellerCode}`, { credentials: 'omit' }).then(r => r.json()),
          fetch(`${API_BASE}/method/tradehub_core.api.seller.get_storefront_layout?seller_code=${this.sellerCode}`, { credentials: 'omit' }).then(r => r.json()).catch(() => null),
          fetch(`${API_BASE}/method/tradehub_core.api.seller.get_seller_categories?seller_code=${this.sellerCode}`, { credentials: 'omit' }).then(r => r.json()).catch(() => ({ message: [] })),
          fetch(`${API_BASE}/method/tradehub_core.api.seller.get_seller_products?seller_code=${this.sellerCode}&page_size=50`, { credentials: 'omit' }).then(r => r.json()).catch(() => ({ message: { products: [] } })),
        ]);
  ...
  _loadMockData() {
    ...
    this.layout = { sections: DEFAULT_SECTIONS, theme: { primaryColor: '#1e3a5f', accentColor: '#cc9900', navBgColor: '#1f1f1f', navTextColor: '#ffffff' } };
  },
  ...
  sortProducts() {
    ...
    switch (this.sortBy) {
      case 'price_asc':
        sorted.sort((a: any, b: any) => parseFloat(a.price_min || '0') - parseFloat(b.price_min || '0'));
        break;
      case 'price_desc':
        sorted.sort((a: any, b: any) => parseFloat(b.price_min || '0') - parseFloat(a.price_min || '0'));
        break;
      case 'newest':
