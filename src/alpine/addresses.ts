...
const MOCK_ADDRESSES: BuyerAddress[] = [
  {
    id: "ADR-1",
    title: "Merkez Depo",
    contact_name: "Ahmet Şeker",
    company: "Türksab Elektronik Toptan Dağıtım Sanayi ve Ticaret Ltd. Şti.",
    phone_prefix: "+90",
    phone: "532 123 45 67",
    country: "Türkiye",
    state: "İstanbul",
    city: "Bağcılar",
    street: "İSTOÇ Ticaret Merkezi 23. Ada No: 145-147, Mahmutbey Mahallesi, 2. Kısım Sokak",
    apartment: "Kat 2, Depo B",
    postal_code: "34218",
    note: "Mesai saatleri içinde teslimat, kapıda güvenliğe haber verin",
    is_default: true,
  ...
  {
    id: "ADR-2",
    title: "Şube — Bayrampaşa",
    contact_name: "Zeynep Demir",
    company: "Türksab Elektronik",
    phone_prefix: "+90",
    phone: "212 555 00 11",
    country: "Türkiye",
    state: "İstanbul",
    city: "Bayrampaşa",
    street: "Terazidere Mah. Vatan Cad. No: 12",
    apartment: "",
    postal_code: "34035",
    note: "",
    is_default: false,
  ...
  },
  {
    ...
    state: "Ankara",
    city: "Çankaya",
    street: "Birlik Mah. 448. Cad. No: 8",
    apartment: "Daire 14",
    postal_code: "06610",
    note: "",
    is_default: false,
  ...
  {
    id: "ADR-4",
    title: "İzmir Bölge Deposu ve Sevkiyat Noktası",
    contact_name: "Mehmet Ali Karaosmanoğlu",
    company: "Ege Dağıtım A.Ş.",
    phone_prefix: "+90",
    phone: "232 444 22 33",
    country: "Türkiye",
    state: "İzmir",
    city: "Bornova",
    street:
      "Ege Serbest Bölgesi, Akçay Cad. No: 144/1, Gaziemir yolu üzeri lojistik depolar bölgesi",
    apartment: "Antrepo 7",
    postal_code: "35410",
    note: "Sadece hafta içi 09:00-17:00 arası kabul",
    is_default: false,
    address_type: "Business",
    tax_no: "9876543210",
    tax_office: "Bornova",
