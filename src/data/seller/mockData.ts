...
function getSeller(): SellerProfile {
  return {
    ...
    mainCategories: [
      t("sellerMock.catElectricMeters"),
      t("sellerMock.catWaterMeters"),
      t("sellerMock.catGasMeters"),
    ],
...
export function getNavData(): StoreNavData {
  return {
    items: [
      ...
      {
        label: t("sellerMock.navProducts"),
        href: "#products",
        isActive: false,
        dropdownType: "products",
      },
      {
        label: t("sellerMock.navCompanyProfile"),
        href: "#company",
        isActive: false,
...
function getCategoryCards(): CategoryCard[] {
  return [
    {
      id: "cat-1",
      name: t("sellerMock.cardPrepaidElectric"),
      bgColor: "#d4e157",
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
    },
    {
      id: "cat-2",
      name: t("sellerMock.cardSmartElectric"),
      bgColor: "#90caf9",
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
    },
    {
      id: "cat-3",
      name: t("sellerMock.cardIndustrialEnergy"),
      bgColor: "#bdbdbd",
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
    },
    {
      id: "cat-4",
      name: t("sellerMock.cardUltrasonicWater"),
      bgColor: "#80deea",
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
    },
    {
      id: "cat-5",
      name: t("sellerMock.cardMechanicalWater"),
      bgColor: "#a5d6a7",
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
    },
    {
      id: "cat-6",
      name: t("sellerMock.cardGasMeters"),
      bgColor: "#ffcc80",
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
    },
    {
      id: "cat-7",
      name: t("sellerMock.cardSpareParts"),
      bgColor: "#f48fb1",
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
    },
...
function getHotProducts(): SimpleProduct[] {
  return [
    ...
    {
      id: "hp-4",
      name: t("sellerMock.hp4"),
      image:
        "https://images.unsplash.com/photo-1627964434947-d5ab70b8c66e?q=80&w=400&auto=format&fit=crop",
      link: "/pages/product-detail.html",
    },
    {
      id: "hp-5",
      name: t("sellerMock.hp5"),
      image:
        "https://images.unsplash.com/photo-1631541909061-71e34ddce158?q=80&w=400&auto=format&fit=crop",
      link: "/pages/product-detail.html",
    },
    {
      id: "hp-6",
      name: t("sellerMock.hp6"),
      image:
        "https://images.unsplash.com/photo-1582046426742-b06f8c792ea8?q=80&w=400&auto=format&fit=crop",
      link: "/pages/product-detail.html",
    },
    {
      id: "hp-7",
      name: t("sellerMock.hp7"),
      image:
    ...
    {
      id: "hp-9",
      name: t("sellerMock.hp9"),
      image:
        "https://images.unsplash.com/photo-1581092335878-2d9ff86ca2bf?q=80&w=400&auto=format&fit=crop",
      link: "/pages/product-detail.html",
    },
  ];
}
  ...
  return [
    {
      ...
      products: [
        {
          id: "clp-1",
          name: t("sellerMock.clp1"),
          image:
            "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
          hasVideo: true,
          badges: [
            { type: "main-product", label: t("sellerMock.badgeMainProduct") },
            { type: "certified", label: t("sellerMock.badgeCeCertified") },
          ],
          priceMin: 18.5,
          priceMax: 24.0,
          moq: 500,
          moqUnit: t("sellerMock.moqUnit"),
          soldCount: 28212,
          link: "/pages/product-detail.html",
        },
        {
          id: "clp-2",
          name: t("sellerMock.clp2"),
          image:
            "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
          hasVideo: false,
          badges: [{ type: "certified", label: t("sellerMock.badgeIecApproved") }],
          priceMin: 32.0,
          priceMax: 45.0,
          moq: 300,
          moqUnit: t("sellerMock.moqUnit"),
        ...
        {
          id: "clp-3",
          name: t("sellerMock.clp3"),
          image:
            "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
          hasVideo: true,
          badges: [{ type: "main-product", label: t("sellerMock.badgeMainProduct") }],
          priceMin: 22.0,
          priceMax: 28.5,
          moq: 500,
          moqUnit: t("sellerMock.moqUnit"),
        ...
        {
          id: "clp-5",
          name: t("sellerMock.clp5"),
          image:
            "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
          hasVideo: true,
          badges: [{ type: "certified", label: t("sellerMock.badgeDlms") }],
          priceMin: 28.0,
          priceMax: 36.0,
          moq: 300,
          moqUnit: t("sellerMock.moqUnit"),
    ...
    },
    {
      ...
      products: [
        {
          id: "clp-9",
          name: t("sellerMock.clp9"),
          image:
            "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
          hasVideo: true,
          badges: [
            { type: "main-product", label: t("sellerMock.badgeMainProduct") },
            { type: "certified", label: t("sellerMock.badgeMidApproved") },
          ],
          priceMin: 42.0,
          priceMax: 58.0,
          moq: 200,
        ...
        {
          id: "clp-12",
          name: t("sellerMock.clp12"),
          image:
            "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
          hasVideo: false,
          badges: [{ type: "certified", label: t("sellerMock.badgeCeCertified") }],
          priceMin: 25.0,
          priceMax: 35.0,
          moq: 300,
          moqUnit: t("sellerMock.moqUnit"),
        ...
        {
          id: "clp-13",
          name: t("sellerMock.clp13"),
          image:
            "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
          hasVideo: true,
          badges: [
            { type: "main-product", label: t("sellerMock.badgeMainProduct") },
            { type: "certified", label: t("sellerMock.badgeIp68") },
          ],
          priceMin: 55.0,
          priceMax: 78.0,
          moq: 200,
        ...
        {
          id: "clp-15",
          name: t("sellerMock.clp15"),
          image:
            "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
          hasVideo: true,
          badges: [{ type: "certified", label: t("sellerMock.badgeMidApproved") }],
          priceMin: 85.0,
          priceMax: 120.0,
          moq: 100,
          moqUnit: t("sellerMock.moqUnit"),
    ...
    factoryPhotos: [
      {
        ...
        image:
          "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
        caption: t("sellerMock.fpProductionLine"),
      },
      {
        id: "fp-2",
        image:
          "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
        caption: t("sellerMock.fpQualityLab"),
      },
      {
        id: "fp-3",
        image:
          "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
        caption: t("sellerMock.fpAssemblyWorkshop"),
      },
    ],
    carouselPhotos: [
      {
        ...
        image:
          "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
        caption: t("sellerMock.cpInnovationPark"),
      },
      {
        id: "cp-2",
        image:
          "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
        caption: t("sellerMock.cpAutoProductionLine"),
      },
      {
        id: "cp-3",
        image:
          "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
        caption: t("sellerMock.cpRdCenter"),
      },
    ],
    locations: [
      {
        id: "loc-1",
        name: t("sellerMock.locHQ"),
        image:
          "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
      },
      {
        id: "loc-2",
        name: t("sellerMock.locRegional"),
        image:
          "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
      },
      {
        id: "loc-3",
        name: t("sellerMock.locFactory"),
        image:
          "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
      },
      {
        id: "loc-4",
        name: t("sellerMock.locWarehouse"),
        image:
          "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
      },
    ],
...
function getCertificates(): Certificate[] {
  return [
    {
      id: "cert-1",
      name: t("sellerMock.cert1"),
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
    },
    {
      id: "cert-2",
      name: t("sellerMock.cert2"),
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
    },
    {
      id: "cert-3",
      name: t("sellerMock.cert3"),
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
    },
    {
      id: "cert-4",
      name: t("sellerMock.cert4"),
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
    },
    {
      id: "cert-5",
      name: t("sellerMock.cert5"),
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
    },
    {
      id: "cert-6",
      name: t("sellerMock.cert6"),
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
    },
    {
      id: "cert-7",
      name: t("sellerMock.cert7"),
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
    },
    {
      id: "cert-8",
      name: t("sellerMock.cert8"),
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
    },
  ];
  ...
  return [
    {
      id: "adv-1",
      icon: "shield-check",
      title: t("sellerMock.advSecurity"),
      description: t("sellerMock.advSecurityDesc"),
    },
    {
      id: "adv-2",
      icon: "certificate",
      title: t("sellerMock.advQuality"),
      description: t("sellerMock.advQualityDesc"),
    },
    {
      id: "adv-3",
      icon: "lightbulb",
      title: t("sellerMock.advInnovation"),
      description: t("sellerMock.advInnovationDesc"),
    },
    {
      id: "adv-4",
      icon: "headset",
      title: t("sellerMock.advService"),
      description: t("sellerMock.advServiceDesc"),
    },
...
function getCompanyInfoCells(): CompanyInfoCell[] {
  return [
    {
      icon: "globe",
      label: t("sellerMock.ciCountry"),
      value: t("sellerMock.ciCountryVal"),
      verified: true,
    },
    { icon: "calendar", label: t("sellerMock.ciEstablished"), value: "2004", verified: true },
    {
      icon: "factory",
      label: t("sellerMock.ciBusinessType"),
      value: t("sellerMock.ciBusinessTypeVal"),
      verified: true,
    },
    {
      icon: "box",
      label: t("sellerMock.ciMainProducts"),
      value: t("sellerMock.ciMainProductsVal"),
      verified: true,
    },
    {
      icon: "map",
      label: t("sellerMock.ciMainMarkets"),
      value: t("sellerMock.ciMainMarketsVal"),
      verified: true,
    },
    {
      icon: "chart",
      label: t("sellerMock.ciAnnualRevenue"),
      value: t("sellerMock.ciAnnualRevenueVal"),
      verified: true,
    },
  ];
}
  ...
  return [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
      caption: t("sellerMock.cipFactoryOverview"),
      hasVideo: true,
    },
    {
      id: "cip-2",
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
      caption: t("sellerMock.cipProductionLine"),
      hasVideo: false,
    },
    {
      id: "cip-3",
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
      caption: t("sellerMock.cipWarehouse"),
      hasVideo: false,
    },
    {
      id: "cip-4",
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
      caption: t("sellerMock.cipShowroom"),
      hasVideo: false,
    },
  ];
}
  ...
  return [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
      caption: t("sellerMock.galAutoAssembly"),
    },
    {
      id: "gal-2",
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
      caption: t("sellerMock.galQcLab"),
    },
    {
      id: "gal-3",
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
      caption: t("sellerMock.galRawStorage"),
    },
    {
      id: "gal-4",
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
      caption: t("sellerMock.galPackaging"),
    },
    {
      id: "gal-5",
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
      caption: t("sellerMock.galRdCenter"),
    },
    {
      id: "gal-6",
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
      caption: t("sellerMock.galAdminBuilding"),
    },
    {
      id: "gal-7",
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
      caption: t("sellerMock.galCalibration"),
    },
    {
      id: "gal-8",
      image:
        "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&h=600&q=80",
      caption: t("sellerMock.galShipping"),
    },
  ];
}
