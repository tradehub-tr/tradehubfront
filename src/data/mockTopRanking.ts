  ...
  return [
    // Consumer Electronics
    {
      ...
      products: [
        {
          id: "rp-1",
          name: "5G Gaming Smartphone 12GB RAM",
        ...
        {
          id: "rp-2",
          name: "Pro Gaming Phone 144Hz Display",
          href: "/pages/product-detail.html",
          price: "$245.00",
          imageSrc:
            "https://images.unsplash.com/photo-1592899677977-9c10ca588bbd?w=400&h=400&fit=crop&q=80",
          moq: "3 pcs",
          rank: 2,
        },
        {
          id: "rp-3",
          name: "Budget Gaming Phone Octa Core",
          href: "/pages/product-detail.html",
          price: "$128.00",
          imageSrc:
            "https://images.unsplash.com/photo-1598327105666-5b89351aff97?w=400&h=400&fit=crop&q=80",
          moq: "10 pcs",
          rank: 3,
        },
      ],
    },
    {
      ...
      products: [
        {
          id: "rp-4",
          name: "RGB Gaming Speaker 2.1 System",
          href: "/pages/product-detail.html",
          price: "$32.50",
          imageSrc:
        ...
        {
          id: "rp-5",
          name: "Portable Gaming Bluetooth Speaker",
          href: "/pages/product-detail.html",
          price: "$18.90",
          imageSrc:
        ...
        {
          id: "rp-6",
          name: "Surround Sound Gaming Soundbar",
          href: "/pages/product-detail.html",
          price: "$45.00",
          imageSrc:
            "https://images.unsplash.com/photo-1558537348-c0f8e733989d?w=400&h=400&fit=crop&q=80",
          moq: "5 pcs",
          rank: 3,
        },
      ],
    },
    {
      ...
      products: [
        {
          id: "rp-7",
          name: "LED Neon Sign Custom Logo",
          href: "/pages/product-detail.html",
          price: "$15.80",
          imageSrc:
        ...
        {
          id: "rp-8",
          name: "Digital Menu Board Display",
          href: "/pages/product-detail.html",
          price: "$89.00",
          imageSrc:
        ...
        {
          id: "rp-9",
          name: "Outdoor LED Advertising Panel",
          href: "/pages/product-detail.html",
          price: "$120.00",
          imageSrc:
            "https://images.unsplash.com/photo-1542744173-05336fcc7ad4?w=400&h=400&fit=crop&q=80",
          moq: "1 pcs",
          rank: 3,
        },
      ],
    ...
    // Jewelry & Eyewear
    {
      ...
      products: [
        ...
        {
          id: "rp-11",
          name: "Gold Plated Beaded Bracelet",
          href: "/pages/product-detail.html",
          price: "$1.95",
          imageSrc:
    ...
    },
    {
      ...
      products: [
        {
          id: "rp-13",
          name: "Crystal Flower Brooch Pin",
          href: "/pages/product-detail.html",
          price: "$1.20",
          imageSrc:
    ...
    // Luggage, Bags & Cases
    {
      ...
      products: [
        ...
        {
          id: "rp-17",
          name: "Printed Satin Care Labels",
          href: "/pages/product-detail.html",
          price: "$0.03",
          imageSrc:
        ...
        {
          id: "rp-18",
          name: "Heat Transfer Label Rolls",
          href: "/pages/product-detail.html",
          price: "$0.08",
          imageSrc:
      ...
      products: [
        {
          ...
          price: "$2.50",
          imageSrc:
            "https://images.unsplash.com/photo-1588850561407-ed78c334e67a?w=400&h=400&fit=crop&q=80",
          moq: "50 pcs",
          rank: 1,
        },
        {
          id: "rp-20",
          name: "Vintage Washed Dad Hat",
          href: "/pages/product-detail.html",
          price: "$1.80",
          imageSrc:
            "https://images.unsplash.com/photo-1521369909029-2afed882baee?w=400&h=400&fit=crop&q=80",
          moq: "100 pcs",
          rank: 2,
        },
        {
          id: "rp-21",
          name: "Snapback Trucker Mesh Cap",
          href: "/pages/product-detail.html",
          price: "$1.50",
          imageSrc:
    ...
    },
    {
      ...
      products: [
        {
          id: "rp-22",
          name: "Woven Brand Labels Damask",
          href: "/pages/product-detail.html",
          price: "$0.04",
          imageSrc:
        ...
        {
          id: "rp-24",
          name: "Rubber Silicone Logo Labels",
          href: "/pages/product-detail.html",
          price: "$0.08",
          imageSrc:
            "https://images.unsplash.com/photo-1588345921523-c2dcdb7f1dcd?w=400&h=400&fit=crop&q=80",
    ...
    // Sports & Entertainment
    {
      ...
      products: [
        {
          id: "rp-25",
          name: "Composite Ice Hockey Stick",
          href: "/pages/product-detail.html",
          price: "$12.50",
          imageSrc:
            "https://images.unsplash.com/photo-1515703407324-5f753afd8be8?w=400&h=400&fit=crop&q=80",
          moq: "10 pcs",
          rank: 1,
        },
        {
          id: "rp-26",
          name: "Field Hockey Training Ball Set",
          href: "/pages/product-detail.html",
          price: "$3.20",
          imageSrc:
        ...
        {
          id: "rp-27",
          name: "Hockey Goalkeeper Gloves",
          href: "/pages/product-detail.html",
          price: "$8.90",
          imageSrc:
            "https://images.unsplash.com/photo-1461896836934-bd45ba8bfb5f?w=400&h=400&fit=crop&q=80",
          moq: "20 pcs",
          rank: 3,
        },
      ],
    ...
    // Home & Garden
    {
      ...
      products: [
        {
          id: "rp-28",
          name: "Universal LED Tail Light Bar",
          href: "/pages/product-detail.html",
          price: "$8.50",
          imageSrc:
        ...
        {
          id: "rp-29",
          name: "Amber Turn Signal LED Strip",
          href: "/pages/product-detail.html",
          price: "$3.20",
          imageSrc:
        ...
        {
          id: "rp-30",
          name: "Round LED Marker Light 12V",
          href: "/pages/product-detail.html",
          price: "$1.50",
          imageSrc:
    ...
    },
    {
      ...
      products: [
        ...
        {
          id: "rp-32",
          name: "Wireless Soundbar with Sub",
          href: "/pages/product-detail.html",
          price: "$42.00",
          imageSrc:
            "https://images.unsplash.com/photo-1545454675-3531b543be5d?w=400&h=400&fit=crop&q=80",
        ...
        {
          id: "rp-33",
          name: "Bluetooth Home Theater Speaker",
          href: "/pages/product-detail.html",
          price: "$28.50",
          imageSrc:
            "https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=400&h=400&fit=crop&q=80",
    ...
    // Gifts & Crafts
    {
      ...
      products: [
        {
          id: "rp-34",
          name: "Press On Nails Set Glossy",
          href: "/pages/product-detail.html",
          price: "$1.20",
          imageSrc:
        ...
        {
          id: "rp-36",
          name: "Coffin Shape Acrylic Nails",
          href: "/pages/product-detail.html",
          price: "$0.80",
          imageSrc:
    ...
    },
    {
      ...
      products: [
        ...
        {
          id: "rp-38",
          name: "Hyaluronic Acid Moisturizing",
          href: "/pages/product-detail.html",
          price: "$2.30",
          imageSrc:
            "https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=400&h=400&fit=crop&q=80",
    ...
    // More Consumer Electronics
    {
      ...
      products: [
        {
          id: "rp-40",
          name: "Mini PC Intel N100 16GB",
          href: "/pages/product-detail.html",
          price: "$125.00",
          imageSrc:
            "https://images.unsplash.com/photo-1593062096033-9a26b09da705?w=400&h=400&fit=crop&q=80",
          moq: "2 pcs",
          rank: 1,
        },
        {
          id: "rp-41",
          name: "Stick PC Windows 11 4GB",
          href: "/pages/product-detail.html",
          price: "$68.00",
          imageSrc:
        ...
        {
          id: "rp-42",
          name: "Fanless Desktop Mini Computer",
          href: "/pages/product-detail.html",
          price: "$95.00",
          imageSrc:
            "https://images.unsplash.com/photo-1587831990711-23ca6441447b?w=400&h=400&fit=crop&q=80",
          moq: "3 pcs",
          rank: 3,
        },
      ],
    },
    {
      ...
      products: [
        {
          id: "rp-43",
          name: '14" Student Laptop 8GB RAM',
          href: "/pages/product-detail.html",
          price: "$185.00",
          imageSrc:
        ...
        {
          id: "rp-44",
          name: 'Chromebook 11.6" Education',
          href: "/pages/product-detail.html",
          price: "$135.00",
          imageSrc:
            "https://images.unsplash.com/photo-1525547719571-a2d4ac8945e2?w=400&h=400&fit=crop&q=80",
          moq: "5 pcs",
          rank: 2,
        },
        {
    ...
    },
    {
      ...
      products: [
        ...
        },
        {
          ...
          price: "$45.00",
          imageSrc:
            "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=400&h=400&fit=crop&q=80",
          moq: "5 pcs",
          rank: 2,
        },
        {
          id: "rp-48",
          name: "4G LTE Wireless Router",
          href: "/pages/product-detail.html",
          price: "$22.00",
          imageSrc:
            "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=400&h=400&fit=crop&q=80",
          moq: "10 pcs",
          rank: 3,
        },
      ],
    },
    {
      ...
      products: [
        {
          id: "rp-49",
          name: "20000mAh PD Fast Charge",
          href: "/pages/product-detail.html",
          price: "$6.80",
          imageSrc:
            "https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?w=400&h=400&fit=crop&q=80",
          moq: "20 pcs",
          rank: 1,
        },
        {
          ...
          price: "$9.50",
          imageSrc:
            "https://images.unsplash.com/photo-1585338107529-13afc5f02586?w=400&h=400&fit=crop&q=80",
          moq: "10 pcs",
          rank: 2,
        },
        {
          id: "rp-51",
          name: "Slim Wireless Charging Bank",
          href: "/pages/product-detail.html",
          price: "$8.20",
          imageSrc:
    ...
    // Medical / Home
    {
      ...
      products: [
        ...
        {
          id: "rp-53",
          name: "Infrared Ear Thermometer",
          href: "/pages/product-detail.html",
          price: "$4.50",
          imageSrc:
            "https://images.unsplash.com/photo-1584515933487-779824d29309?w=400&h=400&fit=crop&q=80",
          moq: "20 pcs",
          rank: 2,
        },
        {
