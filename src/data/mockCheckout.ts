...
export const infoBoxBullets = [
  {
    ...
    description:
      "Place and pay for your order directly through iSTOC.com to enjoy full protection.",
  },
  {
    dotColor: "#22c55e",
    title: "When supplier drafts an order for you:",
    description:
      "Review the order details carefully before confirming and paying through iSTOC.com.",
  },
];
