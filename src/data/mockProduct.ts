...
export function getMockProduct(): ProductDetail {
  return {
    ...
    priceTiers: [
      { minQty: 1, maxQty: 99, price: 12.0, currency: "USD" },
      { minQty: 100, maxQty: 499, price: 10.0, currency: "USD" },
      { minQty: 500, maxQty: null, price: 8.5, currency: "USD" },
    ],
    moq: 1,
    ...
    shipping: [
      {
        method: t("mockProduct.shipDhl"),
        estimatedDays: t("mockProduct.shipDhlDays"),
        cost: "$45.00",
      },
      {
        method: t("mockProduct.shipAir"),
        estimatedDays: t("mockProduct.shipAirDays"),
        cost: "$28.00",
      },
      {
        method: t("mockProduct.shipSea"),
        estimatedDays: t("mockProduct.shipSeaDays"),
        cost: "$12.00",
      },
    ],
    variants: [
      {
        ...
        options: [
          {
            id: "gold",
            label: t("mockProduct.varGold"),
            value: "#D4AF37",
            available: true,
            thumbnail:
              "https://images.unsplash.com/photo-1515562141589-67f0d569b6f5?w=120&h=120&fit=crop&q=80",
          },
          {
            id: "silver",
            label: t("mockProduct.varSilver"),
            value: "#C0C0C0",
            available: true,
            thumbnail:
              "https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=120&h=120&fit=crop&q=80",
          },
          {
            id: "rosegold",
            label: t("mockProduct.varRoseGold"),
            value: "#B76E79",
            available: true,
            thumbnail:
              "https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=120&h=120&fit=crop&q=80",
          },
          {
            id: "black",
            label: t("mockProduct.varBlack"),
            value: "#2D2D2D",
            available: false,
            thumbnail:
              "https://images.unsplash.com/photo-1573408301185-9146fe634ad0?w=120&h=120&fit=crop&q=80",
          },
        ],
      },
      {
  ...
  `,
    ...
    reviews: [
      ...
      },
      {
        ...
        tags: [
          t("mockProduct.tagQuality"),
          t("mockProduct.tagGoodSupplier"),
          t("mockProduct.tagProfessional"),
        ],
    ...
    customizationOptions: [
      {
        name: t("mockProduct.custMaterial"),
        priceAddon: t("mockProduct.custMaterialAddon"),
        minOrder: t("mockProduct.custMaterialMin"),
      },
    ],
