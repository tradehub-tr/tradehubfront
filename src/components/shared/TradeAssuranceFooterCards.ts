/**
 * Trade Assurance Footer Cards — Shared component
...
const iconVideo = `<svg width="48" height="48" viewBox="0 0 48 48" fill="none"><circle cx="24" cy="24" r="24" fill="#FFC200"/><g transform="translate(7.3,7)"><path d="M27.47 4.878l1.417 5.286-15.477 4.056 15.661-.001v13.292c0 1.295-1.052 2.345-2.349 2.345H7.15c-1.297 0-2.349-1.05-2.349-2.345V14.22h.002L4.005 11.147c-.324-1.248.42-2.523 1.666-2.857L24.595 3.22c1.253-.336 2.54.406 2.876 1.658ZM26.723 21.647H7.15v5.864h19.573v-5.864ZM12.54 16.565H7.15v2.737h4.427l-.085-.032 1.048-2.705Zm14.183 0h-4.618l-1.061 2.737h5.679v-2.737Zm-7.136 0h-4.528l-1.061 2.737h4.625l-.085-.032 1.049-2.705Zm5.615-11.08L6.278 10.557l.756 2.91 18.973-4.973-.806-3.008Z" fill="#222" fill-rule="nonzero"/></g></svg>`
