...
export function PromotionBanner({
  ...
  return `
    <a href="${escapeHtml(sanitizeUrl(href))}" class="block rounded-lg overflow-hidden [@media(hover:hover)_and_(pointer:fine)]:hover:shadow-sm transition-shadow" style="background-color: ${safeHexColor(bgColor, "#ffffff")}">
