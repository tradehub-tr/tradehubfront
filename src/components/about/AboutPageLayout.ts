      ...
      <div class="max-w-[900px] mx-auto px-4 sm:px-6">
        ...
        <div class="relative">
          ...
          ${[
            {
              year: "2010",
              title: t("about.timeline2010Title"),
              desc: t("about.timeline2010Desc"),
            },
            {
              year: "2013",
              title: t("about.timeline2013Title"),
              desc: t("about.timeline2013Desc"),
            },
            {
              year: "2016",
              title: t("about.timeline2016Title"),
              desc: t("about.timeline2016Desc"),
            },
            {
              year: "2019",
              title: t("about.timeline2019Title"),
              desc: t("about.timeline2019Desc"),
            },
            {
              year: "2022",
              title: t("about.timeline2022Title"),
              desc: t("about.timeline2022Desc"),
            },
            {
              year: "2024",
              title: t("about.timeline2024Title"),
              desc: t("about.timeline2024Desc"),
            },
            {
              year: "2026",
              title: t("about.timeline2026Title"),
              desc: t("about.timeline2026Desc"),
            },
          ]
            .map(
              (item) => `
