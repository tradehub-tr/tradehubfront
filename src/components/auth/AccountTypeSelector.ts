...
export function AccountTypeSelector(
  ...
  return `
    <div id="account-type-selector" class="auth-account-type-grid flex flex-col gap-3">
      ...
      <button
        type="button"
        class="auth-account-type-card flex items-center gap-3.5 w-full py-4 px-[18px] rounded-md text-start relative cursor-pointer transition-[border-color,box-shadow,background-color] duration-150 ease-out motion-reduce:transition-none border-[1.5px] border-[var(--color-border-default,#e5e5e5)] bg-[var(--color-surface,#fff)] before:content-[''] before:shrink-0 before:w-5 before:h-5 before:border-2 before:border-[var(--color-border-medium,#d1d5db)] before:rounded-full before:transition-[border-color,box-shadow] before:duration-150 before:ease-[cubic-bezier(0.23,1,0.32,1)] before:motion-reduce:transition-none hover:border-[var(--color-border-medium,#d1d5db)] hover:bg-[var(--color-surface-muted,#fafafa)] focus-visible:outline-2 focus-visible:outline-[var(--color-cta-primary,#cc9900)] focus-visible:outline-offset-2 [&.selected]:border-[#1f2937] [&.selected]:shadow-[0_0_0_1px_#1f2937] [&.selected]:before:border-[#1f2937] [&.selected]:before:shadow-[inset_0_0_0_5px_#1f2937] [&.selected]:hover:bg-[var(--color-surface,#fff)]${defaultType === "buyer" ? " selected" : ""}${buyerLocked ? lockedClasses : ""}"
      ...
      <button
        type="button"
        class="auth-account-type-card flex items-center gap-3.5 w-full py-4 px-[18px] rounded-md text-start relative cursor-pointer transition-[border-color,box-shadow,background-color] duration-150 ease-out motion-reduce:transition-none border-[1.5px] border-[var(--color-border-default,#e5e5e5)] bg-[var(--color-surface,#fff)] before:content-[''] before:shrink-0 before:w-5 before:h-5 before:border-2 before:border-[var(--color-border-medium,#d1d5db)] before:rounded-full before:transition-[border-color,box-shadow] before:duration-150 before:ease-[cubic-bezier(0.23,1,0.32,1)] before:motion-reduce:transition-none hover:border-[var(--color-border-medium,#d1d5db)] hover:bg-[var(--color-surface-muted,#fafafa)] focus-visible:outline-2 focus-visible:outline-[var(--color-cta-primary,#cc9900)] focus-visible:outline-offset-2 [&.selected]:border-[#1f2937] [&.selected]:shadow-[0_0_0_1px_#1f2937] [&.selected]:before:border-[#1f2937] [&.selected]:before:shadow-[inset_0_0_0_5px_#1f2937] [&.selected]:hover:bg-[var(--color-surface,#fff)]${defaultType === "supplier" ? " selected" : ""}${supplierLocked ? lockedClasses : ""}"
