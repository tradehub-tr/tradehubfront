  ...
  return /* html */ `
    <div class="relative flex flex-col gap-1.5 border-t border-[var(--color-border-light,#f0f0f0)] bg-white px-4 pt-2 pb-3 flex-shrink-0">
      ...
      <div class="relative flex min-h-[88px] flex-col rounded-lg border border-[var(--color-border-light,#f0f0f0)] bg-[var(--color-surface-muted,#fafafa)] px-3.5 py-3">
        <button type="button"
                class="absolute end-2 top-2 appearance-none border-0 bg-transparent p-1 cursor-pointer text-[var(--color-text-tertiary,#a3a3a3)] hover:text-[var(--color-text-primary,#0a0a0a)] focus:outline-none"
        ...
        <textarea
          ...
          class="flex-1 resize-none border-0 bg-transparent text-[13px] leading-snug text-[var(--color-text-primary,#0a0a0a)] placeholder:text-[var(--color-text-tertiary,#a3a3a3)] focus:outline-none pe-8"></textarea>
        ...
        <button type="button"
                ...
                :class="$store.chatPopup.draft.trim() && !$store.chatPopup.sending
                  ? 'bg-[var(--color-primary-500,#ff8600)] text-[var(--btn-text,#1a1a1a)] hover:bg-[var(--color-primary-600,#db7300)]'
