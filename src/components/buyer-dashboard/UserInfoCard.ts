...
export function UserInfoCard(props: UserInfoCardProps): string {
  ...
  return `
    <div class="relative p-[clamp(0.75rem,0.5rem+1vw,1.25rem)]" x-data="buyerUserInfo">
      ...
      <div class="absolute top-3 end-3 inline-flex items-center gap-1 text-[clamp(0.625rem,0.6rem+0.1vw,0.75rem)] font-medium text-blue-600 bg-blue-50 rounded-md px-2 py-1 max-sm:px-1.5" aria-label="${t("dashboard.ariaOnlineSupport")}">
