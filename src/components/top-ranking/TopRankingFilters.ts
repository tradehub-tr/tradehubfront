    ...
    <div class="flex items-center justify-center gap-2 sm:gap-3 mt-1 lg:mt-5 px-[10px] sm:px-0">
      ...
      <div class="relative" @click.outside="regionDropdownOpen = false">
        ...
        <div
          ...
          x-transition
          x-cloak
          class="hidden lg:block absolute left-0 top-full mt-2 w-64 bg-surface border border-border-default rounded-md shadow-lg z-30 p-3"
        >
          <div class="space-y-1">
            ${regionRadios}
          </div>
          <div class="pt-3 mt-2 border-t border-border-default">
            <button
              type="button"
              class="th-btn w-full px-4 py-2 text-sm font-medium"
              @click="applyRegion()"
              data-i18n="topRankingPage.apply"
            >${t('topRankingPage.apply')}</button>
          </div>
      ...
      <div class="relative" @click.outside="categoryDropdownOpen = false; categoryDropdownLevel = 1">
        ...
        <div
          ...
          x-transition
          x-cloak
          class="hidden lg:block absolute left-0 top-full mt-2 w-72 bg-surface border border-border-default rounded-md shadow-lg z-30 p-3"
        >
    ...
    >
      <div class="bg-white rounded-t-md max-h-[85vh] flex flex-col shadow-2xl">
        ...
        <div class="p-5 pt-3">
          <button
            type="button"
            class="th-btn w-full py-3 font-semibold"
