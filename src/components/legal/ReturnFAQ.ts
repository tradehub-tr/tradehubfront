        ...
        ${FAQ_ITEMS.map(
          ...
          <div class="border border-gray-200 rounded-lg overflow-hidden">
            <button
              ...
              class="w-full flex items-center justify-between px-4 py-3.5 text-start text-sm font-medium text-gray-800 hover:bg-gray-50 transition-colors cursor-pointer"
            >
              <span>${item.q}</span>
              <svg class="w-4 h-4 text-gray-500 transition-transform shrink-0 ms-2" :class="openFaq === ${i} && 'rotate-180'" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5"/></svg>
            </button>
