    ...
    >
      <div class="max-w-5xl mx-auto bg-white border border-gray-200 rounded-md shadow-2xl overflow-hidden">
        ...
        <div class="border-t border-gray-100 px-4 sm:px-6 py-2">
          <button
            @click="detailsMounted = true; showDetails = !showDetails"
