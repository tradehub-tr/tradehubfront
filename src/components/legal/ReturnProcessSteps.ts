...
function getSteps() {
  return [
    {
      num: 1,
      label: t("returnProcess.step1Label"),
      desc: t("returnProcess.step1Desc"),
      icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10"/></svg>',
    },
    {
      num: 2,
      label: t("returnProcess.step2Label"),
      desc: t("returnProcess.step2Desc"),
      icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>',
    },
    {
      num: 3,
      label: t("returnProcess.step3Label"),
      desc: t("returnProcess.step3Desc"),
    ...
    {
      num: 4,
      label: t("returnProcess.step4Label"),
      desc: t("returnProcess.step4Desc"),
      icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z"/></svg>',
    },
    {
      num: 5,
      label: t("returnProcess.step5Label"),
      desc: t("returnProcess.step5Desc"),
