  ...
  return /* html */ `
    <div x-data="orderItemsDrawer" x-cloak>
      ...
      <aside
        ...
        x-show="open"
        x-transition:enter="transition ease-[cubic-bezier(0.32,0.72,0,1)] duration-300 motion-reduce:transition-opacity motion-reduce:duration-150"
        x-transition:enter-start="translate-x-full motion-reduce:translate-x-0 motion-reduce:opacity-0"
        x-transition:enter-end="translate-x-0 motion-reduce:opacity-100"
        x-transition:leave="transition ease-[cubic-bezier(0.32,0.72,0,1)] duration-200 motion-reduce:transition-opacity motion-reduce:duration-150"
        x-transition:leave-start="translate-x-0 motion-reduce:opacity-100"
        x-transition:leave-end="translate-x-full motion-reduce:translate-x-0 motion-reduce:opacity-0"
