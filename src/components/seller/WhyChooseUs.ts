      ...
      <div class="max-w-(--container-lg) mx-auto px-4 lg:px-6 xl:px-8">
        ...
        <div class="why-choose__grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
          ${advantages
            .map(
              (adv) => `
            <div class="why-choose__icon-card flex flex-col items-center text-center p-4 hover:shadow-md [@media(hover:hover)_and_(pointer:fine)]:hover:-translate-y-1 motion-reduce:hover:translate-y-0 motion-reduce:transition-none transition-[transform,box-shadow] duration-300">
