        ...
        <div class="max-w-[640px] mx-auto">
          ...
          <div class="mb-4 max-sm:mb-3">
            ...
            <div class="relative max-w-[360px] max-sm:max-w-full">
              <input :type="showPassword ? 'text' : 'password'" class="th-input th-input-md pe-11" x-ref="emailPassword" autocomplete="off" placeholder="${t("settings.currentPassword")}" />
              <button type="button" aria-label="Şifreyi göster/gizle" @click="showPassword = !showPassword" class="absolute end-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors">
