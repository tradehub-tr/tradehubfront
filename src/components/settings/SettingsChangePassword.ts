        ...
        <div class="max-w-[640px] mx-auto">
          <div class="mb-4 max-sm:mb-3">
            ...
            <div class="relative max-w-[360px] max-sm:max-w-full">
              ...
              <button type="button" @click="showCurrent = !showCurrent" class="absolute end-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors" tabindex="-1">
          ...
          <div class="mb-4 max-sm:mb-3">
            ...
            <div class="relative max-w-[360px] max-sm:max-w-full">
              ...
              <button type="button" @click="showNew = !showNew" class="absolute end-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors" tabindex="-1">
          ...
          <div class="mb-4 max-sm:mb-3">
            ...
            <div class="relative max-w-[360px] max-sm:max-w-full">
              ...
              <button type="button" @click="showConfirm = !showConfirm" class="absolute end-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors" tabindex="-1">
