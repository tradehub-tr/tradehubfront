        ...
        <div class="max-w-[640px] mx-auto">
          <div class="mb-4 max-sm:mb-3">
            ...
            <div class="relative max-w-[360px] max-sm:max-w-full">
              <input :type="showCurrent ? 'text' : 'password'" class="th-input th-input-md pe-11" x-ref="pwCurrent" autocomplete="off" placeholder="${t("settings.currentPassword")}" />
              <button type="button" aria-label="Şifreyi göster/gizle" @click="showCurrent = !showCurrent" class="absolute end-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors">
          ...
          <div class="mb-4 max-sm:mb-3">
            ...
            <div class="relative max-w-[360px] max-sm:max-w-full">
              <input :type="showNew ? 'text' : 'password'" class="th-input th-input-md pe-11" x-ref="pwNew" autocomplete="new-password" placeholder="${t("settings.passwordMinChars")}" />
              <button type="button" aria-label="Şifreyi göster/gizle" @click="showNew = !showNew" class="absolute end-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors">
          ...
          <div class="mb-4 max-sm:mb-3">
            ...
            <div class="relative max-w-[360px] max-sm:max-w-full">
              <input :type="showConfirm ? 'text' : 'password'" class="th-input th-input-md pe-11" x-ref="pwConfirm" autocomplete="new-password" placeholder="${t("settings.reenterPassword")}" />
              <button type="button" aria-label="Şifreyi göster/gizle" @click="showConfirm = !showConfirm" class="absolute end-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors">
          ...
          <button class="th-btn max-sm:py-2 max-sm:text-[13px] max-sm:w-full disabled:opacity-50" type="button" @click="savePassword()" :disabled="loading">
