...
function getDefaultSections(): PrivacySection[] {
  ...
  return [
    {
      id: "basic",
      title: t("settings.sectionBasicInfo"),
      tooltip: true,
      options: shareOptionsExtended,
      selected: "all",
    },
    {
      id: "contact",
      title: t("settings.sectionContactInfo"),
      tooltip: true,
      options: contactOptions,
      selected: "verified-extended",
    },
    {
      id: "spam",
      title: t("settings.sectionSpam"),
      tooltip: true,
    ...
    {
      id: "sourcing",
      title: t("settings.sectionSourcingInfo"),
      tooltip: true,
      options: shareOptions,
      selected: "all",
    },
    ...
    {
      id: "industries",
      title: t("settings.sectionIndustries"),
      tooltip: true,
      options: shareOptions,
      selected: "verified",
    },
    {
      id: "keywords",
      title: t("settings.sectionTopKeywords"),
      tooltip: true,
      options: shareOptions,
      selected: "hide",
    },
    {
      id: "recent",
      title: t("settings.sectionRecentKeywords"),
      tooltip: true,
      options: shareOptions,
      selected: "verified",
    },
    {
      id: "transaction",
      title: t("settings.sectionTransaction"),
      tooltip: true,
      options: shareOptionsExtended,
      selected: "hide",
    },
    {
      id: "details",
      title: t("settings.sectionActivityDetails"),
      tooltip: true,
      options: shareOptions,
      selected: "verified",
    },
