...
export function SellPageLayout(): string {
  ...
  const testimonials = [
    {
      name: t("sellPage.testimonial1Name"),
      company: t("sellPage.testimonial1Company"),
      quote: t("sellPage.testimonial1Quote"),
      metric: t("sellPage.testimonial1Metric"),
    },
    {
      name: t("sellPage.testimonial2Name"),
      company: t("sellPage.testimonial2Company"),
      quote: t("sellPage.testimonial2Quote"),
      metric: t("sellPage.testimonial2Metric"),
    },
    {
      name: t("sellPage.testimonial3Name"),
      company: t("sellPage.testimonial3Company"),
      quote: t("sellPage.testimonial3Quote"),
      metric: t("sellPage.testimonial3Metric"),
    },
  ];
