  ...
  return `
    ...
    <div id="product-gallery" class="relative flex w-full min-[1280px]:ps-[88px] overflow-hidden">
      ...
      <div class="relative flex-1 min-w-0 w-full max-w-[512px] mx-auto">
        ...
        <button type="button" id="gallery-prev" class="gallery-nav-btn absolute top-1/2 -translate-y-1/2 z-[5] w-8 h-8 rounded-full bg-white shadow-[0_2px_8px_rgba(0,0,0,0.15)] flex items-center justify-center border-0 cursor-pointer transition-[transform,background-color] duration-150 hover:scale-105 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-primary-600,#db7300)] start-3" aria-label="${t("product.previous")}" @click.stop="goToSlide(currentIndex - 1)">
        ...
        <button type="button" id="gallery-next" class="gallery-nav-btn absolute top-1/2 -translate-y-1/2 z-[5] w-8 h-8 rounded-full bg-white shadow-[0_2px_8px_rgba(0,0,0,0.15)] flex items-center justify-center border-0 cursor-pointer transition-[transform,background-color] duration-150 hover:scale-105 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-primary-600,#db7300)] end-3" aria-label="${t("product.nextLabel")}" @click.stop="goToSlide(currentIndex + 1)">
