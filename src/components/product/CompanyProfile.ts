    ...
    <div class="py-6 max-[374px]:py-4">
      ...
      <div style="margin-bottom: 24px;">
        ...
        <div class="grid grid-cols-4 gap-3 mb-6 max-sm:grid-cols-2 max-[374px]:gap-2">
          ${[
            {
              label: t("product.productionLine"),
              stroke: "#4a5e9a",
              icon: '<rect x="3" y="8" width="18" height="12" rx="1"/><path d="M7 8V6a2 2 0 012-2h6a2 2 0 012 2v2"/><path d="M12 12v4"/>',
            },
            {
              label: t("product.qualityControl"),
              stroke: "#2d8a5e",
