...
function openImageLightbox(url: string): void {
  ...
  overlay.innerHTML = `
    <button type="button" class="absolute top-4 end-4 w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 text-white flex items-center justify-center transition-colors" aria-label="Kapat">
