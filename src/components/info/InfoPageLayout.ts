      ...
      <div class="max-w-[900px] mx-auto px-4 sm:px-6">
        <div class="space-y-6">
          ${sections
            .map(
              (section, index) => `
            <article class="bg-white rounded-md border border-gray-100 shadow-sm transition-shadow duration-200 [@media(hover:hover)_and_(pointer:fine)]:hover:shadow-md overflow-hidden">
        ...
        <div class="mt-10 text-center">
          <div class="inline-flex items-center gap-2 px-5 py-3 bg-orange-50 border border-orange-200 rounded-md text-sm text-orange-800">
            ...
            <span>Sorulariniz mi var? <a href="/yardim-merkezi" class="font-semibold text-orange-600 hover:text-orange-700 underline underline-offset-2">Yardim Merkezimizi</a> ziyaret edin.</span>
          </div>
        </div>
      </div>
    </section>
