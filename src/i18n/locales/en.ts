  ...
  translation: {
    ...
    legal: {
      ...
      returns: {
        ...
        section6Content:
          '<p>After the return is approved, your payment will be refunded according to the original payment method:</p><ul class="list-disc pl-5 space-y-1"><li><strong>Credit/Debit card:</strong> Refunded to your card within 3-5 business days</li><li><strong>Bank transfer/Wire:</strong> Transferred to your bank account within 1-3 business days</li><li><strong>Platform balance:</strong> Instantly added to your balance</li></ul><p>For installment payments, the refund is reflected in your installment plan by your bank. This period may vary from bank to bank.</p>',
