  ...
  translation: {
    ...
    shipment: {
      ...
      appointment: {
        ...
        date: "Date",
        failed: "Could not create the appointment.",
        full: "full",
        incomplete: "Select a date and a time window.",
        location: "Pickup point",
        noSlots: "No slots available",
        noSlotsHint: "Choose another date or contact the seller.",
        notAvailable: "This feature is not available yet.",
        pastDate: "A past date cannot be selected.",
        request: "Request appointment",
        slot: "Time window",
        slotNotFound: "The selected time window was not found.",
        slotTaken: "That time window is full — choose another one.",
        submitting: "Submitting…",
        subtitle: "Pick a date and time window that suits you.",
        title: "Delivery appointment",
      },
      channel: {
        BUYER_PICKUP: "Store pickup",
        CARGO: "Courier",
        COURIER: "Express",
        SELLER_VEHICLE: "Seller vehicle",
        WAREHOUSE: "Freight",
      },
      checkout: {
        eta: "{{min}}-{{max}} business days",
        free: "Free",
        freeShippingHint: "Add {{amount}} more for free shipping.",
        noOptions: "No shipping option for this address",
        noOptionsHint: "You can try a different delivery address.",
        taxNote: "Prices include VAT.",
        title: "Shipping options",
      },
      confirm: {
        action: "I received it",
        appointment: "Appointment",
        attemptsLeft: "{{count}} attempts left",
        codeExpired: "Your delivery code has expired",
        codeExpiredHint:
          "You can request a new code and try again. Your remaining attempts are preserved.",
        codeHint: "Enter the code the courier gave you.",
        codeInvalid: "The code could not be verified.",
        codeLabel: "Delivery code",
        codeTooShort: "The code looks incomplete.",
        done: "Delivery completed",
        doneHint: "Your delivery details are shown below.",
        expiresIn: "Code expires in {{time}}.",
        failed: "Could not confirm, please try again.",
        goToPayment: "Go to payment",
        location: "Pickup location",
        lockedOut: "No attempts left",
        lockedOutHint: "Please contact the seller.",
        noCodeHint: "No delivery code is needed for this parcel. Confirm if you have received it.",
        notAvailable: "This feature is not available yet.",
        paymentBlocked: "Cannot be collected before payment",
        paymentBlockedHint: "This parcel requires payment first. Return here once you have paid.",
        resendCode: "Request a new code",
        resendFailed: "New code could not be sent.",
        resending: "Sending…",
        submitting: "Submitting…",
      ...
      exception: {
        ...
        RECIPIENT_ABSENT: "Nobody at the address",
        REFUSED: "Delivery refused",
        SIZE_EXCEED: "Size limit exceeded",
        WEATHER: "Delayed due to weather",
        WRONG_ADDRESS: "Wrong address",
      },
      group: {
        allShipped: "Your entire order has been dispatched.",
        carrier: "Carrier",
        empty: "No shipments for this order",
        emptyHint: "They will appear here once the seller prepares the parcel.",
        eta: "Estimated delivery",
        itemProgress: "Item progress",
        manage: "Manage",
        noCarrier: "Not set",
        noTracking: "Not yet",
        parcelOf: "Parcel {{index}} of {{total}}",
        remaining: "{{count}} {{uom}} not yet shipped",
        subtitle: "Your order is being sent in {{count}} parcels.",
        title: "Shipments for {{order}}",
        track: "Track",
        tracking: "Tracking number",
      },
      label: {
        barcodeAlt: "Barcode for {{code}}",
        barcodeUnavailable: "Barcode could not be loaded",
        download: "Download label",
        empty: "No packages found",
        emptyHint: "Complete the packing step first.",
        missingWarning: "{{count}} packages have no label — they cannot be handed to the carrier.",
        noBarcode: "No barcode",
        notReady: "Label is not ready yet",
        printedAt: "Created",
        subtitle: "Labels for the packages of {{shipment}}.",
        title: "Shipping labels",
      },
      notify: {
        empty: "No notifications",
        emptyHint: "Shipment updates will appear here.",
      ...
      notifyEvent: {
        ...
        shipment_exception: "Shipment issue",
        shipment_out_for_delivery: "Out for delivery",
        shipment_shipped: "Shipment dispatched",
      },
      notifyPref: {
        empty: "No preferences found",
        failed: "Could not save the preference.",
        lockedDefault: "Mandatory notification — cannot be turned off.",
        mandatoryBlocked: "This notification is mandatory and cannot be turned off.",
        mandatoryNote: "{{count}} notifications are mandatory and cannot be turned off.",
        notAvailable: "This feature is not available yet.",
        notFound: "This notification type no longer exists.",
        permissionDenied: "You are not allowed to view these settings.",
        saving: "Saving…",
      ...
      packing: {
        ...
        desi: "Desi",
        desiExceeds: "Desi exceeds weight — pricing will use desi.",
        desiHint: "Desi is calculated automatically from the dimensions.",
        empty: "No packages yet",
        failed: "Could not add the package.",
        height: "Height (cm)",
        length: "Length (cm)",
        locked: "This shipment has left; packing cannot be changed.",
        notAvailable: "This feature is not available yet.",
        subtitle: "Define the parcels for this shipment.",
        title: "Packing",
        type: "Package type",
        weight: "Weight (kg)",
        width: "Width (cm)",
      ...
      pod: {
        ...
        discrepancy: "{{delivered}} of {{total}} packages delivered — {{missing}} missing.",
        mediaHidden: "Visual evidence cannot be shown for this account.",
        none: "No evidence recorded for this shipment.",
        noneHint: "Delivery took place; the carrier has not sent the evidence document yet.",
        openDocument: "Open delivery note",
        packageCount: "{{delivered}} / {{total}} packages delivered",
        packages: "Packages",
        photo: "Photo",
        reason: "Reason",
        ...
        waybill: "Carrier tracking no",
      },
      return: {
        allReturned: "The items in this parcel have already been returned.",
        failed: "Could not create the return request.",
        items: "Items",
        mockBarHint: "Your return requests are stored in this browser.",
        mockBarReset: "Reset demo data",
        mockBarTitle: "Sample data mode",
        noItemSelected: "Select at least one item.",
        notAvailable: "This feature is not available yet.",
        notFound: "Return request not found.",
        note: "Description",
        noteHint: "At least {{min}} characters.",
        notePlaceholder: "Briefly describe the issue; the seller decides based on this.",
        noteTooShort: "The description must be at least {{min}} characters.",
        ...
        submitting: "Submitting…",
        subtitle: "Select the items you want to return.",
        title: "Return request",
        windowClosed: "The return window has closed ({{days}} days)",
        windowClosedError: "The return window has closed, so the request cannot be created.",
        windowClosedHint: "If there is still a problem, you can contact our support team.",
      },
      returnTrack: {
        empty: "You have no return requests yet.",
        emptyAction: "Go to my orders",
        emptyHint: "You can start a return from a delivered order.",
        label: "Return shipping label",
        labelHint: "Print it and stick it on the parcel before handing it over.",
        openLabel: "Open label",
        openedAt: "Opened: {{at}}",
        qtyLine: "{{requested}} requested · {{received}} received · {{accepted}} accepted {{uom}}",
        qtyRequestedOnly: "{{requested}} requested for return {{uom}}",
        refundExpected: "Expected refund",
        refundFinal: "Refund amount",
        refundSent: "Refund triggered: {{at}}",
        stepApproved: "Seller approved",
        stepAwaitingDecision: "Waiting for the seller's decision",
        stepClosed: "Closure and refund",
        stepClosedHint: "The amount is transferred once the inspection is complete.",
        stepInTransit: "Return parcel on its way",
        stepInTransitHint: "Print the label and hand the parcel to the carrier.",
        stepInspecting: "Being inspected at the warehouse",
        stepInspectingHint: "The refund amount is final once the inspection ends.",
        stepRejected: "Seller rejected",
        stepRequested: "Request received",
      ...
      sellerForm: {
        allShipped: "This order is fully shipped",
        allShippedHint: "No items left to ship.",
        carrier: "Carrier",
        carrierRequired: "Select a carrier.",
        channel: "Shipping channel",
        driver: "Driver",
        failed: "Could not create the shipment.",
        items: "Items to ship",
        itemsHint: "Partial shipment is allowed; the rest stays for a later parcel.",
        noItemSelected: "Select at least one item.",
        notAvailable: "This feature is not available yet.",
        plate: "Vehicle plate",
        submit: "Create shipment",
        submitting: "Creating…",
        subtitle: "Prepare a parcel for order {{order}}.",
      ...
      sellerReturn: {
        ...
        closed: "Closed",
        closureNote: "Refunds and closure are handled by the platform.",
        days: "waiting {{count}} d",
        decide: "Decide",
        decidedAt: "Decided: {{at}}",
        empty: "No return requests",
        emptyHint: "Requests from buyers will appear here.",
        hours: "waiting {{count}} h",
        refund: "Refund amount",
        subtitle: "Requests awaiting a decision come first.",
      ...
      summary: {
        codeNotUsed: "Not used",
        codeUsed: "Delivery code",
        codeVerified: "Verified",
        document: "Document",
        empty: "No proof of delivery",
        emptyHint: "Proof appears here once the parcel is delivered.",
        mediaUnavailable: "Media could not be loaded",
        notProvided: "Not provided",
        openDocument: "Open document",
        photo: "Delivery photo",
        proof: "Proof of delivery",
        receivedBy: "Received by",
        returnHint: "Something wrong with the item? You can request a return.",
        signature: "Signature",
        startReturn: "Request a return",
      },
      tracking: {
        empty: "No tracking updates yet",
        emptyHint: "Movements appear here once the carrier collects the parcel.",
        exceptionGeneric: "There was a delivery issue; we are on it.",
      },
    },
    pageTitle: {
      home: "iStoc | Global B2B Wholesale & Trade Marketplace",
      homeHeading: "iStoc: Global B2B Wholesale & Trade Marketplace",
      auth_accept_invite: "Accept Invitation | iStoc",
      auth_forgot_password: "Forgot Password | iStoc",
      auth_login: "Sign In | iStoc",
      auth_register: "Sign Up | iStoc",
      auth_reset_password: "Reset Password | iStoc",
      brand: "Wholesale Brand Products | iStoc",
      cart: "My Cart | iStoc",
      categories: "Wholesale Product Categories | iStoc",
      dashboard_addresses: "My Addresses | iStoc",
      dashboard_buyer_dashboard: "Buyer Dashboard | iStoc",
      dashboard_contacts: "My Contacts | iStoc",
      dashboard_favorites: "My Favorites | iStoc",
      dashboard_inquiries: "My Product Questions | iStoc",
      dashboard_kyb: "Document Verification | iStoc",
      dashboard_kyc: "KYC Verification | iStoc",
      dashboard_messages: "My Messages | iStoc",
      dashboard_notification_preferences: "Notification Preferences | iStoc",
      dashboard_orders: "My Orders | iStoc",
      dashboard_payment: "Payment | iStoc",
      dashboard_profile: "My Profile | iStoc",
      dashboard_return_request: "Return Request | iStoc",
      dashboard_returns: "My Return Requests | iStoc",
      dashboard_rfq_form: "RFQ Details | iStoc",
      dashboard_rfq_quotes: "RFQ Quotes | iStoc",
      dashboard_rfq_success: "RFQ Submitted | iStoc",
      dashboard_rfq: "RFQ - Request for Quotation | iStoc",
      dashboard_settings: "Account Settings | iStoc",
      dashboard_shipment_tracking: "Shipment Tracking | iStoc",
      dashboard_subscription: "Subscription | iStoc",
      help_faq_detail: "Question Details – FAQ | iStoc",
      help_faq: "Frequently Asked Questions (FAQ) | iStoc",
      help_help_center: "Help Center | iStoc",
      help_help_ticket_new: "Create Support Ticket | iStoc",
      help_help_ticket: "Support Ticket | iStoc",
      help_help_tickets: "My Support Tickets | iStoc",
      info_after_sales: "After-Sales Support & Protections | iStoc",
      info_payments: "Payment Options – Secure Payment | iStoc",
      info_refund_policy: "Refund Policy | iStoc",
      info_shipping_logistics: "Shipping & Logistics | iStoc",
      info_trade_assurance_detail: "How Trade Assurance Works | iStoc",
      legal_accessibility: "Accessibility Policy | iStoc",
      legal_cookies: "Cookie Policy | iStoc",
      legal_distance_sales: "Distance Sales Agreement | iStoc",
      legal_ip: "Intellectual Property | iStoc",
      legal_kvkk: "Data Protection Notice | iStoc",
      legal_notice: "Legal Notice | iStoc",
      legal_privacy: "Privacy Policy | iStoc",
      legal_product_listing: "Product Listing Rules | iStoc",
      legal_returns: "Return Policy | iStoc",
      legal_terms: "Terms of Use | iStoc",
      manufacturers: "Manufacturers & Wholesalers | iStoc",
      media_watch: "Video | iStoc",
      not_found: "404 - Page Not Found | iStoc",
      order_checkout: "Checkout | iStoc",
      order_order_success: "Order Status | iStoc",
      order_payment_failed: "Payment Failed | iStoc",
      order_payment_processing: "Processing Payment | iStoc",
      product_detail: "Wholesale Product Prices | iStoc",
      products: "Wholesale Products – All Categories | iStoc",
      seller_application_pending: "Application Status | iStoc",
      seller_dashboard: "Seller Panel | iStoc",
      seller_sell_pricing: "Seller Plans & Commissions | iStoc",
      seller_sell: "Become a Seller – Sell Wholesale | iStoc",
      seller_seller_shop: "Seller Store | iStoc",
      seller_seller_storefront: "Seller Profile | iStoc",
      seller_shipment: "Shipment Management | iStoc",
      seller_supplier_setup: "Supplier Application | iStoc",
      seller_verification: "Become a Verified Supplier | iStoc",
      tailored_selections: "Tailored Selections | iStoc",
      top_deals: "Wholesale Deals & Offers | iStoc",
    ...
    prodUi: {
      ...
      editReviewBodyLabel: "Review text",
    ...
    footer: {
      ...
      copyright: "© 2026 iStoc Private Company Limited. All rights reserved.",
      ...
      buyerProtection: "Buyer Protection Program",
    ...
    cart: {
      ...
      removeSku: "Remove variant",
      noLongerForSale: "This product is no longer for sale",
      moqMoreRequiredSuffix: "more required to check out",
      addAll: "Add all",
    ...
    product: {
      ...
      qa: {
        ...
        editSave: "Save",
        cancel: "Cancel",
        okQuestionUpdated: "Your question has been updated",
        verified: "Verified",
      ...
      moqSingle: "{{count}} piece",
      moqRange: "{{min}}-{{max}} pieces",
      attributes: "Attributes",
      certificates: "Certificates",
      // Task 5 (2026-08-27 file-manager-seo) — product documents block
      documents: "Documents",
      docTypeCatalog: "Catalog",
      docTypeCertificate: "Certificate",
      docTypeManual: "Manual",
      docTypeDatasheet: "Technical Sheet",
      docTypeOther: "Other",
      reviews: "Reviews",
      supplier: "Supplier",
      description: "Description",
      ...
      verifiedOrdersTooltip:
        "The overall rating is based on reviews from verified orders placed within the last 365 days. A verified order indicates that the reviewer ordered and received this product on iStoc at a price accessible to most buyers.",
      ...
      whatBuyersRated: "What buyers rated",
      buyerPhotos: "Buyer photos",
      viewAllPhotos: "View all ({{count}})",
      buyerPhoto: "Buyer photo from a {{count}}-star review",
      ...
      supplierVerifiedType: "Verified Seller",
      supplierYearsOn: "{{count}} yrs on iStoc",
      supplierLocation: "Location: {{code}}",
      onTimeDeliveryRate: "On-time delivery rate",
      responseTimeCard: "Response Time",
      viewCompanyProfile: "View company profile",
      showMoreProducts: "Show more products",
      catService: "Service",
      catShipping: "Delivery",
      catQuality: "Quality",
    ...
    orders: {
      ...
      pendingReviewsEmptyDesc:
        "Products from your delivered orders will be listed here for you to review.",
      ...
      refundsEmptyDesc:
        "If you have an issue with an order, you can create and track your refund request here.",
    ...
    // ============================================================
    categoryPage: {
      heading: "Wholesale Product Categories",
      loading: "Loading…",
    ...
    mfr: {
      ...
      list: {
        ...
        yearUnit: "yrs",
        staffUnit: "staff",
        bizManufacturer: "Manufacturer (OEM/ODM)",
        bizWholesaler: "Wholesale supply",
        bizRetailer: "Retail",
        bizSupplier: "Supplier",
        exportLabel: "Export",
        featuredProducts: "Featured products",
    ...
    faqDetail: {
      ...
      introDesc_items: [
        {
          q: "What is iStoc?",
          a: "iStoc is a global B2B (business-to-business) e-commerce platform operated by iStoc Private Company Limited (United Kingdom). It brings together manufacturers, wholesalers and distributors from all over the world with buyers to facilitate safe and efficient trade.",
        },
        {
          q: "Who can use iStoc?",
