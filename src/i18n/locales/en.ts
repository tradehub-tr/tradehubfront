const en = {
  translation: {
    ...
    products: {
      ...
      filterCertDisclaimer: '*Certification Disclaimer: Any assessment, certification, inspection and/or related examination related to any authenticity of certificates are provided or conducted by independent third parties with no involvement from iSTOC.',
    ...
    orders: {
      ...
      faq: 'FAQ',
      taxInfoNotice: 'You can update your tax information in Account Settings. This information will be used for invoice processing.',
    ...
    rfq: {
      ...
      agreePostingRules: 'I have read, understood and agreed to abide by the Buying Request Posting Rules.',
      ...
      qualityRatingDesc: 'Buying request quality is evaluated based on the completion of your buying request form and company profile and your historical activities.',
    ...
    settings: {
      ...
      taxBannerText: 'Complete your tax information. B2B invoicing will be based on this information.',
      ...
      vatExemptionDesc: 'VAT exemption applies to businesses operating in specific sectors that meet legal requirements. You can apply by uploading your exemption certificate.',
      ...
      faqTaxIdDesc: 'Click the Edit button on the "Tax Identity Information" card above to add or update your tax number. Individual users enter TCKN, corporate users enter VKN.',
      faqTaxIdLink: 'Detailed info',
      faqEInvoiceTitle: 'What is E-Invoice and how do I apply?',
      faqEInvoiceDesc: 'E-Invoice is an official electronic invoice issued through the Revenue Administration (GIB). You can apply for E-Invoice registration through the GIB portal.',
      faqEInvoiceLink: 'GIB Portal',
      faqInvoiceTitle: 'Why should I update my invoice information?',
      faqInvoiceDesc: 'Up-to-date invoice information is required for correct invoicing on your orders. It is recommended to update your information immediately when there are changes to company name, tax number, or address.',
      ...
      changeEmailDesc: 'Change the email address associated with your account. You will need to log in with your new email after the change.',
      continueBtn: 'Continue',
      emailUpdated: 'Your email address has been updated!',
      emailUpdatedLoginAgain: 'Your email address has been changed successfully. Please log in again with your new email.',
