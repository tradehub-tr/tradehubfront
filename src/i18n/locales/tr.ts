  ...
  translation: {
    ...
    legal: {
      ...
      privacy: {
        ...
        section3Content:
          '<p>Kişisel verileriniz aşağıdaki amaçlarla işlenmektedir:</p><ul class="list-disc pl-5 space-y-1"><li>Üyelik kaydı oluşturma ve hesap yönetimi</li><li>Sipariş işleme, kargo ve teslimat süreçlerinin yürütülmesi</li><li>Ödeme işlemlerinin güvenli bir şekilde gerçekleştirilmesi</li><li>Müşteri destek hizmetlerinin sunulması</li><li>Yasal yükümlülüklerin yerine getirilmesi (fatura düzenleme, vergi bildirimi)</li><li>Platform güvenliğinin sağlanması ve dolandırıcılığın önlenmesi</li><li>Hizmetlerimizin iyileştirilmesi ve kişiselleştirilmesi</li></ul>',
      ...
      returns: {
        ...
        section6Content:
          '<p>İade onaylandıktan sonra ödemeniz, orijinal ödeme yöntemine göre iade edilir:</p><ul class="list-disc pl-5 space-y-1"><li><strong>Kredi/Banka kartı:</strong> 3-5 iş günü içinde kartınıza iade edilir</li><li><strong>Havale/EFT:</strong> 1-3 iş günü içinde banka hesabınıza aktarılır</li><li><strong>Platform bakiyesi:</strong> Anında bakiyenize eklenir</li></ul><p>Taksitli ödemelerde iade, bankanız tarafından taksit planınıza yansıtılır. Bu süre bankadan bankaya farklılık gösterebilir.</p>',
        section7Title: "7. İade Edilemeyecek Ürünler",
        section7Content:
          '<p>Aşağıdaki ürün kategorileri iade kapsamı dışındadır:</p><ul class="list-disc pl-5 space-y-1"><li>Kişiye özel üretilen veya özelleştirilen ürünler</li><li>Ambalajı açılmış hijyen ürünleri (iç giyim, kozmetik vb.)</li><li>Dijital ürünler ve yazılım lisansları (kullanılmaya başlandıysa)</li><li>Hızlı bozulabilir veya son kullanma tarihi geçme riski olan ürünler</li><li>Gazete, dergi gibi süreli yayınlar</li><li>Satıcı tarafından "iade edilemez" olarak belirtilen kampanya ürünleri</li></ul><p>Bu istisnalar, ürünün hatalı veya hasarlı olması durumunda geçerli değildir. Hatalı/hasarlı ürünlerde her koşulda iade hakkınız saklıdır.</p>',
      },
      notice: {
