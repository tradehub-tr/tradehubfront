const tr = {
  translation: {
    ...
    shipment: {
      ...
      checkout: {
        eta: "{{min}}-{{max}} iş günü",
        free: "Ücretsiz",
        freeShippingHint: "{{amount}} daha ekleyin, kargo ücretsiz olsun.",
        noOptions: "Bu adrese kargo seçeneği bulunamadı",
        noOptionsHint: "Farklı bir teslimat adresi deneyebilirsiniz.",
        taxNote: "Tutarlara KDV dahildir.",
      ...
      confirm: {
        ...
        location: "Teslim noktası",
        lockedOut: "Kod deneme hakkı doldu",
        lockedOutHint: "Lütfen satıcıyla iletişime geçin.",
      ...
      exception: {
        ADDR_NOT_FOUND: "Adres bulunamadı",
        CUSTOMS_HOLD: "Gümrükte bekliyor",
        DAMAGED: "Paket hasarlı",
        RECIPIENT_ABSENT: "Adreste bulunulamadı",
        REFUSED: "Teslim alınmadı",
        SIZE_EXCEED: "Boyut limiti aşıldı",
        WEATHER: "Hava koşulları nedeniyle gecikme",
        WRONG_ADDRESS: "Yanlış adres",
      },
      group: {
        allShipped: "Siparişinizin tamamı yola çıktı.",
        carrier: "Taşıyıcı",
        empty: "Bu siparişe ait sevkiyat yok",
        emptyHint: "Satıcı gönderiyi hazırladığında burada görünecek.",
        eta: "Tahmini teslim",
        itemProgress: "Ürün durumu",
        manage: "Yönet",
        noCarrier: "Belirtilmedi",
        noTracking: "Henüz yok",
        parcelOf: "{{index}}. parça / {{total}}",
        remaining: "{{count}} {{uom}} henüz gönderilmedi",
        subtitle: "Siparişiniz {{count}} parça hâlinde gönderiliyor.",
        title: "{{order}} sevkiyatları",
        track: "Takip et",
        tracking: "Takip no",
      },
      label: {
        ...
        download: "Etiketi indir",
        empty: "Koli bulunamadı",
        emptyHint: "Önce paketleme adımını tamamlayın.",
        missingWarning: "{{count}} kolinin etiketi yok — bu koliler kargoya verilemez.",
        noBarcode: "Barkod yok",
        notReady: "Etiket henüz hazır değil",
        printedAt: "Oluşturuldu",
        subtitle: "{{shipment}} kolilerinin etiketleri.",
        title: "Kargo etiketleri",
      },
      notify: {
        empty: "Bildiriminiz yok",
        emptyHint: "Sevkiyat hareketleri burada görünecek.",
      ...
      notifyEvent: {
        ...
        shipment_exception: "Sevkiyat sorunu",
        shipment_out_for_delivery: "Kurye dağıtıma çıktı",
        shipment_shipped: "Sevkiyat yola çıktı",
      },
      notifyPref: {
        empty: "Tercih bulunamadı",
        failed: "Tercih kaydedilemedi.",
        lockedDefault: "Zorunlu bildirim — kapatılamaz.",
        mandatoryBlocked: "Bu bildirim zorunlu, kapatılamaz.",
        mandatoryNote: "{{count}} bildirim zorunludur ve kapatılamaz.",
        notAvailable: "Bu özellik henüz kullanıma açılmadı.",
        notFound: "Bu bildirim türü artık yok.",
        permissionDenied: "Bu ayarları görüntüleme yetkiniz yok.",
        saving: "Kaydediliyor…",
      ...
      packing: {
        ...
        addTitle: "Koli ekle",
        desi: "Desi",
        desiExceeds: "Desi ağırlığı aştı — ücret desi üzerinden hesaplanacak.",
        desiHint: "Desi ölçülerden otomatik hesaplanır.",
        empty: "Henüz koli eklenmedi",
        failed: "Koli eklenemedi.",
        height: "Yükseklik (cm)",
        length: "Uzunluk (cm)",
        locked: "Bu gönderi yola çıktı, paketleme değiştirilemez.",
        notAvailable: "Bu özellik henüz kullanıma açılmadı.",
        subtitle: "Gönderinin kolilerini tanımlayın.",
        title: "Paketleme",
        type: "Koli tipi",
        weight: "Ağırlık (kg)",
        width: "Genişlik (cm)",
      ...
      pod: {
        code: "Tek kullanımlık kod",
        codeVerified: "Doğrulandı",
        deliveredAt: "Teslim zamanı",
        deliveryPoint: "Teslim noktası",
        discrepancy:
          "{{total}} kolinin {{delivered}} tanesi teslim edildi — {{missing}} koli eksik.",
        mediaHidden: "Görsel kanıtlar bu hesapta görüntülenemiyor.",
        none: "Bu sevkiyat için kanıt kaydedilmemiş.",
        noneHint: "Teslimat gerçekleşti; taşıyıcı henüz kanıt belgesini iletmedi.",
        openDocument: "Teslim tutanağını aç",
        packageCount: "{{delivered}} / {{total}} koli teslim edildi",
        packages: "Paket",
        photo: "Fotoğraf",
        reason: "Neden",
        ...
        signature: "İmza",
        title: "Teslim kanıtı",
        waybill: "Taşıyıcı takip no",
      },
      return: {
        allReturned: "Bu gönderideki ürünler zaten iade edildi.",
        failed: "İade talebi oluşturulamadı.",
        items: "Ürünler",
        mockBarHint: "İade talepleriniz tarayıcınızda saklanır.",
        mockBarReset: "Demo verisini sıfırla",
        mockBarTitle: "Örnek veri modu",
        noItemSelected: "En az bir ürün seçin.",
        notAvailable: "Bu özellik henüz kullanıma açılmadı.",
        notFound: "İade talebi bulunamadı.",
        note: "Açıklama",
        noteHint: "En az {{min}} karakter.",
        notePlaceholder: "Sorunu kısaca anlatın; satıcı buna göre karar verecek.",
        noteTooShort: "Açıklama en az {{min}} karakter olmalı.",
        ...
        submitting: "Gönderiliyor…",
        subtitle: "İade etmek istediğiniz ürünleri seçin.",
        title: "İade talebi",
        windowClosed: "İade süresi doldu ({{days}} gün)",
        windowClosedError: "İade süresi dolduğu için talep oluşturulamıyor.",
        windowClosedHint: "Yine de bir sorun varsa destek ekibimize yazabilirsiniz.",
      },
      returnTrack: {
        empty: "Henüz iade talebiniz yok.",
        emptyAction: "Siparişlerime git",
        emptyHint: "Teslim aldığınız bir siparişten iade başlatabilirsiniz.",
        label: "İade kargo etiketi",
        labelHint: "Kargoya vermeden önce yazdırıp kolinin üstüne yapıştırın.",
        openLabel: "Etiketi aç",
        openedAt: "Açıldı: {{at}}",
        qtyLine: "{{requested}} istendi · {{received}} ulaştı · {{accepted}} kabul {{uom}}",
        qtyRequestedOnly: "{{requested}} iade edilmek istendi {{uom}}",
        refundExpected: "Beklenen iade tutarı",
        refundFinal: "İade tutarı",
        refundSent: "Para iadesi tetiklendi: {{at}}",
        stepApproved: "Satıcı onayladı",
        stepAwaitingDecision: "Satıcının kararı bekleniyor",
        stepClosed: "Kapanış ve para iadesi",
        stepClosedHint: "Kontrol bitince tutar hesabınıza aktarılır.",
        stepInTransit: "İade kargosu yolda",
        stepInTransitHint: "Etiketi yazdırıp kargoya verin.",
        stepInspecting: "Depoda kontrol ediliyor",
        stepInspectingHint: "Sonuç çıkınca iade tutarı kesinleşir.",
        stepRejected: "Satıcı reddetti",
        stepRequested: "Talep alındı",
        title: "İade takibi",
      },
      returnReason: {
      ...
      sellerForm: {
        allShipped: "Bu siparişin tamamı gönderildi",
        allShippedHint: "Sevk edilecek kalem kalmadı.",
        carrier: "Kargo firması",
        carrierRequired: "Kargo firması seçin.",
        channel: "Gönderim yöntemi",
        driver: "Sürücü",
        failed: "Sevkiyat oluşturulamadı.",
        items: "Gönderilecek ürünler",
        itemsHint: "Kısmi gönderi yapabilirsiniz; kalan miktar sonraki sevkiyata kalır.",
        noItemSelected: "En az bir ürün seçin.",
        notAvailable: "Bu özellik henüz kullanıma açılmadı.",
        plate: "Araç plakası",
        submit: "Sevkiyatı oluştur",
        submitting: "Oluşturuluyor…",
        subtitle: "{{order}} siparişi için gönderi hazırlayın.",
        title: "Sevkiyat oluştur",
        tracking: "Takip numarası",
      },
      sellerReturn: {
        awaiting: "Karar bekliyor",
        closed: "Kapalı",
        closureNote: "Para iadesi ve kapanış platform tarafından yürütülür.",
        days: "{{count}} gün bekliyor",
        decide: "Karara bağla",
        decidedAt: "Karar: {{at}}",
        empty: "İade talebi yok",
        emptyHint: "Alıcılardan gelen talepler burada görünecek.",
        hours: "{{count}} sa bekliyor",
        refund: "İade tutarı",
        subtitle: "Karar bekleyenler önce listelenir.",
      ...
      summary: {
        codeNotUsed: "Kullanılmadı",
        codeUsed: "Teslim kodu",
        codeVerified: "Doğrulandı",
        document: "Belge",
        empty: "Teslim kanıtı bulunamadı",
        emptyHint: "Gönderi teslim edildiğinde kanıt burada görünür.",
        ...
        proof: "Teslim kanıtı",
        receivedBy: "Teslim alan",
        returnHint: "Üründe bir sorun mu var? İade talebi oluşturabilirsiniz.",
        signature: "İmza",
        startReturn: "İade talebi oluştur",
      },
      tracking: {
        empty: "Henüz takip bilgisi yok",
        emptyHint: "Kargo firması gönderiyi teslim aldığında hareketler burada görünür.",
        exceptionGeneric: "Teslimatta bir sorun oluştu, ilgileniyoruz.",
      },
    },
    pageTitle: {
      home: "iStoc | Global B2B Toptan Satış ve Ticaret Pazaryeri",
      homeHeading: "iStoc: Global B2B Toptan Satış ve Ticaret Pazaryeri",
      auth_accept_invite: "Daveti Kabul Et | iStoc",
      auth_forgot_password: "Şifremi Unuttum | iStoc",
      auth_login: "Giriş Yap | iStoc",
      auth_register: "Kayıt Ol | iStoc",
      auth_reset_password: "Şifre Sıfırla | iStoc",
      brand: "Toptan Marka Ürünleri | iStoc",
      cart: "Sepetim | iStoc",
      categories: "Toptan Ürün Kategorileri | iStoc",
      dashboard_addresses: "Adreslerim | iStoc",
      dashboard_buyer_dashboard: "Alıcı Kontrol Paneli | iStoc",
      dashboard_contacts: "Kişilerim | iStoc",
      dashboard_favorites: "Favorilerim | iStoc",
      dashboard_inquiries: "Ürün Sorularım | iStoc",
      dashboard_kyb: "Belge Doğrulama | iStoc",
      dashboard_kyc: "KYC Doğrulama | iStoc",
      dashboard_messages: "Mesajlarım | iStoc",
      dashboard_notification_preferences: "Bildirim Tercihleri | iStoc",
      dashboard_orders: "Siparişlerim | iStoc",
      dashboard_payment: "Ödeme | iStoc",
      dashboard_profile: "Profilim | iStoc",
      dashboard_return_request: "İade Talebi | iStoc",
      dashboard_returns: "İade Taleplerim | iStoc",
      dashboard_rfq_form: "RFQ Detayları | iStoc",
      dashboard_rfq_quotes: "RFQ Teklifleri | iStoc",
      dashboard_rfq_success: "RFQ Gönderildi | iStoc",
      dashboard_rfq: "RFQ - Fiyat Teklifi Talebi | iStoc",
      dashboard_settings: "Hesap Ayarları | iStoc",
      dashboard_shipment_tracking: "Sevkiyat Takibi | iStoc",
      dashboard_subscription: "Abonelik | iStoc",
      help_faq_detail: "Soru Detayı – SSS | iStoc",
      help_faq: "Sık Sorulan Sorular (SSS) | iStoc",
      help_help_center: "Yardım Merkezi | iStoc",
      help_help_ticket_new: "Destek Talebi Oluştur | iStoc",
      help_help_ticket: "Destek Talebi | iStoc",
      help_help_tickets: "Destek Taleplerim | iStoc",
      info_after_sales: "Satış Sonrası Destek ve Korumalar | iStoc",
      info_payments: "Ödeme Seçenekleri – Güvenli Ödeme | iStoc",
      info_refund_policy: "Para İade Politikası | iStoc",
      info_shipping_logistics: "Kargo ve Lojistik Süreçleri | iStoc",
      info_trade_assurance_detail: "Ticari Güvence Nasıl Çalışır? | iStoc",
      legal_accessibility: "Erişilebilirlik Politikası | iStoc",
      legal_cookies: "Çerez Politikası | iStoc",
      legal_distance_sales: "Mesafeli Satış Sözleşmesi | iStoc",
      legal_ip: "Fikri Mülkiyet | iStoc",
      legal_kvkk: "KVKK Aydınlatma Metni | iStoc",
      legal_notice: "Yasal Bildirim | iStoc",
      legal_privacy: "Gizlilik Politikası | iStoc",
      legal_product_listing: "Ürün Listeleme Kuralları | iStoc",
      legal_returns: "İade Politikası | iStoc",
      legal_terms: "Kullanım Koşulları | iStoc",
      manufacturers: "Üreticiler ve Toptancılar | iStoc",
      media_watch: "Video | iStoc",
      not_found: "404 - Sayfa Bulunamadı | iStoc",
      order_checkout: "Ödeme | iStoc",
      order_order_success: "Sipariş Durumu | iStoc",
      order_payment_failed: "Ödeme Başarısız | iStoc",
      order_payment_processing: "Ödeme İşleniyor | iStoc",
      product_detail: "Toptan Ürün Fiyatları | iStoc",
      products: "Toptan Ürünler – Tüm Kategoriler | iStoc",
      seller_application_pending: "Başvuru Durumu | iStoc",
      seller_dashboard: "Satıcı Paneli | iStoc",
      seller_sell_pricing: "Satıcı Paketleri ve Komisyonlar | iStoc",
      seller_sell: "Satıcı Ol – Toptan Satış Yapın | iStoc",
      seller_seller_shop: "Satıcı Mağazası | iStoc",
      seller_seller_storefront: "Satıcı Profili | iStoc",
      seller_shipment: "Sevkiyat Yönetimi | iStoc",
      seller_supplier_setup: "Tedarikçi Başvurusu | iStoc",
      seller_verification: "Doğrulanmış Tedarikçi Olun | iStoc",
      tailored_selections: "Size Özel Seçimler | iStoc",
      top_deals: "Toptan Kampanyalar ve Fırsat Ürünleri | iStoc",
      top_ranking_category: "Kategoriye Göre En Çok Satanlar | iStoc",
      top_ranking: "En Çok Satan Toptan Ürünler | iStoc",
      trade_assurance: "Ticari Güvence – Güvenli Toptan Alışveriş | iStoc",
    },
    pageHeading: {
      help_help_ticket: "Destek Talebi",
      dashboard_buyer_dashboard: "Alıcı Kontrol Paneli",
      dashboard_contacts: "Kişilerim",
      dashboard_inquiries: "Ürün Sorularım",
      dashboard_messages: "Mesajlarım",
      dashboard_settings: "Hesap Ayarları",
      manufacturers: "Üreticiler ve Toptancılar",
      seller_application_pending: "Başvuru Durumu",
    },
    notFound: {
      title: "Bir hata oluştu",
      desc: "Aradığınız sayfa şu anda kullanılamıyor.",
      back: "Geri Dön",
      home: "Ana Sayfaya Git",
    },
    acceptInvite: {
      title: "Daveti Kabul Et",
      desc: "Ekibe katılmak için ad-soyadınızı girin ve bir şifre belirleyin.",
      fullName: "Ad Soyad",
      password: "Şifre",
    ...
    p2g0: {
      categoryProductsAria: "{{category}} ürünleri",
      productCategoryLabel: "Ürün kategorisi:",
      noCategoryMatch: "Eşleşen kategori bulunamadı.",
    },
    p2g3: {
      uploadOkResponseUnreadable: "{{name}} yüklendi ama yanıt okunamadı.",
      unsupportedFormat: "Desteklenmeyen format: {{name}}",
      fileTooLarge: "{{name}} 5MB üzerinde, atlandı.",
      maxFivePhotos: "En fazla 5 fotoğraf yükleyebilirsiniz.",
    ...
    authAddr: {
      ...
      emptyStateText: "Henüz kayıtlı adresiniz yok.",
      ...
      addressTitlePlaceholder: "örn. Merkez Ofis, Depo",
      contactPerson: "İrtibat Kişisi",
      contactPersonPlaceholder: "Ad Soyad",
      companyName: "Şirket Adı",
      companyNamePlaceholder: "Şirket A.Ş.",
      taxNo: "Vergi No (VKN/TCKN)",
      taxNoPlaceholder: "10 hane VKN veya 11 hane TCKN",
      taxOffice: "Vergi Dairesi",
      taxOfficePlaceholder: "örn. Beyoğlu V.D.",
      phone: "Telefon",
      province: "İl",
      district: "İlçe",
      select: "Seçiniz",
      addressLine: "Adres Satırı",
      addressLinePlaceholder: "Mahalle, sokak, bina adı",
      apartment: "Daire / Bina",
      apartmentPlaceholder: "Kat 3, Daire 7",
      postalCode: "Posta Kodu",
      addressNote: "Adres Notu",
      optional: "(opsiyonel)",
      addressNotePlaceholder: "örn. Hafta içi 09:00-18:00 teslimat",
      setAsDefaultDelivery: "Varsayılan teslimat adresi olarak ayarla",
      cancel: "İptal",
      save: "Kaydet",
      saving: "Kaydediliyor...",
      deleteAddressTitle: "Adresi Sil",
      deleteConfirmSuffix: "adresini silmek istediğinize emin misiniz?",
      fieldRequired: "Bu alan zorunludur.",
      invalidPhoneTR: "Geçerli bir telefon numarası giriniz. (örn. 0212 555 00 00)",
      invalidPhoneIntl: "Geçerli bir telefon numarası giriniz (7-15 rakam).",
      invalidTaxNo: "VKN 10 hane veya TCKN 11 hane olmalı.",
      ...
      defaultUpdateFailed: "Varsayılan adres güncellenemedi.",
      addressDeleted: "Adres silindi.",
      addressDeleteFailed: "Adres silinemedi.",
    },
    buyerUi: {
      ...
      mySupportTickets: "Destek Taleplerim",
      all: "Tümü",
      noSupportTickets: "Henüz destek talebiniz yok.",
      ...
      rejectedDocDesc: "Eksik veya hatalı belge tespit edildi. Lütfen düzelt + tekrar gönder.",
      fixKyc: "KYC'yi Düzelt",
      fixKyb: "KYB'yi Düzelt",
      verificationIncompleteTitle: "Doğrulama tamamlanmadı",
      bothPendingDesc: "Hem KYC hem KYB belgelerinizi yüklemeniz gerekiyor.",
      kycPendingTitle: "KYC doğrulamanız bekliyor",
      kycPendingDesc: "Ürün satın alabilmek için KYC belgelerinizi yükleyin.",
      kybPendingTitle: "KYB doğrulamanız bekliyor",
      kybPendingDesc: "Ürün satabilmek için KYB belgelerinizi yükleyin.",
      applyNow: "Şimdi Başvur",
      kybUnderReviewTitle: "KYB incelemede",
      kybUnderReviewDesc: "Belgeleriniz inceleniyor. Genellikle 1-2 iş günü içinde sonuçlanır.",
      fillKycForShoppingTitle: "Alışveriş için KYC doldurun",
      fillKycForShoppingDesc: "Satıcı olarak başarılısınız. Alıcı olmak isterseniz KYC doldurun.",
      fillKyc: "KYC Doldur",
      gridView: "Izgara",
      listView: "Liste",
    ...
    checkoutMfr: {
      ...
      addressSaveFailed: "Adres kaydedilemedi",
      addressDeleteFailed: "Adres silinemedi",
      defaultAddressUpdateFailed: "Varsayılan adres güncellenemedi",
      completeYourPayment: "Ödemenizi tamamlayın.",
      notSpecified: "Belirtilmedi",
      optionOutOfStock: "{{label}} — tükendi",
      toggleExpand: "Aç/Kapat",
      totalLabel: "Toplam",
      countryTR: "Türkiye",
      countryCN: "Çin Halk Cumhuriyeti",
      countryPK: "Pakistan",
      countryUS: "Amerika Birleşik Devletleri",
      countryIN: "Hindistan",
      countryTW: "Tayvan, Çin",
      countryDE: "Almanya",
      countryIT: "İtalya",
      countryFR: "Fransa",
      yearsAndAbove: "{{count}} yıl ve üzeri",
      percentAndAbove: "%{{value}} ve üzeri",
      ...
      searchingResults: "İhtiyacınıza uygun sonuçlar aranıyor",
      selectingSuppliers: "İşletme analizlerine göre tedarikçiler seçiliyor",
      noSellersFound: "Henüz satıcı bulunamadı.",
      unitPieces: "Adet",
      galleryAlt: "galeri",
    ...
    commonNav: {
      ...
      lensDescBefore: "Benzer ürünleri daha ucuza bulmak için",
      lensFree: "ÜCRETSİZ",
      lensDescAfter: "fiyat karşılaştırma eklentimizle zamandan ve paradan tasarruf edin",
    ...
    commonSvc: {
      authCheckFailed: "Yetki kontrolü başarısız",
      conversationsLoadFailed: "Konuşmalar yüklenemedi",
      startChatFailed: "Satıcı ile sohbet başlatılamadı",
      messagesLoadFailed: "Mesajlar yüklenemedi",
      conversationLoadFailed: "Konuşma yüklenemedi",
      fileExceeds10mb: "Dosya 10 MB sınırını aşıyor ({{kb}} KB).",
      messageSendFailed: "Mesaj gönderilemedi",
      fileSendFailed: "Dosya gönderilemedi",
      callUrlFailed: "Görüşme URL'i alınamadı",
      videoCallFailed: "Görüntülü görüşme başlatılamadı",
      ...
      startVideoCall: "Görüntülü görüşme başlat",
      seller: "Satıcı",
      now: "Şimdi",
      minutesShort: "{{n}}dk",
      hoursShort: "{{n}}sa",
      ...
      file: "Dosya",
      noFile: "Dosya yok",
      meetingReservation: "Görüşme Rezervasyonu",
      pickAvailableHour: "müsait olduğu bir saat seç",
      reservationConfirmed: "Rezervasyon onaylandı",
      canStartChatNowPrefix: "Şimdi",
      canStartChatNowSuffix: "ile mesajlaşmaya başlayabilirsin.",
      ...
      noSlotsHint: "Satıcı yeni slot açtığında burada görünecek.",
      availableForMeeting: "Görüşme için müsait",
      cancel: "Vazgeç",
      reserving: "Rezerve ediliyor…",
      reserve: "Rezerve Et",
      unsupportedFileFormat: "Desteklenmeyen dosya formatı",
      fileExceeds20mb: "Dosya boyutu 20MB'ı aşıyor",
      fileReadFailed: "Dosya okunamadı",
      genericError: "Bir hata oluştu. Lütfen tekrar deneyin.",
      fileUploadFailed: "Dosya yüklenemedi",
      fileUploadFailedHttp: "Dosya yüklenemedi (HTTP {{status}})",
      kwTextile: "Tekstil ve Konfeksiyon",
      kwMachinery: "Makine ve Ekipman",
      kwElectronics: "Elektronik ve Yazılım",
      kwFood: "Gıda ve İçecek",
      kwConstruction: "İnşaat Malzemeleri",
      kwAutomotive: "Otomotiv Parçaları",
      kwChemicals: "Kimyasal Ürünler",
      kwHealthcare: "Sağlık Ekipmanları",
      close: "Kapat",
      ...
      uploaded: "yüklendi",
      fileWord: "dosya",
      uploadingPct: "yükleniyor… {{pct}}%",
      errorWord: "hata",
      fileTooLarge: "Dosya çok büyük (maks. {{mb}}MB)",
      maxAbbr: "maks.",
      clickOrDrag: "Tıkla veya sürükle",
      unknownError: "Bilinmeyen hata",
      slotsLoadFailed: "Müsait saatler alınamadı",
      reservationFailed: "Rezervasyon yapılamadı",
    },
    helpUi: {
      breadcrumbMyTickets: "Destek Taleplerim",
      ticketLoading: "Talep yükleniyor...",
      ticketNotFound: "Talep bulunamadı",
      ticketNotFoundDesc: "Geçersiz veya erişiminiz olmayan bir talep.",
      noSubject: "(konusuz)",
      openedAt: "Açılış:",
      noDescription: "Açıklama girilmedi",
      customerFirstRequest: "Müşteri · İlk Talep",
      senderSupport: "Destek",
      senderYou: "Siz",
      attachments: "Ekler",
      ticketClosedNotice: "Bu talep kapatıldı. Yeni bir konu için",
      openNewTicketLink: "yeni talep açabilirsiniz",
      writeReply: "Yanıt yaz",
      replyPlaceholder: "Destek ekibine mesajınız...",
      replyNotifyHint: "Ekip yanıtladığında e-posta ve buradan bildirilirsiniz.",
      sending: "Gönderiliyor...",
      send: "Gönder",
      markedResolvedTitle: "Destek ekibi çözüm olarak işaretledi",
      markedResolvedDesc: "Çözümü onaylıyorsanız talebi kapatabilirsiniz.",
      ...
      typeLabel: "Tip",
      supportTeamLabel: "Destek Ekibi",
      openingLabel: "Açılış",
      lastUpdateLabel: "Son Güncelleme",
      ticketsCountSuffix: "talep",
      ticketsLoading: "Talepler yükleniyor...",
      ...
      priorityHigh: "Yüksek",
      priorityUrgent: "Acil",
      fileUnsupported: "Desteklenmeyen format:",
      fileTooLarge: "Dosya çok büyük:",
      fileDuplicate: "Zaten eklendi:",
      fileMaxFiles: "En fazla 5 dosya ekleyebilirsiniz.",
      routingHintSeller: "Bu talep, seçtiğiniz siparişin satıcısına iletilecek.",
      routingHintPlatform: "Bu talep Platform Destek ekibine iletilecek.",
      orderRefNoOrders: "Uygun siparişiniz yok. Lütfen başka bir kategori seçin.",
      orderRefRequired: "Bu kategori için sipariş seçimi zorunludur.",
      ticketCreatedFilesFailed: "Ticket oluşturuldu fakat bazı dosyalar yüklenemedi:",
      ticketsLoadError: "Talepler yüklenemedi",
      ticketIdMissing: "Talep ID verilmedi (?id=...).",
      ticketLoadError: "Talep yüklenemedi",
      replySendError: "Yanıt gönderilemedi",
      ticketCloseError: "Talep kapatılamadı",
    },
    infoMisc: {
      ...
      trialEndingDays: "Deneme süreniz {{days}} gün içinde sona eriyor.",
      ...
      moqOnePiece: "1 adet",
      viewAll: "Tümünü Gör",
      exploreTopDeals: "En iyi fırsatları keşfedin",
      productsLoading: "Ürünler yükleniyor...",
      newProductsSoon: "Yakında yeni ürünler eklenecek",
      badgeInterest: "İlgi Alanın",
      badgeTrend: "Trend",
      badgeQuality: "Kalite",
      officialBrand: "Resmi Marka",
      founded: "kuruldu",
      productsLabel: "ürün",
      sellerLabel: "Satıcı:",
      aboutUs: "Hakkımızda",
      ...
      brandNoProducts: "Bu markanın henüz ürünü yok",
      productsSoon: "Yakında ürünler eklenecek.",
      allProducts: "Tüm Ürünler",
      socialMedia: "Sosyal Medya",
      brandNotFound: "Marka bulunamadı",
      backToAllProducts: "Tüm ürünlere dön",
      brandNotFoundOrUnapproved: "Marka bulunamadı veya onaylanmamış",
    ...
    kycUi: {
      ...
      corporateRequired: "Kurumsal hesap için zorunlu",
      companyTitleLabel: "Şirket Ünvanı",
      companyTitlePlaceholder: "Örn: ACME Ltd. Şti.",
      identityContactTitle: "Kimlik & İletişim Bilgileri",
      allFieldsRequired: "Tüm alanlar zorunlu",
      taxNumberTckn: "Vergi Numarası (TCKN)",
      taxNumberVkn: "Vergi Numarası (VKN)",
      taxDigits1011: "10-11 hane",
      taxDigits11: "11 hane",
      phone: "Telefon",
      email: "E-Posta",
      address: "Adres",
      ...
      bannerSuspendedDesc: "Destek ile iletişime geçin.",
      updateInfo: "Bilgileri Güncelle",
      fixAndResubmit: "Düzelt + Tekrar Gönder",
      locked: "Kilitli",
      mersisNumber: "MERSİS Numarası",
      mersisPlaceholder: "16 hane",
    ...
    ordersUi: {
      ...
      rfqCreateFailed: "RFQ oluşturulamadı",
      ...
      refundUnderReview: "İade talebi inceleniyor",
      reviewedBySeller: "Satıcı tarafından inceleniyor.",
      refundApprovedTitle: "İade onaylandı",
      refundApprovedBySeller: "tutarında iade satıcı tarafından onaylandı.",
      refundRejectedTitle: "İade talebi reddedildi",
      refundRejectedBySeller: "Satıcı iade talebini reddetti.",
      wireEft: "Havale / EFT",
      confirmed: "Onaylandı",
      pendingStatus: "Beklemede",
      transferDate: "Havale Tarihi",
      sender: "Gönderen",
      amountLabel: "Tutar",
      receipt: "Dekont",
      ...
      seller: "Satıcı",
      reason: "Sebep",
      refundAmountCol: "İade Tutarı",
      statusCol: "Durum",
      paid: "Ödendi",
      refundedStatus: "İade Edildi",
      unpaidStatus: "Ödenmedi",
      orderDetailSections: "Sipariş detay bölümleri",
      statusRefundReviewing: "İade İnceleniyor",
    ...
    prodUi: {
      ...
      fileUploadFailed: "Dosya yüklenemedi",
      serverError: "Sunucu hatası",
      abuseReasonSpam: "Spam / Reklam",
      abuseReasonHate: "Hakaret / Nefret İçeriği",
      abuseReasonFake: "Sahte / Yanıltıcı",
      abuseReasonOffTopic: "Ürünle Alakasız",
      abuseReasonPersonalInfo: "Kişisel Bilgi İçeriyor",
      abuseReasonOther: "Diğer",
      abuseReportReceived: "Şikayetiniz alındı, moderatörler inceleyecek.",
      error: "Hata",
      reportReviewTitle: "Yorumu Şikayet Et",
      close: "Kapat",
      reportReasonPrompt: "Bu yorumu neden şikayet ediyorsunuz?",
      descriptionLabel: "Açıklama",
      optionalParen: "(opsiyonel)",
      detailedDescriptionPlaceholder: "Detaylı açıklama...",
      cancel: "İptal",
      submitting: "Gönderiliyor",
      reportSubmit: "Şikayet Et",
      pendingApproval: "Onay bekliyor",
      notHelpful: "Faydalı değildi",
      edit: "Düzenle",
      ...
      cannotReviewOwn: "Kendi sattığınız ürünü yorumlayamazsınız",
      reviewRequiresApprovedOrder: "Bu ürünü yorumlayabilmek için onaylı bir siparişiniz olmalı",
      feedbackReceived: "Geri bildiriminiz alındı.",
      voteFailed: "Oy verilemedi",
      editReviewModalTitle: "Yorumunuzu düzenleyin",
      editReviewBodyLabel: "Yorum metni",
      ...
      promoVideo: "Tanıtım Videosu",
      variantVideo: "Varyant Videosu",
      watchOnPage: "Sayfasında izle",
      ...
      questionsAndAnswers: "Soru ve cevaplar",
      productLoading: "Ürün yükleniyor...",
      productNotFound: "Ürün bulunamadı",
      productNotFoundDesc: "Aradığınız ürün mevcut değil veya kaldırılmış olabilir.",
      browseProducts: "Ürünlere gözat",
      chat: "Sohbet",
    },
    sellerApp: {
      genericError: "Bir hata oluştu",
      ...
      enterImageUrl: "Görsel URL giriniz",
      maxPhotos: "Maksimum 20 fotoğraf yükleyebilirsiniz",
      ...
      messageFailedRetry: "Mesaj gönderilemedi. Tekrar deneyin.",
      ...
      allProducts: "Tüm ürünler",
      chatNow: "Hemen sohbet et",
      noProductsInCategory: "Bu kategoride ürün bulunamadı.",
      showAllProducts: "Tüm ürünleri göster",
      bizType: "İş Tipi",
      staffCount: "Çalışan Sayısı",
      annualRevenue: "Yıllık Gelir",
      mainMarkets: "Ana Pazarlar",
      validUntil: "Geçerli:",
      noCertificates: "Henüz doğrulanmış sertifika yok.",
      galleryAlt: "Galeri",
      contactInfo: "İletişim Bilgileri",
      loginToViewContact: "İletişim bilgilerini görüntülemek için giriş yapın",
      loginHint: "Yıldızlı alana tıklayarak giriş yapabilirsiniz",
      login: "Giriş Yap",
      contactPerson: "Yetkili",
      phoneLabel: "Telefon:",
      emailLabel: "E-posta:",
      websiteLabel: "Şirket internet sitesi:",
      companyLabel: "Firma:",
      addressLabel: "Adres:",
      ...
      sectionCategoryListing: "Ürün Listeleme",
      sectionCompanyInfo: "Şirket Bilgisi",
      sectionCertificates: "Sertifikalar",
      sectionWhyChooseUs: "Neden Biz",
      sectionGallery: "Galeri",
      sectionCompanyIntro: "Şirket Tanıtımı",
      sectionContactForm: "İletişim Formu",
    },
    sellerDash: {
      loading: "Yükleniyor...",
      loginRequiredTitle: "Giriş Gerekli",
      loginRequiredDesc: "Satıcı paneline erişmek için giriş yapmalısınız.",
      loginBtn: "Giriş Yap",
      notSellerTitle: "Satıcı Değilsiniz",
      notSellerDesc: "Bu sayfaya erişmek için satıcı hesabınız olmalıdır.",
      ...
      district: "İlçe",
      postalCode: "Posta Kodu",
      storeSlogan: "Mağaza Sloganı",
      sloganPlaceholder: "Kısa bir slogan...",
      storeDescription: "Mağaza Açıklaması",
      storeDescriptionPlaceholder: "Mağazanız hakkında kısa bir açıklama...",
      saving: "Kaydediliyor...",
      save: "Kaydet",
      logoBanner: "Logo & Banner",
      logoUrl: "Logo URL",
      bannerUrl: "Banner URL",
      saveImages: "Görselleri Kaydet",
      ...
      noReviewsYet: "Henüz yorum bulunmuyor",
      reviewsHint: "İlk siparişlerinizden sonra yorumlar burada görünecek",
      products: "Ürünler",
      ...
      noCategoriesYet: "Henüz kategori eklemediniz",
      galleryTitle: "Fabrika / Mağaza Fotoğrafları",
      maxPhotos: "Maksimum 20 fotoğraf",
      ...
      address2: "Adres 2",
      address2Placeholder: "Sanayi Sitesi, Blok...",
      orders: "Siparişler",
      filterAll: "Tümü",
      ...
      remittanceInfo: "Havale Bilgileri",
      remittanceDate: "Havale Tarihi",
      sentAmount: "Gönderilen Tutar",
      senderName: "Gönderen Ad",
      viewReceipt: "Dekontu Görüntüle",
    ...
    tradeAssurance: {
      ...
      featureQualityTitle: "Otomatik Kalite Kontrol",
      featureQualityDesc: "Her siparişte otomatik ürün kalite kontrol süreçleri.",
      featureSmartContractTitle: "Akıllı Sözleşmeler",
      featureSmartContractDesc: "Tarafların haklarını otomatik olarak güvence altına alır.",
      featurePaymentSecurityTitle: "Ödeme Güvenliği",
      featurePaymentSecurityDesc: "SSL şifreleme ve bloke hesap koruması.",
      featureReturnsTitle: "İade ve Değişim",
      ...
      footerRead: "Okuyun",
      footerGuideTitle: "Ticari Güvence kılavuzu",
    ...
    header: {
      ...
      langCurrencyDesc:
        "Tercih ettiğiniz dil ve para birimini seçin. Ayarları istediğiniz zaman güncelleyebilirsiniz.",
      language: "Dil",
    ...
    mega: {
      topRanking: "En çok satanlar",
      topRankingDesc: "Bu hafta tedarikçilerin en çok sevkiyat yaptığı ürünler",
      topRankingMeta: "1.240+ ürün",
      newArrivals: "Yeni gelenler",
      tailoredSelections: "Size özel seçimler",
      tailoredSelectionsDesc: "Geçmiş siparişlerine göre kürate edilmiş öneriler",
      tailoredSelectionsMeta: "Sana özel",
      topDeals: "En iyi fırsatlar",
      topDealsDesc: "Sınırlı süreli toplu alım indirimleri ve kampanyalar",
      topDealsMeta: "%40'a varan indirim",
      bannerTagNew: "Yeni",
      discoverProducers: "Üreticileri keşfet",
    ...
    footer: {
      ...
      copyright: "© 2026 iStoc Private Company Limited. Tüm hakları saklıdır.",
      ...
      buyerProtection: "Alıcı Koruma Programı",
    ...
    // ============================================================
    cart: {
      // Giriş sonrası misafir sepeti ↔ hesap sepeti (state/guestCartMerge.ts)
      guestMergeTitle: "Sepetinizi birleştirelim mi?",
      guestMergeDesc:
      ...
      guestMergeLater: "Şimdi değil",
      guestMergeDone: "Sepetler birleştirildi.",
      guestMergeReplaced: "Hesap sepeti boşaltıldı, yeni ürünler eklendi.",
      guestMergeMoved: "Giriş öncesi sepetiniz hesabınıza aktarıldı.",
      guestMergeFailed: "Sepet birleştirilemedi. Lütfen tekrar deneyin.",
      title: "Sepetim",
      empty: "Sepetiniz boş",
      emptyDesc:
        "Henüz sepetinize ürün eklemediniz. Ürünleri keşfedip sepetinize ekleyebilirsiniz.",
      ...
      moqWarning: 'Minimum sipariş adedi eksik ürünler var. "Tümünü ekle" ile tamamlayın.',
      ...
      payThisSupplier: "Satıcıya ödeme yap",
      moveToFavorites: "Favorilere taşı",
      removeProduct: "Ürünü sil",
      removeSku: "Varyantı sil",
      noLongerForSale: "Bu ürün artık satışta değil",
      moqMoreRequiredSuffix: "adet daha eklemelisiniz",
      addAll: "Tümünü ekle",
    ...
    checkout: {
      ...
      reviewOrderTitleSeller: "{{seller}} sipariş onayı",
      reviewOrderDirectPay: "Ödeme doğrudan {{seller}} satıcısına yapılır.",
      ...
      confirmOrderBtnSeller: "{{seller}} siparişini onayla",
      ...
      checkDraftDesc:
        "Çek veya senet ile vadeli ödeme yapın. Satıcı ile vade koşullarını belirleyin.",
      ...
      bankTransferDesc:
        "Banka havalesi veya EFT ile ödeme yapın. Ödeme sonrası siparişiniz onaylanır.",
      ...
      pieceUnit: "adet",
      // Tedarikçi notu
      addNoteToSupplier: "Tedarikçiye not ekle",
      editNote: "Notu düzenle",
      noteToSupplierLabel: "Tedarikçiye not:",
      noteToSupplierTitle: "Tedarikçiye not",
      noteFillIn: "Lütfen doldurun",
      // Ürün kartı özeti
      variantsLabel: "{{count}} varyant",
      unitsLabel: "{{count}} adet",
      showMoreVariants: "+{{count}} varyant daha göster",
      showLessVariants: "Daha az göster",
      // Fatura bilgileri
      billingInfo: "Fatura bilgileri",
      billingMissing: "Eksik",
      billingComplete: "Tamamlandı",
      open: "Aç",
      close: "Kapat",
      edit: "Düzenle",
      billingSummaryEmpty: "Fatura bilgilerini doldurmak için Düzenle'ye tıklayın.",
      billingSummaryIndividual: "Bireysel fatura kesilecek (TCKN ile).",
      billingSummaryCompanyNamed: "{{name}} adına şirket faturası kesilecek.",
      billingSummaryCompanyEmpty: "Şirket faturası kesilecek — bilgileri tamamlayın.",
      billingUseShippingAddress:
        "Teslimat adresinde belirtilen adres fatura adresi olarak kullanılacak.",
      billingIndividual: "Bireysel",
      billingIndividualDesc: "TCKN ile fatura",
      billingCompany: "Şirket / Kurumsal",
      billingCompanyDesc: "Vergi numarası ile fatura",
      billingTcn: "T.C. Kimlik Numarası (TCKN)",
      billingCompanyName: "Şirket ünvanı",
      billingTaxOffice: "Vergi dairesi",
      billingTaxNumber: "Vergi numarası (VKN)",
      billingEInvoice: "e-Fatura mükellefiyim",
      billingEInvoiceHint: "(faturanız elektronik olarak gönderilir)",
      billingSameAsShipping: "Fatura adresi teslimat adresi ile aynı",
      billingAddress: "Adres",
      billingCity: "İl",
      billingDistrict: "İlçe",
      billingPostalCode: "Posta kodu",
      billingTcnError: "Geçerli bir TCKN girin (11 haneli)",
      billingTaxNumberError: "Geçerli bir VKN girin (10 haneli)",
      billingValidationError: "Lütfen fatura bilgilerini eksiksiz doldurun",
    ...
    product: {
      ...
      qa: {
        ...
        editSave: "Kaydet",
        cancel: "İptal",
        okQuestionUpdated: "Sorunuz güncellendi",
        verified: "Doğrulanmış",
      ...
      reviewWrite: {
        ...
        writeReviewDisabledHint: "Bu ürünü yorumlayabilmek için doğrulanmış bir siparişiniz olmalı",
        editMyReviewHint: "Yorumumu düzenle (24 saat içinde)",
        reviewerTop: "Üst Düzey Değerlendirici",
        reviewerTrusted: "Güvenilir Değerlendirici",
        reviewerVerified: "Doğrulanmış Değerlendirici",
        modalTitle: "Ürünü Değerlendir",
        close: "Kapat",
        whichOrder: "Hangi Sipariş?",
        overallRating: "Genel Puan",
        overallHint: "— detaylı puanların ortalaması",
        detailedRating: "Detaylı Puanlama",
        titleLabel: "Başlık",
        optional: "(opsiyonel)",
        titlePlaceholder: "Kısa bir özet yazın",
        commentLabel: "Yorum",
        commentMinHint: "(en az 20 karakter)",
        commentPlaceholder: "Ürün ve satıcı deneyiminizi paylaşın...",
        charSuffix: "karakter",
        maxChars: "Maks 2000",
        photosLabel: "Fotoğraflar",
        photosHint: "(maks 5, her biri 5MB)",
        cancel: "İptal",
        submitting: "Gönderiliyor",
        submit: "Yorumu Gönder",
        dzTitle: "Fotoğrafları sürükle",
        dzOr: "veya",
        dzPick: "Foto Ekle",
        dzRelease: "Bırakın",
        ...
        errBodyMin: "Yorum metni en az 20 karakter olmalı.",
        okPublished: "Yorumunuz yayınlandı.",
      ...
      // Task 5 (2026-08-27 dosya-yöneticisi-seo) — ürün dokümanları bloğu
      documents: "Dokümanlar",
      docTypeCatalog: "Katalog",
      docTypeCertificate: "Sertifika",
      docTypeManual: "Kılavuz",
      docTypeDatasheet: "Teknik Föy",
      docTypeOther: "Diğer",
      reviews: "Yorumlar",
      supplier: "Tedarikçi",
      description: "Açıklama",
      ...
      salesRankPosition: "Sıra",
      salesRankOutOf: "{{total}} ürün içinde",
      ...
      verifiedOrdersTooltip:
        "Genel puanlama, son 365 gün içinde doğrulanmış siparişlerden gelen değerlendirmelere göre belirlenir. Doğrulanmış bir sipariş, yorum yapan kullanıcının; bu ürünü iStoc üzerinden çoğu alıcının erişebileceği bir fiyata sipariş ettiğini ve teslim aldığını gösterir.",
      productReviewsTab: "Ürün değerlendirmeleri ({{count}})",
      storeReviewsTab: "Mağaza değerlendirmeleri ({{count}})",
      noRatingNote:
      ...
      starSuffix: "yıldız",
      sortLabel: "Şuna göre sırala",
      sortRelevant: "En alakalı",
      sortNewest: "En son",
      sortHighest: "En yüksek puan",
      sortLowest: "En düşük puan",
      langNote: "Seçtiğiniz dildeki tüm değerlendirmeler gösteriliyor",
      showOriginal: "Orijinalini göster",
      verifiedPurchase: "Doğrulanmış satın alım",
      repeatBuyer: "Alıcıyı tekrarla",
      supplierReply: "Tedarikçi yanıtı:",
      productImage: "Ürün görseli",
      viewProductDetails: "Ürün detaylarına göz atın",
      showHiddenReviews: "Gizli yorumları göster",
      helpful: "Yararlı ({{count}})",
      frequentMentions: "Sık bahsedilenler:",
      showAll: "Tümünü Göster",
      withPhotos: "Fotoğraflar/videolar ile ({{count}})",
      whatBuyersRated: "Alıcılar neyi puanladı",
      buyerPhotos: "Alıcı fotoğrafları",
      viewAllPhotos: "Tümünü gör ({{count}})",
      buyerPhoto: "{{count}} yıldızlı yoruma ait alıcı fotoğrafı",
      verySatisfied: "Çok Memnun",
      satisfied: "Memnun",
      neutral: "Orta",
      dissatisfied: "Memnun Değil",
      veryDissatisfied: "Çok Memnun Değil",
      basedOnReviews: "Yapılan {{count}} değerlendirmeye göre",
      supplierVerifiedType: "Doğrulanmış Satıcı",
      supplierYearsOn: "iStoc'ta {{count}} yıl",
      supplierLocation: "Konumu: {{code}}",
      onTimeDeliveryRate: "Zamanında teslimat oranı",
      responseTimeCard: "Yanıtlama Süresi",
      viewCompanyProfile: "Şirket profilini görüntüle",
      showMoreProducts: "Daha fazla ürün göster",
      catService: "Hizmet",
      catShipping: "Teslimat",
      catQuality: "Kalite",
      ...
      returnPolicyDesc:
        "30 gün içinde iade başvurusu yapabilirsiniz. Ürünler hasarlı veya tanımlandığı gibi değilse iade kabul edilir.",
      ...
      duration: "Süre",
      // Mobil ürün detay — İşlem süresi / Teslimat (Alibaba app pattern)
      ...
      orderProtectionSectionDesc:
        "Yalnızca iStoc üzerinden verilen ve ödemesi yapılan siparişler bu kapsamda ücretsiz korunur.",
      moneyBackProtection: "Para iade koruması",
    ...
    products: {
      ...
      filterToggleSubcategories: "Alt kategorileri aç/kapat",
      chipsShowMore: "+{{count}} daha",
      chipsShowLess: "Daha az göster",
      chipsToggle: "Filtre etiketlerini aç/kapat",
      filterSearchCategory: "Kategori ara",
      fillHeading: "Bu ürünler de ilginizi çekebilir",
    ...
    dashboard: {
      ...
      emailVerification:
        "E-posta adresinizi doğrulayın. Hesabınızın güvenliği için e-posta doğrulaması gereklidir.",
      verify: "Doğrula",
      favorites: "Favoriler",
    ...
    messages: {
      ...
      // Sohbet mesajları
      conv1m1:
        "Merhaba, RFQ talebinize yanıt vermek istiyorum. Ürünlerimiz hakkında detaylı bilgi paylaşabilirim.",
      ...
      conv2m3:
        "Elbette, silikon ürün kataloğumuzu ekte bulabilirsiniz. Sorularınız olursa çekinmeyin.",
    ...
    orders: {
      ...
      remitSmartPrediction:
        "Akıllı tahmin, sağladığınız bilgilere dayanarak havale varış süresi ve aracı banka masrafları hakkında tahmini bilgi verecektir",
      ...
      remitSuccessDesc:
        "Havale makbuzunuz başarıyla gönderildi. Detayları doğrulayıp ödeme durumunu güncelleyeceğiz.",
      ...
      productionMonitoringDesc:
        "Fabrika zemininden fotoğraf/video güncellemeleriyle gerçek zamanlı üretim ilerleme takibi.",
      preShipmentInspection: "Sevkiyat Öncesi Denetim",
      preShipmentInspectionDesc:
        "Mallar sevk edilmeden önce profesyonel üçüncü taraf denetimi. SGS, BV veya TÜV sertifikalı denetçiler tarafından gerçekleştirilir.",
      selectService: "Seç",
      ...
      sortPriceAsc: "Fiyat ↑",
      sortPriceDesc: "Fiyat ↓",
      noProductsFound: "Aramayla eşleşen ürün bulunamadı",
      // OrderItemsDrawer
      lines: "kalem",
      ...
      vat: "KDV (%20)",
      showMoreProducts: "ürün daha — tümünü göster",
      collapse: "Daralt",
      ...
      // OrderListItem — D yaklaşımı
      cancelOrder: "Siparişi iptal et",
      productsUnit: "ürün",
      orderContents: "Sipariş içeriği",
      viewAll: "Tümünü gör",
      subtotalVatIncluded: "Ara toplam · KDV dahil",
      viewReceipt: "Dekontu görüntüle",
      // Cancel order modal
      ...
      faqNoTaxInfoAnswer:
        "Vergi bilginiz yoksa siparişler standart vergi oranlarıyla işlenir. Vergi bilgilerini daha sonra ekleyebilirsiniz.",
    ...
    legal: {
      ...
      privacy: {
        ...
        section3Content:
          '<p>Kişisel verileriniz aşağıdaki amaçlarla işlenmektedir:</p><ul class="list-disc ps-5 space-y-1"><li>Üyelik kaydı oluşturma ve hesap yönetimi</li><li>Sipariş işleme, kargo ve teslimat süreçlerinin yürütülmesi</li><li>Ödeme işlemlerinin güvenli bir şekilde gerçekleştirilmesi</li><li>Müşteri destek hizmetlerinin sunulması</li><li>Yasal yükümlülüklerin yerine getirilmesi (fatura düzenleme, vergi bildirimi)</li><li>Platform güvenliğinin sağlanması ve dolandırıcılığın önlenmesi</li><li>Hizmetlerimizin iyileştirilmesi ve kişiselleştirilmesi</li></ul>',
        section4Title: "4. Hukuki Dayanak",
        section4Content:
          '<p>Kişisel verileriniz, 6698 sayılı Kişisel Verilerin Korunması Kanunu (KVKK) kapsamında aşağıdaki hukuki dayanaklara istinaden işlenmektedir:</p><ul class="list-disc ps-5 space-y-1"><li><strong>Açık rıza:</strong> Pazarlama iletişimleri ve çerez tercihleri</li><li><strong>Sözleşmenin ifası:</strong> Sipariş, ödeme ve teslimat süreçleri</li><li><strong>Yasal yükümlülük:</strong> Vergi mevzuatı, tüketici hukuku</li><li><strong>Meşru menfaat:</strong> Platform güvenliği, hizmet iyileştirme</li></ul>',
      ...
      cookies: {
        ...
        section1Content:
          "<p>Çerezler, web sitelerinin tarayıcınıza gönderdiği ve cihazınızda saklanan küçük metin dosyalarıdır. Bu dosyalar, siteyi tekrar ziyaret ettiğinizde sizi tanımamıza ve deneyiminizi kişiselleştirmemize yardımcı olur.</p><p>Çerezler, oturum çerezleri (tarayıcı kapatıldığında silinen) ve kalıcı çerezler (belirli bir süre boyunca cihazınızda kalan) olmak üzere ikiye ayrılır.</p>",
        section2Title: "2. Zorunlu Çerezler",
        section2Content:
          "<p>Bu çerezler, Platform'un temel işlevlerinin çalışması için gereklidir ve devre dışı bırakılamazlar. Bunlar olmadan oturum açma, sepete ürün ekleme gibi temel işlemleri gerçekleştiremezsiniz.</p><p><strong>Örnekler:</strong> Oturum yönetimi çerezleri, CSRF koruma çerezleri, yük dengeleme çerezleri.</p>",
        section3Title: "3. Fonksiyonel Çerezler",
        section3Content:
          "<p>Bu çerezler, tercihlerinizi hatırlayarak daha kişiselleştirilmiş bir deneyim sunar. Dil seçiminiz, para birimi tercihiniz veya bölge ayarlarınız gibi bilgileri saklar.</p><p>Bu çerezleri devre dışı bırakırsanız, bazı kişiselleştirme özellikleri çalışmayabilir.</p>",
        section4Title: "4. Analitik Çerezler",
        section4Content:
          "<p>Bu çerezler, ziyaretçilerin sitemizi nasıl kullandığını anlamamıza yardımcı olur. Sayfa görüntülemeleri, oturum süresi, hemen çıkma oranı gibi istatistiksel veriler toplar.</p><p>Toplanan veriler anonimleştirilir ve yalnızca Platform hizmetlerinin iyileştirilmesi amacıyla kullanılır. Bu amaçla Google Analytics ve benzeri araçlar kullanılmaktadır.</p>",
        section5Title: "5. Pazarlama Çerezleri",
        section5Content:
          "<p>Bu çerezler, ilgi alanlarınıza uygun reklamlar göstermek için kullanılır. Farklı web sitelerinde gezinme alışkanlıklarınızı takip edebilir.</p><p>Bu çerezleri devre dışı bırakmak, reklam görmeyeceğiniz anlamına gelmez; yalnızca size gösterilen reklamların ilgi alanlarınıza göre kişiselleştirilmediği anlamına gelir.</p>",
        section6Title: "6. Çerez Yönetimi",
        section6Content:
          '<p>Tarayıcı ayarlarınızdan çerezleri silme veya engelleme seçeneğiniz bulunmaktadır. Ancak zorunlu çerezlerin engellenmesi, Platform\'un düzgün çalışmamasına neden olabilir.</p><p>Aşağıdaki bağlantılardan popüler tarayıcıların çerez ayarlarına erişebilirsiniz:</p><ul class="list-disc ps-5 space-y-1"><li>Google Chrome: Ayarlar > Gizlilik ve Güvenlik > Çerezler</li><li>Mozilla Firefox: Seçenekler > Gizlilik ve Güvenlik</li><li>Safari: Tercihler > Gizlilik</li><li>Microsoft Edge: Ayarlar > Gizlilik, Arama ve Hizmetler</li></ul><p class="mt-3">Ayrıca bu sayfadaki çerez tercih panelini kullanarak kategori bazında çerez izinlerinizi yönetebilirsiniz.</p>',
      },
      returns: {
        ...
        section3Content:
          '<p>İade sürecinizi başlatmak için aşağıdaki adımları takip ediniz:</p><ol class="list-decimal ps-5 space-y-2"><li><strong>İade talebi oluşturun:</strong> Hesabınızdaki "Siparişlerim" bölümünden veya <a href="/destek/yeni" class="text-primary-500 hover:underline">Destek Talebi</a> sayfasından iade talebinizi oluşturun.</li><li><strong>Onay bekleyin:</strong> Talebiniz 24 saat içinde değerlendirilecektir.</li><li><strong>Ürünü gönderin:</strong> Onay sonrası size iletilen kargo koduyla ürünü gönderin.</li><li><strong>İnceleme süreci:</strong> Ürün teslim alındıktan sonra 2 iş günü içinde incelenir.</li><li><strong>İade tamamlanır:</strong> Onay sonrası ödemeniz iade edilir.</li></ol>',
        section4Title: "4. İade Kargo",
        section4Content:
          "<p><strong>Ücretsiz iade kargo:</strong> Üretim hatası, yanlış ürün gönderimi veya hasarlı ürün durumlarında kargo ücreti tarafımızca karşılanır.</p><p><strong>Alıcı karşılar:</strong> Cayma hakkı kullanımı veya fikir değişikliği nedenli iadelerde kargo ücreti alıcıya aittir.</p><p>İade kargolarında anlaşmalı kargo firmalarımız üzerinden gönderim yapılması gerekmektedir. Aksi takdirde kargo güvencesi sağlanamaz.</p>",
        section5Title: "5. Ürün İnceleme",
        section5Content:
          '<p>İade edilen ürünler, depomuzda kalite kontrol ekibimiz tarafından incelenir. İnceleme kriterleri:</p><ul class="list-disc ps-5 space-y-1"><li>Ürünün kullanılmamış ve hasarsız olması</li><li>Orijinal ambalaj ve etiketlerin mevcut olması</li><li>Tüm aksesuarların eksiksiz iade edilmesi</li><li>Ürünün hijyen koşullarına uygun olması</li></ul><p>İnceleme sonucu olumsuz ise, ürün masrafları alıcıya ait olmak üzere geri gönderilir.</p>',
        section6Title: "6. Para İadesi",
        section6Content:
          '<p>İade onaylandıktan sonra ödemeniz, orijinal ödeme yöntemine göre iade edilir:</p><ul class="list-disc ps-5 space-y-1"><li><strong>Kredi/Banka kartı:</strong> 3-5 iş günü içinde kartınıza iade edilir</li><li><strong>Havale/EFT:</strong> 1-3 iş günü içinde banka hesabınıza aktarılır</li><li><strong>Platform bakiyesi:</strong> Anında bakiyenize eklenir</li></ul><p>Taksitli ödemelerde iade, bankanız tarafından taksit planınıza yansıtılır. Bu süre bankadan bankaya farklılık gösterebilir.</p>',
        section7Title: "7. İade Edilemeyecek Ürünler",
        section7Content:
          '<p>Aşağıdaki ürün kategorileri iade kapsamı dışındadır:</p><ul class="list-disc ps-5 space-y-1"><li>Kişiye özel üretilen veya özelleştirilen ürünler</li><li>Ambalajı açılmış hijyen ürünleri (iç giyim, kozmetik vb.)</li><li>Dijital ürünler ve yazılım lisansları (kullanılmaya başlandıysa)</li><li>Hızlı bozulabilir veya son kullanma tarihi geçme riski olan ürünler</li><li>Gazete, dergi gibi süreli yayınlar</li><li>Satıcı tarafından "iade edilemez" olarak belirtilen kampanya ürünleri</li></ul><p>Bu istisnalar, ürünün hatalı veya hasarlı olması durumunda geçerli değildir. Hatalı/hasarlı ürünlerde her koşulda iade hakkınız saklıdır.</p>',
      },
      notice: {
        ...
        section1Content:
          '<p><strong>Operatör (Tüzel Kişilik):</strong> iStoc Private Company Limited</p><p><strong>Yargı Bölgesi:</strong> İngiltere ve Galler (United Kingdom)</p><p><strong>Marka:</strong> iStoc</p><p><strong>E-posta:</strong> info@istoc.com</p><p class="text-sm text-gray-500 mt-2"><em>Companies House kayıt numarası, kayıtlı adres ve Türkiye temsilcisi bilgileri tamamlandıkça bu sayfa güncellenecektir.</em></p>',
        section2Title: "2. Platform Hakkında",
        section2Content:
          "<p>iStoc, iStoc Private Company Limited (United Kingdom) tarafından işletilen, işletmeler arası (B2B) ticareti kolaylaştırmak amacıyla kurulmuş küresel bir elektronik ticaret platformudur. Platform, satıcı ile alıcı arasındaki ticari ilişkide aracı hizmet sağlayıcı konumundadır.</p><p>Platform üzerinde sunulan ürün ve hizmetlerin sorumluluğu, ilgili satıcılara aittir.</p>",
      ...
      ip: {
        ...
        section2Content:
          "<p>Aşağıdakiler dahil ancak bunlarla sınırlı olmamak üzere, Platform üzerindeki tüm içerik ve materyaller iStoc markası adına iStoc Private Company Limited'in veya lisans verenlerinin fikri mülkiyetindedir:</p><ul class=\"list-disc ps-5 space-y-1\"><li>iStoc adı, logosu ve tüm ticari markaları</li><li>Platform tasarımı, arayüz düzeni ve kullanıcı deneyimi</li><li>Yazılım kodu, algoritmalar ve veritabanları</li><li>Platform tarafından üretilen içerik, raporlar ve analizler</li><li>Eğitim materyalleri ve dokümantasyonlar</li></ul><p>Bu materyallerin iStoc Private Company Limited'in yazılı izni olmaksızın kopyalanması, çoğaltılması, dağıtılması veya ticari amaçla kullanılması yasaktır.</p>",
        section3Title: "3. İhlal Bildirimi",
        section3Content:
          '<p>Fikri mülkiyet haklarınızın ihlal edildiğini düşünüyorsanız, aşağıdaki bilgilerle birlikte bize başvurabilirsiniz:</p><ul class="list-disc ps-5 space-y-1"><li>Hak sahibinin veya yetkili temsilcisinin kimlik bilgileri</li><li>İhlal edildiği iddia edilen fikri mülkiyet hakkının açıklaması</li><li>İhlal içeren içeriğin Platform üzerindeki konumu (URL)</li><li>İhlal iddiasını destekleyen belgeler (tescil belgesi, lisans sözleşmesi vb.)</li><li>İyi niyetle yapılan bir bildirim olduğuna dair beyan</li></ul><p><strong>Bildirim adresi:</strong> ipr@istoc.com</p>',
        section4Title: "4. İnceleme ve Değerlendirme Süreci",
        section4Content:
          '<p>Fikri mülkiyet ihlal bildirimleri aşağıdaki süreçle değerlendirilir:</p><ol class="list-decimal ps-5 space-y-2"><li><strong>Bildirim Alındı:</strong> Başvurunuz 24 saat içinde kaydedilir ve size bildirim numarası iletilir.</li><li><strong>Ön İnceleme:</strong> Ekibimiz başvurunuzu 3 iş günü içinde ön incelemeye alır.</li><li><strong>Satıcı Bildirimi:</strong> İhlal iddiası ilgili satıcıya iletilir ve 5 iş günü içinde yanıt istenir.</li><li><strong>Karar:</strong> Tüm deliller değerlendirilerek karar verilir ve taraflara bildirilir.</li><li><strong>Uygulama:</strong> İhlal tespit edilmesi halinde ilgili içerik kaldırılır.</li></ol>',
        section5Title: "5. Karşı Bildirim Hakkı",
        section5Content:
          '<p>İçeriği kaldırılan satıcılar, kaldırma işlemine karşı bildirimde bulunma hakkına sahiptir. Karşı bildirim aşağıdaki bilgileri içermelidir:</p><ul class="list-disc ps-5 space-y-1"><li>Satıcının kimlik ve iletişim bilgileri</li><li>Kaldırılan içeriğin tanımı</li><li>İçeriğin neden hak ihlali oluşturmadığına dair açıklama ve destekleyici belgeler</li><li>Yanlış bildirim durumunda yasal sorumluluğu kabul ettiğine dair beyan</li></ul><p>Karşı bildirimler, kaldırma işleminden itibaren 10 iş günü içinde yapılmalıdır.</p>',
        section6Title: "6. Tekrarlayan İhlaller",
        section6Content:
          '<p>iStoc, tekrarlayan fikri mülkiyet ihlallerine karşı sıfır tolerans politikası uygulamaktadır:</p><ul class="list-disc ps-5 space-y-1"><li><strong>İlk ihlal:</strong> Yazılı uyarı ve içerik kaldırma</li><li><strong>İkinci ihlal:</strong> 30 gün hesap askıya alma</li><li><strong>Üçüncü ihlal:</strong> Hesabın kalıcı olarak kapatılması</li></ul><p>Kasıtlı ve organizasyonel ihlallerde iStoc, ilk ihlalde dahi hesabı kalıcı olarak kapatma ve yasal işlem başlatma hakkını saklı tutar.</p>',
      },
      accessibility: {
        ...
        section2Content:
          '<p>Platformumuzda aşağıdaki erişilebilirlik özelliklerini sunmaktayız:</p><ul class="list-disc ps-5 space-y-1"><li><strong>Klavye Navigasyonu:</strong> Tüm Platform özellikleri yalnızca klavye kullanılarak erişilebilir</li><li><strong>Ekran Okuyucu Desteği:</strong> İçeriklerimiz, popüler ekran okuyucu yazılımlarıyla uyumludur</li><li><strong>Metin Boyutu Ayarı:</strong> Kullanıcılar metin boyutunu tarayıcı ayarlarından değiştirebilir</li><li><strong>Renk Kontrastı:</strong> WCAG AA standartlarını karşılayan renk kontrastı oranları</li><li><strong>Alternatif Metinler:</strong> Görseller için açıklayıcı alternatif metinler</li><li><strong>Form Etiketleri:</strong> Tüm form alanları için açık ve anlaşılır etiketler</li><li><strong>Odak Göstergeleri:</strong> Klavye ile gezinirken görünür odak göstergeleri</li></ul>',
        section3Title: "3. Desteklenen Yardımcı Teknolojiler",
        section3Content:
          '<p>Platformumuz aşağıdaki yardımcı teknolojilerle test edilmiştir:</p><ul class="list-disc ps-5 space-y-1"><li><strong>Ekran Okuyucular:</strong> NVDA, JAWS, VoiceOver (macOS/iOS), TalkBack (Android)</li><li><strong>Büyütme Yazılımları:</strong> ZoomText, Windows Büyüteç</li><li><strong>Ses Tanıma:</strong> Dragon NaturallySpeaking, Windows Ses Tanıma</li><li><strong>Alternatif Giriş Cihazları:</strong> Switch erişim, göz izleme sistemleri</li></ul><p>Farklı tarayıcı ve cihaz kombinasyonlarında en iyi deneyimi sağlamak için düzenli testler yapmaktayız.</p>',
        section4Title: "4. Bilinen Sınırlamalar",
        section4Content:
          '<p>Erişilebilirlik konusunda sürekli iyileştirme çalışmalarımıza rağmen, bazı alanlarda sınırlamalar olabilir:</p><ul class="list-disc ps-5 space-y-1"><li>Satıcılar tarafından yüklenen bazı ürün görselleri alternatif metin içermeyebilir</li><li>Üçüncü taraf entegrasyonları (ödeme sayfaları, harita servisleri) kendi erişilebilirlik standartlarına tabidir</li><li>Bazı eski PDF belgeler tam erişilebilir olmayabilir</li></ul><p>Bu sınırlamaları gidermek için aktif olarak çalışmaktayız.</p>',
        ...
        section6Content:
          '<p>Erişilebilirlik çalışmalarımız kapsamında:</p><ul class="list-disc ps-5 space-y-1"><li>Düzenli erişilebilirlik denetimleri gerçekleştirmekteyiz</li><li>Geliştirici ekibimiz erişilebilirlik eğitimleri almaktadır</li><li>Yeni özellikler, erişilebilirlik testlerinden geçirildikten sonra yayınlanmaktadır</li><li>Engelli kullanıcılardan oluşan danışma grubuyla periyodik değerlendirmeler yapmaktayız</li></ul><p>Erişilebilirlik yol haritamız, kullanıcı geri bildirimleri ve teknolojik gelişmeler doğrultusunda sürekli güncellenmektedir.</p>',
      },
    },
    // ============================================================
    // SHARED / BREADCRUMB
    ...
    dropshipping: {
      ...
      autoApprovalDesc:
        "Siparişler otomatik olarak onaylanarak işleme alınır. Bu özellik etkinleştirildiğinde, siparişleriniz manuel onay gerektirmeden doğrudan işlenir.",
      autoApprovalLegal:
        "Stoksuz ticaret hizmet şartlarını okudum ve kabul ediyorum. Otomatik sipariş onayı ile ilgili tüm sorumlulukları üstleniyorum.",
    ...
    inquiries: {
      ...
      rateLabel: "Kur",
      rateUnavailable: "{{from}} → {{to}} için kur bulunamadı",
    ...
    subscription: {
      ...
      faqChargeTodayA:
        "Hayır, 3 günlük ücretsiz deneme süreniz boyunca ücret alınmayacaktır. Deneme süresi sona erdikten sonra, seçtiğiniz plana göre otomatik olarak faturalandırılırsınız.",
      faqBilling: "Faturalandırma nasıl çalışır?",
      faqBillingA:
        "Aylık veya yıllık faturalandırma seçenekleri mevcuttur. Yıllık planda %50 tasarruf edersiniz. Faturalar her dönem başında otomatik olarak kesilir.",
      ...
      faqCancelA:
        "Mevcut fatura döneminizin sonuna kadar tüm özelliklerden yararlanmaya devam edersiniz. Dönem sonunda otomatik olarak Ücretsiz plana geçirilirsiniz.",
    },
    ...
    logistics: {
      ...
      myReviews: "Değerlendirmelerim",
      reviewsDesc:
        "Siparişiniz tamamlandıktan sonra 90 gün içinde deneyiminizi puanlayın ve değerlendirme bırakın",
    ...
    payment: {
      ...
      uploadDescription:
        "Havale dekontunuzu veya MT103 belgenizi yükleyin veya dosyayı kutuya sürükleyip bırakın.",
    ...
    cookieConsent: {
      ...
      necessaryDesc:
        "Web sitesinin temel işlevleri için gereklidir. Bu çerezler devre dışı bırakılamaz.",
    ...
    // ============================================================
    categoryPage: {
      heading: "Toptan Ürün Kategorileri",
      loading: "Yükleniyor…",
    ...
    otherServices: {
      ...
      piParagraph1:
        "Ürün denetim hizmetimiz ile siparişlerinizin kalitesini sevkiyat öncesinde profesyonel denetçiler tarafından kontrol ettirebilirsiniz. Bu hizmet şu anda yapılandırılmaktadır.",
      piParagraph2:
    ...
    seller: {
      ...
      sf: {
        ...
        enterInquiryDetails:
          "Ürün adı, renk, boyut, miktar, malzeme vb. gibi sorgu ayrıntılarınızı girin.",
        // StoreNav extras
    ...
    paymentStatus: {
      ...
      notPaidYet:
        "Siparişiniz için henüz ödeme yapmadınız. Son adımı tamamlamak için şimdi ödeme yapın.",
      makePayment: "Ödeme yap",
      viewAllOrders: "Tüm siparişleri görüntüle",
      failedTitle: "Ödeme Başarısız",
      failedMessage:
        "Ödemeniz gerçekleştirilemedi. Yetersiz bakiye, süresi dolmuş kart veya bankanızla ilgili geçici bir sorundan kaynaklanıyor olabilir.",
    ...
    orderSuccess: {
      ...
      needHelpDesc:
        "Siparişinizle ilgili herhangi bir sorunuz varsa, size yardımcı olmaktan memnuniyet duyarız.",
      ...
      bankTransferPendingDesc:
        "Siparişinizi tamamlamak için lütfen siparişler sayfasından havale dekontunuzu gönderin.",
      goToUploadReceipt: "Havale Makbuzu Gönder",

      // Loading & Fallback
      loadingOrders: "Sipariş detaylarınız yükleniyor...",
      fallbackMessage:
        "Sipariş numaralarınız kaydedildi. Tam detaylar için siparişler sayfanızı ziyaret edin.",
    },
    ...
    categoryBrowse: {
      title: "Kategoriler",
      headerForYou: "Sizin için kategoriler",
    ...
    heroBanner: {
      ...
      newSuppliersText:
        "Doğrulanmış fabrikaları bulun, teklifleri karşılaştırın ve tek bir yerden daha hızlı tedarik edin.",
      seeMore: "Daha fazla gör",
      trendAlert: "TREND UYARISI",
      topPicked: "Sezonun en çok tercih edilen ürünleri",
      topPickedText:
        "Trend kategorilere göz atın ve bugün sevkiyata hazır tedarikçilerle bağlantı kurun.",
      exploreNow: "Şimdi keşfet",
      fastCustomization: "Hızlı özelleştirme",
      privateLabelDesc: "Kendi markanızı oluşturun",
      privateLabelText:
        "Logonuzu ve ambalaj detaylarınızı düşük MOQ seçenekli üreticilere gönderin.",
    ...
    tailoredPage: {
      ...
      cat: {
        ...
        drawstringBagsDesc:
          "Çok yönlü perakende ürünlerine uygun büzgülü tarzda alışveriş çantalarına ilgi gösterdiniz. 800+ ilgili ürünü inceledik ve 5.000+ en iyi seçimi derledik...",
        hikingShoes: "Her Mevsim Yürüyüş Ayakkabıları",
        hikingShoesDesc:
          "Spor ve Eğlence kategorisinde Yürüyüş Ayakkabıları öne çıkıyor; listemiz fiyat, satış ve kanal trendlerini değerlendiriyor.",
        shoulderBags: "Erkek Fermuarlı Omuz Çantaları",
        shoulderBagsDesc:
          "İhtiyaçlarınıza uygun güvenli fermuarlı kapama ile 1.000+ en iyi ürünü seçtik.",
        phoneCases: "Premium Telefon Kılıfları",
        phoneCasesDesc:
          "Cihazlarınızı küratörlü telefon kılıfı seçimimizle koruyun. İnce'den sağlam'a, şeffaf'tan tasarımcı'ya — 3.000+ seçenek incelendi.",
        tacticalGear: "Taktik ve Outdoor Ekipman",
        tacticalGearDesc:
          "Askeri düzeyde taktik ekipman ve outdoor malzemeleri. Dayanıklılık, fiyat aralığı ve alıcı yorumları üzerinden 2.500+ ürün analiz edildi.",
      },
    },
    ...
    mfr: {
      ...
      list: {
        ...
        yearUnit: "yıl",
        staffUnit: "personel",
        bizManufacturer: "Üretici (OEM/ODM)",
        bizWholesaler: "Toptan tedarik",
        bizRetailer: "Perakende satış",
        bizSupplier: "Tedarikçi",
        exportLabel: "İhracat",
        viewProfile: "Profili görüntüle",
        featuredProducts: "Öne çıkan ürünler",
        productsUnit: "ürün",
    ...
    rfq: {
      ...
      uploadFile: "Dosya yükle",
      messageLabel: "Talebinizi açıklayın",
      textareaPlaceholder:
        'Aradığınız ürünü kısaca tarif edin. Örneğin: "Eklediğim tasarıma göre 100 adet oyuncak ayı"',
      writeRfqDetails: "RFQ detaylarını yaz",
      productNameTooShort: "Ürün adı en az 2 karakter olmalı",
      categoryRequired: "Lütfen önerilerden bir kategori seçin",
      ...
      step3Desc:
        "İhtiyaçlarınıza uygun tedarikçilerle iletişime geçin ve sipariş detaylarını belirleyin",
      manageRfq: "RFQ Yönet",
      // RFQ Success page
      ...
      qualityRatingDesc:
        "Satın alma talebi kalitesi, formunuzun tamlığı, şirket profiliniz ve platformdaki geçmiş aktivitelerinize göre değerlendirilir.",
      ...
      unitLoading: "Yükleniyor…",
      unitLoadFailed: "Birimler yüklenemedi",
      unitNotReady: "Lütfen birim seçilmeden önce listenin yüklenmesini bekleyin",
      // RFQ Attachments
      attachmentsTitle: "Yüklenen Belgeler",
      attachmentsCountSuffix: "dosya",
      attachmentsPrivateHint: "Özel — sadece eşleşen tedarikçiler ve admin görür",
      openInNewTab: "Yeni Sekmede Aç",
      downloadFile: "İndir",
      previewable: "Önizle",
      notPreviewable: "Önizleme yok",
      previewClose: "Kapat",
      fileTooLarge: "Dosya çok büyük (10MB üstü): {{fileName}}",
      // Dropzone
      dropzoneTitle: "Dosyaları buraya sürükleyin",
      dropzoneDragRelease: "Bırakın",
      dropzoneOr: "veya",
    ...
    helpCenter: {
      ...
      noTicketsDesc:
        "Henüz destek talebi oluşturmadınız veya arama kriterlerinize uygun talep yok.",
      previousPage: "Önceki",
      nextPage: "Sonraki",
      // ── HelpCenterHeader ──
      navHome: "Ana Sayfa",
    ...
    settings: {
      ...
      taxBannerText:
        "Vergi bilgilerinizi eksiksiz doldurun. B2B işlemlerinizde faturalandırma bu bilgiler üzerinden yapılacaktır.",
      ...
      vatExemptionDesc:
        "KDV muafiyeti, belirli sektörlerde faaliyet gösteren ve yasal şartları karşılayan işletmelere uygulanır. Muafiyet belgenizi yükleyerek başvurunuzu yapabilirsiniz.",
      ...
      faqTaxIdDesc:
        'Yukarıdaki "Vergi Kimlik Bilgileri" kartında Düzenle butonuna tıklayarak vergi numaranızı ekleyebilir veya güncelleyebilirsiniz. Bireysel kullanıcılar TCKN, kurumsal kullanıcılar VKN girer.',
      faqTaxIdLink: "Detaylı bilgi",
      faqEInvoiceTitle: "E-Fatura nedir ve nasıl başvururum?",
      faqEInvoiceDesc:
        "E-Fatura, Gelir İdaresi Başkanlığı (GİB) üzerinden kesilen resmi elektronik faturadır. E-Fatura mükellefi olmak için GİB portalından başvurabilirsiniz.",
      faqEInvoiceLink: "GİB Portal",
      faqInvoiceTitle: "Fatura bilgilerimi neden güncellemeliyim?",
      faqInvoiceDesc:
        "Güncel fatura bilgileri, siparişlerinizde doğru fatura kesilmesi için gereklidir. Şirket unvanı, vergi numarası veya adres değişikliklerinde bilgilerinizi hemen güncellemeniz önerilir.",
      ...
      optionShareVerifiedExtended:
        "Yalnızca doğrulanmış tedarikçiler, üçüncü taraf hizmet sağlayıcıları ve/veya iştirakleriyle paylaş",
      optionExchangedOnly: "Yalnızca kartvizit değiştirdiğiniz tedarikçiler görebilir",
      optionExchangedExtended:
        "Yalnızca (i) tedarikçiler, (ii) üçüncü taraf hizmet sağlayıcıları ve/veya (iii) kartvizit değiştirdiğiniz iştirakleri görebilir",
      ...
      changeEmailDesc:
        "Hesabınıza bağlı e-posta adresini değiştirin. Değişiklik sonrası yeni e-posta ile giriş yapmanız gerekecektir.",
      continueBtn: "Devam",
      ...
      codeSentMsg:
        "E-postanıza yeni bir doğrulama kodu gönderildi ve 30 dakika geçerli olacak. Lütfen bu kodu başkalarıyla paylaşmayın.",
      ...
      deleteIrreversibleDesc:
        "Hesabınız silindikten sonra verilerinizi kurtarmak mümkün olmayacaktır.",
      ...
      verifyDeleteDesc:
        "Hesabınızı silmek için <strong>{{email}}</strong> adresine gönderilen doğrulama kodunu girin.",
      verifyAndContinue: "Doğrula ve devam et",
      finalConfirmation: "Son onay",
      finalConfirmDesc:
        'Hesabınızı kalıcı olarak silmek için aşağıdaki kutuyu işaretleyin ve "Hesabımı sil" butonuna tıklayın.',
      confirmDeleteCheck:
      ...
      adAllPersonalizedAdsDesc:
        "Kişiselleştirilmiş reklamlar açıkken, size özel öneriler gösterilir. Kapatırsanız yine de reklam görürsünüz, ancak ilgi alanlarınıza göre özelleştirilmez.",
      adAllPersonalizedRecs: "Tüm kişiselleştirilmiş öneriler",
      adAllPersonalizedRecsDesc:
        "İlginizi çekebilecek ürünleri göstermek için öneriler kullanıyoruz. Öneri ayarlarınızı değiştirerek önerilerinizi etkileyin.",
      adBack: "Geri",
      ...
      altEmailHint:
        "(Alternatif E-posta adresinize e-posta alabilmeniz için alternatif eposta adresinizin doğru ve güncel olduğundan emin olun.)",
      ...
      surveys: "Anketler",
      surveysDesc:
        "Size daha iyi hizmet verebilmek için tekliflerimizi geliştirebilmemiz için sizi geri bildirim sağlamaya davet eden e-postalar.",
      ...
      downloadMyDataPasswordPlaceholder: "Mevcut şifreniz",
      consentManagementNav: "Onay yönetimi",
      consentManagementTitle: "Onay Yönetimi",
      consentManagementDesc: "Verdiğiniz onayları buradan görüntüleyebilir ve geri çekebilirsiniz.",
      consentGranted: "Onay verildi",
      consentWithdrawn: "Onay geri çekildi",
      consentWithdrawBtn: "Geri Çek",
      consentGrantBtn: "Onay Ver",
      consentPrivacyPolicy: "Gizlilik Politikası",
      consentTerms: "Kullanım Koşulları",
      consentMarketingEmail: "Pazarlama E-postaları",
      consentMarketingSms: "Pazarlama SMS",
      consentCookieAnalytics: "Analitik Çerezler",
      consentCookieMarketing: "Pazarlama Çerezleri",
      consentCookieFunctional: "İşlevsel Çerezler",
    ...
    faqDetail: {
      ...
      introDesc_items: [
        {
          q: "iStoc nedir?",
          a: "iStoc, Birleşik Krallık merkezli iStoc Private Company Limited tarafından işletilen küresel bir B2B (işletmeden işletmeye) e-ticaret platformudur. Tüm dünyadan üreticiler, toptancılar ve distribütörler ile alıcıları bir araya getirerek güvenli ve verimli ticaret yapılmasını sağlar.",
        },
        {
      ...
      introMembership_items: [
        ...
        },
        {
          ...
          a: "Ücretsiz üyelik ile ürün arayabilir, tedarikçilere mesaj gönderebilir, teklif isteyebilir ve sınırlı sayıda ürün listeleyebilirsiniz. Temel ticaret güvencesi kapsamı da ücretsiz üyeliğe dahildir.",
        },
        {
          q: "Gold üyeliğe nasıl yükseltirim?",
          a: 'Hesap ayarlarınızdan "Üyeliği Yükselt" seçeneğine tıklayarak Gold üyeliğe geçiş yapabilirsiniz. Aylık veya yıllık ödeme planları mevcuttur. Yıllık planda <strong>%20 indirim</strong> uygulanır.',
        },
        {
          q: "Verified üyelik avantajları nelerdir?",
          a: "Verified üyelik; doğrulanmış rozet, arama sonuçlarında öncelik, özel hesap yöneticisi, genişletilmiş analitik paneli, sınırsız ürün listeleme ve öncelikli müşteri desteği gibi avantajlar sunar.",
        },
      ],
      ...
      accountSettings_items: [
        {
          ...
          a: 'Sağ üst köşedeki profil simgenize tıklayın, ardından <strong>"Hesap Ayarları"</strong> bölümüne gidin. Burada ad, soyad, şirket bilgileri, iletişim bilgileri ve profil fotoğrafınızı güncelleyebilirsiniz.',
        },
        {
          q: "E-posta adresimi değiştirebilir miyim?",
          a: "Evet, Hesap Ayarları > İletişim Bilgileri bölümünden e-posta adresinizi değiştirebilirsiniz. Yeni e-posta adresinize bir doğrulama kodu gönderilecektir. Doğrulama tamamlanana kadar eski e-posta adresiniz aktif kalır.",
        },
        {
          q: "Şifremi nasıl değiştiririm?",
          a: "Hesap Ayarları > Güvenlik bölümünden şifrenizi değiştirebilirsiniz. Mevcut şifrenizi girdikten sonra yeni şifrenizi iki kez yazmanız gerekir. Şifreniz en az 8 karakter, bir büyük harf ve bir rakam içermelidir.",
        },
        {
          q: "Bildirim tercihlerimi nasıl ayarlarım?",
          a: "Hesap Ayarları > Bildirimler bölümünden e-posta, SMS ve uygulama içi bildirim tercihlerinizi yönetebilirsiniz. Sipariş güncellemeleri, mesajlar, promosyonlar ve güvenlik uyarıları için ayrı ayrı ayar yapabilirsiniz.",
        },
      ],
      ...
      accountCancelReactivate_items: [
        ...
        },
        {
          ...
          a: "Premium üyeliğinizi iptal ettiğinizde, mevcut fatura dönemi sonuna kadar tüm özellikler aktif kalır. Dönem bitiminde hesabınız otomatik olarak ücretsiz üyeliğe düşürülür. Yıllık planda kalan süre için kısmi iade yapılır.",
        },
      ],
      ...
      accountLogin_items: [
        ...
        },
        {
          ...
          a: 'Giriş ekranındaki <strong>"Şifremi Unuttum"</strong> bağlantısına tıklayın. Kayıtlı e-posta adresinize bir şifre sıfırlama bağlantısı gönderilecektir. Bağlantı 24 saat geçerlidir. E-posta gelmediyse spam klasörünü kontrol edin.',
        },
        {
          q: "İki faktörlü doğrulama (2FA) nasıl etkinleştirilir?",
          a: "Hesap Ayarları > Güvenlik bölümünden iki faktörlü doğrulamayı etkinleştirebilirsiniz. SMS veya authenticator uygulaması (Google Authenticator, Authy) seçeneklerinden birini kullanabilirsiniz. 2FA etkinleştirildiğinde her girişte ek bir doğrulama kodu istenecektir.",
        },
        {
          q: "Hesabım kilitlendi, ne yapmalıyım?",
          a: 'Art arda 5 başarısız giriş denemesinden sonra hesabınız güvenlik amacıyla geçici olarak kilitlenir. 30 dakika bekleyerek tekrar deneyebilir veya "Şifremi Unuttum" ile şifrenizi sıfırlayabilirsiniz. Sorun devam ederse müşteri hizmetleriyle iletişime geçin.',
        },
      ],
      ...
      accountRegister_items: [
        ...
        {
          q: "Kayıt için hangi bilgiler gerekli?",
          a: "Temel kayıt için <strong>e-posta adresi</strong> ve <strong>şifre</strong> yeterlidir. Satıcı olarak kayıt olmak istiyorsanız ek olarak şirket adı, vergi numarası ve iletişim bilgileri gereklidir.",
        },
        {
          q: "E-posta doğrulaması yapamıyorum, ne yapmalıyım?",
          a: "Doğrulama e-postası gelmezse öncelikle spam/istenmeyen posta klasörünüzü kontrol edin. Yeni doğrulama e-postası göndermek için giriş sayfasından tekrar deneyebilirsiniz. Sorun devam ederse farklı bir e-posta adresi ile kayıt olmayı deneyin veya destek ekibiyle iletişime geçin.",
        },
      ],
      ...
      accountBecomeSeller_items: [
        ...
        {
          q: "Satıcı kaydı ücretsiz mi?",
          a: "Evet, satıcı kaydı tamamen ücretsizdir. Ücretsiz planda belirli sayıda ürün listeleyebilirsiniz. Daha fazla listeleme ve gelişmiş özellikler için Gold veya Verified üyelik planlarını tercih edebilirsiniz.",
        },
        {
        ...
        },
        {
          ...
          a: "Satıcı başvurunuz genellikle <strong>1-3 iş günü</strong> içinde değerlendirilir. Belgeleriniz eksiksiz ise süreç daha hızlı tamamlanır. Eksik belge durumunda e-posta ile bilgilendirilirsiniz.",
        },
      ],
      ...
      sourcingSearch_items: [
        {
          ...
          a: "Ana sayfadaki arama çubuğuna ürün adı, kategori veya anahtar kelime yazarak arama yapabilirsiniz. Sonuçları fiyat, minimum sipariş miktarı, konum ve tedarikçi puanına göre filtreleyebilirsiniz.",
        },
        {
        ...
        },
        {
          ...
          a: "Evet, arama çubuğundaki kamera simgesine tıklayarak bir ürün fotoğrafı yükleyebilir ve benzer ürünleri bulabilirsiniz. Bu özellik AI teknolojisi ile desteklenmektedir ve en doğru sonuçları verir.",
        },
      ],
      ...
      sourcingSupplierEval_items: [
        {
          q: "Tedarikçi güvenilirliğini nasıl kontrol ederim?",
          a: "Her tedarikçi profilinde <strong>doğrulama durumu</strong>, <strong>işlem geçmişi</strong>, <strong>müşteri puanları</strong> ve <strong>yanıt süresi</strong> bilgileri yer alır. Verified rozeti taşıyan tedarikçiler üçüncü taraf denetimden geçmiştir.",
        },
        {
          q: "Tedarikçi puanları nasıl hesaplanır?",
          a: 'Tedarikçi puanları; zamanında teslimat oranı, ürün kalitesi değerlendirmeleri, iletişim hızı ve anlaşmazlık çözüm oranına göre hesaplanır. Puan 1-5 arasında olup, 4.5 üzeri "Mükemmel Tedarikçi" olarak işaretlenir.',
        },
        {
          q: "Tedarikçi denetim raporu nedir?",
          a: "Denetim raporu, bağımsız üçüncü taraf firmalar tarafından tedarikçinin fabrika kapasitesi, üretim süreçleri, kalite kontrol sistemleri ve finansal durumunu değerlendiren kapsamlı bir belgedir. Verified tedarikçiler için bu rapor mevcut olup profil sayfasından görüntülenebilir.",
        },
      ],
      ...
      sourcingTradeInfo_items: [
        {
          q: "Ticaret bilgisi sayfasında hangi bilgilere ulaşabilirim?",
          a: "Ticaret bilgisi sayfasında gümrük vergileri, ithalat/ihracat düzenlemeleri, ülkelere göre ticaret anlaşmaları, HS kodları ve sektörel ticaret istatistikleri gibi kapsamlı bilgilere ulaşabilirsiniz.",
        },
        {
        ...
        },
        {
          ...
          a: "Ticaret bilgisi sayfasındaki vergisi hesaplama aracına ürün kategorisi, HS kodu, menşei ülke ve hedef ülkeyi girerek tahmini gümrük vergisini hesaplayabilirsiniz. Sonuçlar bilgilendirme amaçlıdır ve resmi oranlardan farklılık gösterebilir.",
        },
      ],
      ...
      sourcingRecommender_items: [
        ...
        },
        {
          ...
          a: "Profilinizdeki sektör, ilgi alanları ve tercih edilen kategorileri güncelleyerek önerileri kişiselleştirebilirsiniz. Ayrıca beğendiğiniz veya beğenmediğiniz önerileri işaretleyerek sistemin öğrenmesine yardımcı olabilirsiniz.",
        },
        {
          q: "Öneren özelliğini kapatabilir miyim?",
          a: "Evet, Hesap Ayarları > Gizlilik bölümünden kişiselleştirilmiş önerileri kapatabilirsiniz. Bu durumda genel popüler ürünler ve trendler gösterilecektir.",
        },
      ],
      ...
      sourcingAiApp_items: [
        ...
        },
        {
          ...
          a: "Ekranın sağ alt köşesindeki sohbet simgesine tıklayarak AI asistana erişebilirsiniz. Ürün bulma, fiyat karşılaştırma, sipariş takibi veya genel sorularınız için AI asistandan yardım alabilirsiniz.",
        },
        {
          q: "AI fiyat analizi nasıl çalışır?",
          a: "AI fiyat analizi, piyasa verilerini ve geçmiş fiyat trendlerini analiz ederek ürünler için adil piyasa fiyatı aralığını belirler. Bu sayede alıcılar, tedarikçilerin sunduğu fiyatların piyasa koşullarına uygun olup olmadığını değerlendirebilir.",
        },
      ],
      ...
      sourcingSourcing_items: [
        ...
        },
        {
          ...
          a: "Evet, özellikle büyük siparişlerde RFQ göndermek önerilir. RFQ ile birden fazla tedarikçiden aynı anda teklif alabilir, fiyat ve koşulları karşılaştırabilirsiniz. RFQ'nuz genellikle <strong>24 saat</strong> içinde yanıt alır.",
        },
        {
      ...
      negotiationRfq_items: [
        {
          q: "RFQ nasıl gönderilir?",
          a: 'Ana menüdeki "RFQ Gönder" butonuna tıklayın. Ürün açıklaması, miktar, hedef fiyat, teslimat süresi ve varsa ürün görseli ekleyerek talebinizi gönderin. RFQ\'nuz ilgili tedarikçilere otomatik olarak iletilir.',
        },
        {
          q: "RFQ'ma kaç teklif alabilirim?",
          a: "Genellikle bir RFQ'ya <strong>5-20 teklif</strong> gelir. Teklif sayısı ürün kategorisine ve talep detaylarına göre değişir. Teklifleri fiyat, kalite, teslimat süresi ve tedarikçi puanına göre karşılaştırabilirsiniz.",
        },
        {
          q: "RFQ'mu düzenleyebilir veya iptal edebilir miyim?",
          a: 'Evet, henüz teklif almamış bir RFQ\'yu düzenleyebilirsiniz. İptal etmek için RFQ detay sayfasından "İptal Et" seçeneğini kullanabilirsiniz. Teklif almış bir RFQ iptal edildiğinde tedarikçiler bilgilendirilir.',
        },
      ],
      ...
      negotiationMessages_items: [
        {
          q: "Tedarikçiye nasıl mesaj gönderirim?",
          a: 'Tedarikçi profilindeki veya ürün detay sayfasındaki "Mesaj Gönder" butonuna tıklayarak iletişime geçebilirsiniz. Metin, görsel ve dosya gönderebilirsiniz.',
        },
        {
          q: "Mesajlarıma yanıt gelmezse ne yapmalıyım?",
          a: "Tedarikçinin ortalama yanıt süresi profil sayfasında görüntülenir. 48 saat içinde yanıt gelmezse hatırlatma mesajı gönderebilir veya alternatif tedarikçilere ulaşabilirsiniz. Ayrıca tedarikçi değerlendirmesinde yanıt süresini puanlayabilirsiniz.",
        },
        {
          q: "Mesaj geçmişimi nereden görebilirim?",
          a: 'Sol menüdeki "Mesajlar" bölümünden tüm mesaj geçmişinize erişebilirsiniz. Konuşmaları tedarikçi adı veya ürün bazında filtreleyebilir, önemli mesajları yıldızlayabilirsiniz.',
        },
      ],
      ...
      negotiationOtherIssues_items: [
        ...
        },
        {
          ...
          a: 'Tedarikçi profilindeki "Bildir" butonuna tıklayarak şüpheli durumu raporlayabilirsiniz. Sahte ürün, yanıltıcı bilgi veya dolandırıcılık şüphesi gibi durumlarda güvenlik ekibimiz konuyu <strong>24 saat</strong> içinde inceler.',
        },
        {
          q: "Video görüşme yapabilir miyim?",
          a: "Evet, mesajlaşma ekranındaki video kamera simgesine tıklayarak tedarikçi ile video görüşme başlatabilirsiniz. Bu özellik Gold ve Verified üyelere sunulmaktadır. Fabrika turları ve ürün incelemeleri için idealdir.",
        },
      ],
      ...
      placeOrderTradeAssurance_items: [
        ...
        },
        {
          ...
          a: "Program kapsamında <strong>ürün kalitesi</strong>, <strong>zamanında teslimat</strong>, <strong>sipariş miktarı doğruluğu</strong> ve <strong>ödeme güvenliği</strong> korunmaktadır. Sorun yaşandığında arabuluculuk hizmeti de sağlanır.",
        },
        {
      ...
      placeOrderPlace_items: [
        {
          ...
          a: 'Ürün detay sayfasında miktar ve varyant seçimini yaptıktan sonra "Sepete Ekle" veya "Hemen Al" butonuna tıklayın. Teslimat adresinizi girin, ödeme yönteminizi seçin ve siparişinizi onaylayın.',
        },
        {
          q: "Minimum sipariş miktarı (MOQ) nedir?",
          a: "MOQ, tedarikçinin kabul ettiği en düşük sipariş miktarıdır. Bu miktar ürün detay sayfasında belirtilir. MOQ altında sipariş vermek istiyorsanız tedarikçi ile mesaj yoluyla görüşebilirsiniz.",
        },
        {
      ...
      placeOrderConfirm_items: [
        {
          q: "Siparişimi nasıl onaylarım?",
          a: 'Sipariş özeti ekranında tüm detayları kontrol ettikten sonra "Siparişi Onayla" butonuna tıklayın. Ödeme işlemi tamamlandığında sipariş onayı e-posta ve uygulama bildirimi olarak gönderilir.',
        },
        {
          q: "Sipariş onayından sonra değişiklik yapabilir miyim?",
          a: "Sipariş henüz tedarikçi tarafından kabul edilmemişse miktar, renk veya boyut gibi değişiklikler yapabilirsiniz. Kabul edildikten sonra değişiklik için tedarikçi ile doğrudan iletişime geçmeniz gerekir.",
        },
        {
          q: "Sipariş onay e-postası gelmedi, ne yapmalıyım?",
          a: 'Öncelikle spam klasörünüzü kontrol edin. Siparişinizi "Siparişlerim" sayfasından görüntüleyebilirsiniz. E-posta gelmezse Hesap Ayarları > Bildirimler bölümünden e-posta bildirimlerinizin açık olduğundan emin olun.',
        },
      ],
      ...
      paymentOrderPayment_items: [
        ...
        },
        {
          ...
          a: "Tüm ödemeler 256-bit SSL şifreleme ile korunur. Ticaret Güvencesi kapsamında ödemeniz, ürün teslim alınana ve onaylanana kadar güvende tutulur. 3D Secure doğrulaması kredi kartı ödemelerinde zorunludur.",
        },
        {
          q: "Taksitli ödeme yapabilir miyim?",
          a: "Evet, kredi kartı ile yapılan ödemelerde 3, 6, 9 ve 12 taksit seçenekleri mevcuttur. Taksit seçenekleri ve oranları bankanıza göre değişiklik gösterebilir.",
        },
      ],
      ...
      paymentReceipt_items: [
        {
          q: "Ödeme makbuzumu nereden görüntüleyebilirim?",
          a: '"Siparişlerim" sayfasında ilgili siparişin detaylarına girerek ödeme makbuzunuzu PDF olarak indirebilirsiniz. Makbuz ayrıca kayıtlı e-posta adresinize de gönderilir.',
        },
        {
          q: "Fatura nasıl talep ederim?",
          a: 'Sipariş verirken fatura bilgilerinizi (şirket adı, vergi numarası, adres) girmeniz yeterlidir. E-fatura otomatik olarak düzenlenir ve "Belgelerim" bölümünden erişilebilir.',
        },
        {
          q: "Fatura bilgilerimi değiştirebilir miyim?",
          a: "Fatura düzenlenmeden önce sipariş detaylarından fatura bilgilerinizi güncelleyebilirsiniz. Fatura düzenlendikten sonra değişiklik için müşteri hizmetleriyle iletişime geçmeniz gerekir.",
        },
      ],
      ...
      paymentFinancial_items: [
        ...
        },
        {
          ...
          a: 'Hesap sayfanızdan "Finansal Hizmetler" bölümüne giderek kredi limiti başvurusunda bulunabilirsiniz. Başvuru için şirket belgeleri ve finansal bilgiler gereklidir. Onay süreci genellikle <strong>3-5 iş günü</strong> sürer.',
        },
        {
          q: "Vadeli ödeme seçenekleri nelerdir?",
          a: "Onaylanmış alıcılar 30, 60 veya 90 gün vadeli ödeme seçeneklerinden faydalanabilir. Vade süreleri ve limitler, kredi değerlendirmesine göre belirlenir.",
        },
      ],
      ...
      paymentPayment_items: [
        {
          q: "Ödemem başarısız oldu, ne yapmalıyım?",
          a: "Öncelikle kartınızın limitini ve geçerlilik süresini kontrol edin. 3D Secure doğrulamasını tamamladığınızdan emin olun. Sorun devam ederse farklı bir ödeme yöntemi deneyin veya bankanızla iletişime geçin.",
        },
        {
          q: "Çift çekim yapıldı, ne yapmalıyım?",
          a: "Çift çekim durumunda hemen müşteri hizmetleriyle iletişime geçin. Ödeme ekranından çıkmadan sayfayı yenilemek çift çekime neden olabilir. Fazla çekim <strong>5-10 iş günü</strong> içinde otomatik olarak iade edilir.",
        },
        {
      ...
      paymentTypes_items: [
        ...
        },
        {
          ...
          a: "LC ödeme, alıcının bankasının satıcıya ödemeyi garanti ettiği bir uluslararası ödeme yöntemidir. Genellikle büyük siparişlerde tercih edilir. LC açılışı için bankanızla iletişime geçmeniz gerekir.",
        },
      ],
      ...
      taxSubmitInfo_items: [
        {
          q: "Vergi bilgilerimi nasıl kayıt ederim?",
          a: "Hesap Ayarları > Vergi Bilgileri bölümünden vergi kimlik numaranızı, vergi dairenizi ve şirket bilgilerinizi girebilirsiniz. Bu bilgiler fatura düzenlenmesi için gereklidir.",
        },
        {
          q: "Birden fazla vergi bilgisi ekleyebilir miyim?",
          a: "Evet, farklı şirketler veya şubeler için birden fazla vergi bilgisi ekleyebilirsiniz. Sipariş verirken hangi vergi bilgisinin kullanılacağını seçebilirsiniz.",
        },
        {
          q: "Vergi bilgilerimi ne zaman güncellemeliyim?",
          a: "Şirket unvanı, vergi numarası veya adres değişikliklerinde vergi bilgilerinizi hemen güncellemeniz önerilir. Güncel olmayan bilgiler fatura sorunlarına neden olabilir.",
        },
      ],
      ...
      taxTypes_items: [
        ...
        },
        {
          ...
          a: "KDV oranları ürün kategorisine göre değişir. Genel oran %20, indirimli oran %10 ve süper indirimli oran %1'dir. Ürün detay sayfasında KDV dahil ve hariç fiyatlar gösterilir.",
        },
        {
      ...
      taxInvoice_items: [
        {
          q: "Vergi faturası nasıl düzenlenir?",
          a: 'Sipariş tamamlandığında vergi faturası otomatik olarak e-fatura formatında düzenlenir. Fatura, kayıtlı vergi bilgilerinize göre oluşturulur ve "Belgelerim" bölümünden erişilebilir.',
        },
        {
          q: "Faturamda hata var, nasıl düzeltirim?",
          a: "Faturadaki hatalar için müşteri hizmetleriyle iletişime geçin. Gerekli durumlarda iptal faturası düzenlenip yeni fatura oluşturulur. Fatura düzeltme işlemi <strong>3-5 iş günü</strong> sürebilir.",
        },
        {
          q: "Proforma fatura alabilir miyim?",
          a: "Evet, sipariş vermeden önce proforma fatura talep edebilirsiniz. Tedarikçiye mesaj göndererek veya ürün detay sayfasından proforma fatura isteğinizi iletebilirsiniz.",
        },
      ],
      ...
      taxVerifyInfo_items: [
        {
          q: "Vergi bilgileri nasıl doğrulanır?",
          a: "Girdiğiniz vergi bilgileri, GİB (Gelir İdaresi Başkanlığı) veritabanı ile otomatik olarak doğrulanır. Doğrulama işlemi birkaç dakika içinde tamamlanır ve sonuç hesabınızda görüntülenir.",
        },
        {
          q: "Vergi bilgisi doğrulaması başarısız oldu, ne yapmalıyım?",
          a: "Vergi numaranızı ve şirket unvanınızı doğru girdiğinizden emin olun. Bilgiler GİB kayıtları ile eşleşmelidir. Sorun devam ederse vergi levhanızın güncel olduğunu kontrol edin veya müşteri hizmetleriyle iletişime geçin.",
        },
        {
          q: "Yabancı şirketler vergi doğrulaması yapabilir mi?",
          a: "Evet, yabancı şirketler kendi ülkelerindeki vergi kayıt belgelerini yükleyerek doğrulama yapabilir. Belge incelemesi manuel olarak yapılır ve <strong>2-3 iş günü</strong> sürebilir.",
        },
      ],
      ...
      taxOrderManage_items: [
        {
          q: "Siparişlerimde vergi bilgilerini nasıl değiştiririm?",
          a: 'Sipariş onaylanmadan önce "Sipariş Detayları" bölümünden fatura/vergi bilgilerinizi değiştirebilirsiniz. Onaylanan siparişlerde değişiklik için müşteri hizmetleriyle iletişime geçin.',
        },
        {
          q: "Vergisiz sipariş verebilir miyim?",
          a: "Serbest bölge işlemleri ve bazı özel ticaret anlaşmaları kapsamında vergisiz sipariş verilebilir. Bu durumlar için gerekli belgeleri sipariş sırasında yüklemeniz gerekir.",
        },
        {
          q: "Toplu siparişlerde vergi hesaplaması nasıl yapılır?",
          a: "Toplu siparişlerde vergi, toplam sipariş tutarı üzerinden hesaplanır. Farklı KDV oranlarına tabi ürünler ayrı ayrı hesaplanarak toplam vergi tutarı belirlenir.",
        },
      ],
      ...
      shippingImportFees_items: [
        {
          q: "İthalat ücretleri nelerdir?",
          a: "İthalat ücretleri; <strong>gümrük vergisi</strong>, <strong>KDV</strong>, <strong>anti-damping vergisi</strong> (varsa), <strong>gümrük müşaviri ücreti</strong> ve <strong>liman hizmet bedeli</strong> gibi kalemlerden oluşabilir.",
        },
        {
        ...
        },
        {
          ...
          a: "Bazı ürün kategorileri serbest ticaret anlaşmaları kapsamında gümrük vergisinden muaf olabilir. Muafiyet durumu menşei ülke ve ürün kategorisine göre değişir. Detaylı bilgi için gümrük müşavirinize danışmanızı önerilir.",
        },
      ],
      ...
      receiptCompletion_items: [
        {
          q: "Sipariş tamamlanma onayı nedir?",
          a: 'Ürünü teslim aldıktan ve kontrol ettikten sonra "Siparişi Tamamla" butonuna tıklayarak siparişi onaylarsınız. Bu onay ile ödeme tedarikçiye serbest bırakılır. Onay vermezseniz 15 gün sonra otomatik olarak tamamlanır.',
        },
        {
          q: "Tamamlanma onayı vermeden iade yapabilir miyim?",
          a: 'Evet, ürünü teslim aldığınızda sorun varsa tamamlanma onayı vermeden "İade/Anlaşmazlık Başlat" seçeneğini kullanabilirsiniz. Bu durumda ödeme askıda kalır ve sorun çözülene kadar tedarikçiye aktarılmaz.',
        },
        {
          q: "Sipariş tamamlandıktan sonra değerlendirme yapabilir miyim?",
          a: "Evet, sipariş tamamlandıktan sonra ürün kalitesi, teslimat süresi ve tedarikçi iletişimi hakkında değerlendirme yapabilirsiniz. Değerlendirmeleriniz diğer alıcılara yardımcı olur.",
        },
      ],
      ...
      inspectionServices_items: [
        ...
        },
        {
          ...
          a: "<strong>Üretim öncesi denetim</strong> (hammadde kontrolü), <strong>üretim sırası denetim</strong> (süreç kontrolü), <strong>sevk öncesi denetim</strong> (son ürün kontrolü) ve <strong>konteyner yükleme denetimi</strong> hizmetleri sunulmaktadır.",
        },
        {
          q: "Denetim hizmeti nasıl talep edilir?",
          a: 'Sipariş detay sayfasından "Denetim Talep Et" butonuna tıklayarak veya müşteri hizmetleri üzerinden denetim talebinde bulunabilirsiniz. Denetim ücreti denetim türü ve konumuna göre belirlenir.',
        },
      ],
      ...
      inspectionMonitoring_items: [
        {
          q: "Üretim izleme hizmeti nedir?",
          a: "Üretim izleme, siparişinizin üretim sürecini başından sonuna kadar takip etmenizi sağlayan bir hizmettir. Düzenli fotoğraf/video güncellemeleri, ilerleme raporları ve kalite kontrol noktaları ile üretimi uzaktan izleyebilirsiniz.",
        },
        {
          q: "Üretim izleme ücretli mi?",
          a: "Temel üretim güncellemeleri (fotoğraf ve ilerleme raporu) ücretsizdir. Detaylı video izleme, canlı fabrika bağlantısı ve özel denetçi atama gibi premium hizmetler ek ücrete tabidir.",
        },
        {
          q: "Üretimde sorun tespit edilirse ne olur?",
          a: "Üretim izleme sırasında kalite sorunu veya sipariş spesifikasyonlarına uyumsuzluk tespit edilirse, hemen bilgilendirilirsiniz. Sorunun çözümü için tedarikçi ile koordinasyon sağlanır ve gerekirse Ticaret Güvencesi devreye girer.",
        },
      ],
      ...
      afterSalesDispute_items: [
        {
          q: "Sipariş anlaşmazlığı nasıl açılır?",
          a: '"Siparişlerim" sayfasından ilgili siparişi seçip "Anlaşmazlık Başlat" butonuna tıklayın. Sorununuzu açıklayın, kanıt (fotoğraf, video) ekleyin ve istediğiniz çözümü (iade, kısmi geri ödeme, yeniden gönderim) belirtin.',
        },
        {
        ...
        },
        {
          ...
          a: "Anlaşmazlık süresince ödemeniz güvenli şekilde askıda tutulur ve tedarikçiye aktarılmaz. Çözüm lehine sonuçlanırsa ödemeniz iade edilir.",
        },
      ],
      ...
      afterSalesDisputeProcess_items: [
        ...
        },
        {
          ...
          a: "Evet, arabuluculuk kararına 7 gün içinde itiraz edebilirsiniz. İtiraz, üst düzey bir arabuluculuk komitesi tarafından incelenir. Komitenin kararı nihaidir.",
        },
        {
      ...
      afterSalesGoodsIssue_items: [
        {
          q: "Yanlış ürün gönderildi, ne yapmalıyım?",
          a: 'Hemen fotoğraf çekin ve "Siparişlerim" sayfasından anlaşmazlık başlatın. Yanlış ürün gönderimi Ticaret Güvencesi kapsamındadır. Tedarikçi doğru ürünü yeniden göndermekle veya tam iade yapmakla yükümlüdür.',
        },
        {
        ...
        },
        {
          ...
          a: "Ürünü numune veya sipariş spesifikasyonları ile karşılaştırın. Farkları belgelendirerek anlaşmazlık başlatın. Kalite uyumsuzluğu Ticaret Güvencesi kapsamında değerlendirilir.",
        },
      ],
      ...
      afterSalesDisputeRules_items: [
        {
          q: "Anlaşmazlık açma süresi ne kadardır?",
          a: "Siparişin teslim alınmasından itibaren <strong>30 gün</strong> içinde anlaşmazlık açılabilir. Bu süre, sipariş otomatik tamamlanma süresinden önce işletilmelidir.",
        },
        {
          q: "Hangi konularda anlaşmazlık açılabilir?",
          a: "Ürün kalitesi, miktar eksikliği, yanlış ürün, teslimat gecikmesi, açıklama uyumsuzluğu ve hasarlı ürün konularında anlaşmazlık açılabilir. Her anlaşmazlık türü için farklı kanıt gereksinimleri uygulanır.",
        },
        {
          q: "Anlaşmazlıkta tarafların yükümlülükleri nelerdir?",
          a: "<strong>Alıcı:</strong> kanıt sunmak, iletişime yanıt vermek. <strong>Satıcı:</strong> 3 gün içinde yanıt vermek, çözüm önerisi sunmak. Yanıt vermeyen taraf aleyhine karar verilebilir.",
        },
      ],
      ...
      afterSalesRefund_items: [
        {
          q: "Geri ödeme nasıl yapılır?",
          a: "Anlaşmazlık veya iade sonucunda onaylanan geri ödemeler, orijinal ödeme yönteminize iade edilir. Kredi kartı ödemelerinde <strong>5-10 iş günü</strong>, banka havalelerinde <strong>3-5 iş günü</strong> içinde iade tamamlanır.",
        },
        {
          q: "Kısmi geri ödeme nedir?",
          a: "Ürünün bir kısmı hatalıysa veya küçük bir kalite sorunu varsa, tam iade yerine kısmi geri ödeme yapılabilir. Kısmi iade tutarı, sorunun boyutuna göre taraflar arasında veya arabuluculuk ile belirlenir.",
        },
        {
          q: "Geri ödeme durumumu nasıl takip ederim?",
          a: '"Siparişlerim" > "İadeler" bölümünden geri ödeme durumunuzu takip edebilirsiniz. İade onaylandığında, işlendiğinde ve tamamlandığında bildirim alırsınız.',
        },
      ],
      ...
      feedbackManagement_items: [
        {
          q: "Değerlendirme nasıl yapılır?",
          a: 'Sipariş tamamlandıktan sonra "Değerlendir" butonuna tıklayarak 1-5 yıldız puanlama ve yazılı yorum yapabilirsiniz. Ürün kalitesi, teslimat süresi ve tedarikçi iletişimi için ayrı puanlama yapılır.',
        },
        {
          q: "Değerlendirmemi düzenleyebilir veya silebilir miyim?",
          a: "Değerlendirmenizi yayınlandıktan sonraki <strong>30 gün</strong> içinde düzenleyebilirsiniz. Silme işlemi için müşteri hizmetleriyle iletişime geçmeniz gerekir. Gerçeğe aykırı değerlendirmeler kaldırılabilir.",
        },
        {
          q: "Fotoğraflı değerlendirme nasıl yaparım?",
          a: 'Değerlendirme formunda "Fotoğraf Ekle" butonuna tıklayarak ürün fotoğraflarınızı yükleyebilirsiniz. Fotoğraflı değerlendirmeler diğer alıcılar için daha faydalıdır ve ekstra puan kazandırır.',
        },
      ],
      ...
      feedbackRules_items: [
        {
          q: "Hangi değerlendirmeler yasaktır?",
          a: "Kişisel saldırı, hakaret, ırkçılık, reklam içerikli, gerçeğe aykırı ve rakip ürün tanıtımı yapan değerlendirmeler yasaktır. Bu tür değerlendirmeler tespit edildiğinde kaldırılır.",
        },
        {
          q: "Sahte değerlendirmeyi nasıl bildiririm?",
          a: 'Değerlendirmenin altındaki "Bildir" butonuna tıklayarak sahte veya uygunsuz değerlendirmeleri bildirebilirsiniz. Ekibimiz bildirimi <strong>48 saat</strong> içinde inceler.',
        },
        {
          q: "Değerlendirme puanım satıcı statümü etkiler mi?",
          a: "Evet, satıcı olarak aldığınız değerlendirme puanları arama sıralamanızı, Verified statünüzü ve platform üzerindeki görünürlüğünüzü doğrudan etkiler.",
        },
      ],
      ...
      securityFraud_items: [
        ...
        },
        {
          ...
          a: "Hemen şifrenizi değiştirin ve iki faktörlü doğrulamayı etkinleştirin. Yetkisiz işlemler varsa müşteri hizmetlerini arayın. Hesabınız geçici olarak dondurulabilir ve güvenlik incelemesi yapılabilir.",
        },
      ],
      ...
      securityIpr_items: [
        {
          q: "IPR (Fikri Mülkiyet Hakları) şikayeti nasıl yapılır?",
          a: '"Güvenlik Merkezi" > "IPR Şikayet" bölümünden fikri mülkiyet hakkı ihlali bildiriminde bulunabilirsiniz. Marka tescil belgesi, patent belgesi veya telif hakkı kanıtını yüklemeniz gerekir.',
        },
        {
          q: "IPR şikayeti sonrası ne olur?",
          a: "Şikayetiniz <strong>3-5 iş günü</strong> içinde incelenir. İhlal tespit edilirse ilgili ürün listesi kaldırılır ve satıcıya uyarı verilir. Tekrarlayan ihlallerde satıcı hesabı askıya alınabilir.",
        },
        {
          q: "Yanlış IPR şikayeti yapılırsa ne olur?",
          a: "İtham edilen satıcı itiraz hakkına sahiptir. Yeterli kanıt sunulursa ürün yeniden listelenir. Kasıtlı olarak yanlış IPR şikayeti yapan kullanıcılara yaptırım uygulanabilir.",
        },
      ],
      ...
      othersCustomerService_items: [
        {
          ...
          a: "Müşteri hizmetlerine <strong>canlı sohbet</strong>, <strong>telefon</strong> (0800 123 45 67), <strong>e-posta</strong> (support@istoc.com) ve <strong>destek talebi</strong> oluşturarak ulaşabilirsiniz. Canlı sohbet 7/24 hizmet vermektedir.",
        },
        {
        ...
        },
        {
          ...
          a: "Canlı sohbette ortalama <strong>2-5 dakika</strong>, e-posta ile <strong>12-24 saat</strong> ve destek talebi ile <strong>24-48 saat</strong> içinde yanıt alabilirsiniz. Acil durumlar için telefon hattını kullanmanızı öneriyoruz.",
        },
      ],
      ...
      othersUnclearConcern_items: [
        {
          q: "Sorunumu hangi kategoriye bildireceğimi bilmiyorum, ne yapmalıyım?",
          a: "Endişenizi genel destek kanalından iletebilirsiniz. Müşteri temsilcimiz sorununuzu analiz edip doğru ekibe yönlendirecektir. Canlı sohbet üzerinden hızlıca yardım alabilirsiniz.",
        },
        {
          q: "Geri bildirim veya öneri göndermek istiyorum, nasıl yapabilirim?",
          a: 'Sayfanın altındaki "Geri Bildirim" bağlantısından veya Hesap > Geri Bildirim bölümünden önerilerinizi iletebilirsiniz. Her geri bildirim değerlendirilerek platform iyileştirmelerine katkı sağlar.',
        },
        {
          q: "Platform hatası bildirmek istiyorum, nasıl yapabilirim?",
          a: 'Teknik hataları "Destek Talebi Oluştur" > "Teknik Sorun" kategorisinden bildirebilirsiniz. Hata ekran görüntüsü ve hangi cihaz/tarayıcıda yaşandığı bilgisini eklemeniz çözüm süresini hızlandırır.',
        },
      ],
      ...
      othersOfflineService_items: [
        ...
        },
        {
          ...
          a: "İletişim sayfamızdan veya müşteri hizmetleri üzerinden yüz yüze görüşme randevusu alabilirsiniz. Randevular genellikle <strong>2-3 iş günü</strong> öncesinden planlanmalıdır.",
        },
      ],
      ...
      promotionsShoppingGuide_items: [
        ...
        },
        {
          ...
          a: "Ticaret Güvencesi kapsamındaki tedarikçileri tercih edin, numune almadan büyük sipariş vermeyin, platform dışı ödeme yapmayın ve tedarikçi değerlendirmelerini mutlaka okuyun.",
        },
      ],
      ...
      promotionsScenario_items: [
        {
          q: "Senaryolu promosyon nedir?",
          a: 'Belirli koşullar sağlandığında otomatik olarak uygulanan indirimlerdir. Örneğin: "3 ürün al, 1 ürün bedava" veya "500 TL üzeri alışverişe %10 indirim" gibi senaryolar uygulanır.',
        },
        {
          q: "Aktif promosyonları nasıl görebilirim?",
          a: 'Ana sayfadaki "Kampanyalar" bölümünden veya ürün detay sayfalarındaki promosyon etiketlerinden aktif kampanyaları görebilirsiniz. Ayrıca e-posta bültenleri ile kampanyalardan haberdar olabilirsiniz.',
        },
        {
          q: "Promosyonlar birleştirilebilir mi?",
          a: "Genellikle kampanyalar birleştirilemez. Her siparişe en avantajlı tek bir promosyon uygulanır. İstisnalar kampanya detaylarında belirtilir.",
        },
      ],
      ...
      promotionsSuper_items: [
        {
          q: "Süper Promosyon etkinlikleri ne zaman yapılır?",
          a: "Süper Promosyon etkinlikleri yılda birkaç kez düzenlenir: <strong>Bahar Festivali</strong>, <strong>Yaz İndirimleri</strong>, <strong>Kasım Kampanyası</strong> ve <strong>Yıl Sonu Fırsatları</strong> başlıca etkinliklerdir.",
        },
        {
          q: "Süper Promosyon'a nasıl katılırım?",
          a: "Etkinlik dönemlerinde ana sayfada özel kampanya alanı oluşturulur. E-posta bildirimleri açık olan kullanıcılar önceden bilgilendirilir. Stoklar sınırlı olduğundan erken harekete geçmenizi öneriyoruz.",
        },
        {
          q: "Flash Sale (Anlık İndirim) nedir?",
          a: 'Flash Sale, sınırlı süre ve sınırlı stokla sunulan çok avantajlı indirimlerdir. Genellikle 24 veya 48 saat sürer. Flash Sale ürünleri "Anlık Fırsatlar" bölümünden takip edilebilir.',
        },
      ],
      ...
      promotionsPayment_items: [
        ...
        },
        {
          ...
          a: "Yeni kayıt olan kullanıcılar için genellikle ilk sipariş indirimi sunulmaktadır. İndirim tutarı ve koşulları dönemsel olarak değişebilir.",
        },
        {
          q: "Kupon kodu nasıl kullanılır?",
          a: 'Ödeme sayfasında "Kupon Kodu" alanına kodunuzu girin ve "Uygula" butonuna tıklayın. Kupon indirimi sipariş toplamından otomatik düşülür. Her kuponun kullanım koşulları ve geçerlilik süresi farklıdır.',
        },
      ],
      ...
      promotionsOtherIssues_items: [
        {
          q: "Promosyon uygulanmadı, ne yapmalıyım?",
          a: "Promosyonun geçerlilik süresini, minimum sipariş tutarını ve kapsam dışı ürünleri kontrol edin. Koşulları sağlamanıza rağmen uygulanmadıysa müşteri hizmetleriyle iletişime geçin.",
        },
        {
          q: "Kampanya ürünü iade edilirse indirim ne olur?",
          a: "Kampanyalı ürün iade edildiğinde, indirimli tutar üzerinden geri ödeme yapılır. Eğer iade, kampanya koşulunu bozan bir durum oluşturursa (örn. minimum adet altına düşme) kalan ürünlere indirim uygulanmayabilir.",
        },
        {
          q: "Satıcı olarak kampanya nasıl oluştururum?",
          a: 'Satıcı panelinden "Promosyonlar" > "Yeni Kampanya Oluştur" bölümünden indirim türü, oran, süre ve kapsam belirleyerek kampanya oluşturabilirsiniz.',
        },
      ],
      ...
      guaranteedAfterSales_items: [
        ...
        },
        {
          ...
          a: "Standart garanti süresi siparişin tamamlanmasından itibaren <strong>60 gün</strong>dır. Gold ve Verified üyelerde bu süre 90 güne çıkar.",
        },
        {
          q: "Garanti kapsamında olmayan durumlar nelerdir?",
          a: "Kullanıcı hatası, normal aşınma, doğal afet zararları, yetkisiz modifikasyon ve sipariş spesifikasyonlarına uygun ürünlerdeki subjektif memnuniyetsizlik garanti kapsamı dışındadır.",
        },
      ],
      ...
      guaranteedPreSales_items: [
        {
          q: "Garantili Ön Satış nedir?",
          a: "Sipariş vermeden önce tedarikçi doğrulama, numune kalite güvencesi ve fiyat koruma gibi hizmetleri kapsayan bir programdır. Alıcıların doğru tedarikçiyi seçmesine yardımcı olur.",
        },
        {
          q: "Numune kalite güvencesi nasıl çalışır?",
          a: "Garanti kapsamında gönderilen numuneler, nihai siparişle aynı kalitede olmalıdır. Numune ile nihai ürün arasında önemli fark tespit edilirse tam iade veya yeniden üretim garanti edilir.",
        },
        {
          q: "Fiyat koruma garantisi nedir?",
          a: "Sipariş sonrası tedarikçinin tek taraflı olarak fiyat artırması durumunda, orijinal anlaşma fiyatı korunur. Bu koruma sipariş onayından sevkiyata kadar geçerlidir.",
        },
      ],
      ...
      guaranteedPlaceOrder_items: [
        {
          q: "Garantili Sipariş nedir?",
          a: "Ticaret Güvencesi kapsamında verilen siparişlerde ödemeniz, ürün teslim alınıp onaylanana kadar güvende tutulur. Sorun yaşandığında tam veya kısmi geri ödeme garanti edilir.",
        },
        {
        ...
        },
        {
          ...
          a: "Ücretsiz üyelikte sipariş koruma limiti <strong>50.000 TL</strong>, Gold üyelikte <strong>250.000 TL</strong> ve Verified üyelikte <strong>1.000.000 TL</strong>'dir.",
        },
      ],
      ...
      guaranteedOverseasWarehouse_items: [
        ...
        },
        {
          ...
          a: "Şu anda <strong>Almanya</strong>, <strong>ABD</strong>, <strong>İngiltere</strong>, <strong>BAE</strong> ve <strong>Japonya</strong>'da doğrulanmış depolarımız bulunmaktadır. Yeni lokasyonlar sürekli eklenmektedir.",
        },
        {
      ...
      appSettingsLabel_items: [
        ...
        },
        {
          ...
          a: "Uygulama içinden Ayarlar > Bildirimler bölümünden push bildirimlerini yönetebilirsiniz. Sipariş güncellemeleri, mesajlar, kampanyalar ve güvenlik uyarıları için ayrı ayrı açma/kapama yapabilirsiniz.",
        },
        {
          q: "Uygulama dilini nasıl değiştiririm?",
          a: "Uygulama Ayarları > Dil & Bölge bölümünden uygulamanın arayüz dilini değiştirebilirsiniz. Türkçe ve İngilizce seçenekleri mevcuttur.",
        },
        {
          q: "Uygulama çok yer kaplıyor, ne yapmalıyım?",
          a: "Ayarlar > Depolama bölümünden önbelleği temizleyebilirsiniz. Ayrıca otomatik medya indirme ayarlarını kapatarak veri kullanımını azaltabilirsiniz.",
        },
      ],
      ...
      localizationSettings_items: [
        {
          q: "Platform dilini nasıl değiştiririm?",
          a: "Sayfanın üst kısmındaki dil seçicisinden veya Hesap Ayarları > Dil & Bölge bölümünden platform dilini değiştirebilirsiniz. Değişiklik anında uygulanır.",
        },
        {
        ...
        },
        {
          ...
          a: "Dil seçicisinin yanındaki para birimi seçicisinden tercih ettiğiniz para birimini seçebilirsiniz. Fiyatlar seçtiğiniz para birimine dönüştürülerek gösterilir. Döviz kurları günlük olarak güncellenir.",
        },
        {
    ...
    sellPage: {
      ...
      successDesc:
        "Satıcı hesabınız 1-2 iş günü içinde aktifleştirilecektir. E-posta adresinize onay bildirimi gönderilecektir.",
      ...
      yearlyUpfrontVatExcl: "KDV hariç",
      monthlyCancelAnytime: "aylık · istediğin zaman iptal",
      yearlyBilled: "yıllık {{amount}} peşin",
      monthlyYearTotal: "yılda {{amount}}",
      pricedByVolume: "hacme göre fiyatlandırılır",
      continue: "Devam et",
      packageContents: "Paket içeriği",
      sampleSales: "Numune satışı",
      bulkUploadCsv: "Toplu yükleme (CSV)",
      matrixStorefront: "Vitrin & sergileme",
      manufacturerBadge: "Üretici rozeti",
      tierStandard: "Standart",
      tierSilver: "Gümüş",
      tierGold: "Altın",
      storefrontType: "Vitrin tipi",
      tierFullyCustom: "Tam özel",
      multiLanguage: "Çoklu dil",
      langCount2: "2 dil",
      langCount4: "4 dil",
      langCount6: "6 dil",
      langCount15Plus: "15+ dil",
      videoMedia360: "Video & 360° ürün medya",
      featuredListingPerMonth: "Öne çıkan listeleme / ay",
      matrixSupport: "Destek & operasyon",
      support: "Destek",
      supportPriority: "Öncelikli",
      supportAccountMgr: "Hesap yön.",
      support247Dedicated: "7/24 dedicated",
      ...
      apiAccessHelp: "Sipariş, stok, fiyat eşitleme",
      limited: "Limitli",
      full: "Tam",
      customSla: "Özel SLA",
      erpIntegration: "ERP / muhasebe entegrasyonu",
      customPaymentTerms: "Özel ödeme koşulları",
      customSubdomain: "Alt domain (markaniz.istoc.com)",
      matrixCommissionLimits: "Komisyon & limitler",
      salesCommission: "Satış komisyonu",
      salesCommissionHelp: "Tamamlanan siparişler üzerinden",
      ...
      b2cFocused: "B2C ağırlıklı",
      commissionRate: "Komisyon oranı",
      variable12to30: "Değişken %12–30",
      monthlyMembership: "Aylık üyelik",
      none: "Yok",
      listingFee: "Listeleme ücreti",
      perProductFee: "Ürün başı ücret",
      paymentPeriod: "Ödeme süresi",
      days7: "7 gün",
      days14to30: "14 — 30 gün",
      ...
      allProducts: "Tüm Ürünler",
      companyProfile: "Şirket Profili",
      detailedProfile: "Detaylı Profil",
      searchInStore: "Bu Mağazada Ara",
      sectionCategories: "Kategoriler",
      sectionPopularProducts: "Popüler Ürünler",
      sectionCompanyInfo: "Şirket Bilgisi",
      sectionCertificates: "Sertifikalar",
    ...
    mockData: {
      cart: {
        product1Title:
          "Erkek Nefes Alabilen Boy Uzatıcı Yumuşak Yastıklı Moda Açık Hava Spor Ayakkabıları Kırış Yürüyüş Botları Kış İstikamet Yaz",
        ...
        product2Title:
          "Erkek hafif açık ayakkabı deri aşınmaya dayanıklı yürüyüş tırmanma arazisinden spor ayakkabılar",
      ...
      tickets: {
        ...
        t13Msg1:
          "Verified satıcı statüsüne geçmek istiyorum. Gerekli belgeleri nereden yükleyebilirim?",
      ...
      rfqData: {
        ...
        testimonial2Quote:
          "Platformdaki AI destekli eşleştirme özelliği tam ihtiyacımız olan tedarikçileri öneriyor. İlk siparişimizden itibaren kaliteden memnunuz. Kesinlikle tavsiye ederim.",
        testimonial2Name: "Ayşe Demir",
        testimonial2Title: "Genel Müdür",
        testimonial2Company: "Demir Gıda San. Tic. Ltd. Şti.",
        testimonial3Quote:
          "Yurt dışı tedarikçilerle iletişim kurmak hiç bu kadar kolay olmamıştı. Güvenli ödeme sistemi ve şeffaf süreç yönetimi ile toptan alımlarımızı büyük ölçüde kolaylaştırdık.",
  ...
  mockProduct: {
    ...
    descIntro:
      "Bu premium kolye ucu, dayanıklılığı ve hipoalerjenik özellikleriyle bilinen 316L paslanmaz çelikten üretilmiştir. 18K altın kaplama, uzun ömürlü lüks bir görünüm sağlarken, IP67 su geçirmezlik derecesi duş ve yüzme dahil günlük kullanıma dayanmasını garanti eder.",
    ...
    descUsage:
      "Günlük kullanım, özel günler ve hediye için mükemmel. Premium kaliteyi rekabetçi toptan fiyatlarla arayan butik sahipleri, takı perakendecileri ve online satıcılar için ideal. 500 adet üzeri siparişlerde OEM/ODM özelleştirme mevcuttur.",
    descQcTitle: "Kalite Kontrol",
    descQc:
      "Her parça 3 aşamalı kalite kontrolünden geçer: malzeme bileşim testi, kaplama kalınlığı ölçümü ve su geçirmezlik sızıntı doğrulaması. Talep üzerine SGS ve ROHS sertifikaları sunulabilir.",
    ...
    countryIT: "İtalya",
    rev1Comment:
      "Mükemmel kalite, tam açıklandığı gibi. Altın kaplama kalın ve premium hissiyat veriyor. 500 adet sipariş ettim ve sadece 2 tanede küçük kusur vardı. Tekrar sipariş vereceğim.",
    rev1Reply:
    ...
    rev3Reply:
      "Sürekli güveniniz için teşekkür ederiz! Sadık müşterilerimize değer veriyor ve her zaman en iyisi için çalışıyoruz.",
    rev3Product: "Rose Gold Titanyum Yüzük Seti",
    rev4Comment:
      "Fiyat noktasına göre güzel kalite. Ambalaj geliştirilebilir ama takının kendisi iyi yapılmış.",
    rev4Product: "Minimalist Gümüş Kolye Ucu Zincir",
    rev5Comment:
      "Bu platformda çalıştığım en iyi tedarikçi. İletişim hızlı, kalite tutarlı ve özel tasarımlarda çok yardımcı oluyorlar.",
    rev5Reply:
      "Harika değerlendirme için teşekkür ederiz! Bir sonraki işbirliğimizi dört gözle bekliyoruz.",
    rev5Product: "Özel Logo Charm Bileklik Seti",
    rev6Comment:
      "Ürün kalitesi fena değil ama bazı ürünlerde yanlış beden aldım. Müşteri hizmetleri çözdü ama zaman aldı.",
    rev6Reply:
      "Beden sorunu için özür dileriz. Bu durumu önlemek için kalite kontrol sürecimizi iyileştirdik. Bir sonraki siparişinize indirim uygulanacaktır.",
  ...
  sellerMock: {
    ...
    companyDesc:
      "Anadolu Endüstriyel Ölçüm Sistemleri, 2004 yılından bu yana elektrik, su ve gaz sayaçlarının önde gelen üreticisidir. Ankara, Türkiye'de bulunan 15.000m2 tesisimiz, Afrika, Orta Doğu ve Asya pazarları için yıllık 500.000'den fazla sayaç üretmektedir.",
    companyDescExt:
      "IEC, MID ve CE sertifikalarıyla hem standart hem de özel ölçüm çözümleri sunuyoruz. 45 mühendislik uzmanından oluşan Ar-Ge ekibimiz, LoRa, NB-IoT ve GPRS iletişim modülleri dahil akıllı ölçüm teknolojilerini sürekli geliştirmektedir.",
    ...
    contactPlaceholder:
      "Tedarikçiye mesajınızı yazın. Ürün detayları, miktar, özelleştirme gereksinimlerini belirtebilirsiniz...",
  ...
  dropshipping: {
    ...
    autoApprovalDesc:
      "Bu özellik etkinleştirildiğinde, gelen dropshipping siparişleri otomatik olarak onaylanacaktır.",
    autoApprovalLegal:
      "Siparişlerin otomatik olarak onaylanacağını ve ilgili şartları kabul ediyorum.",
  ...
  chat: {
    ...
    send: "Gönder",
    placeholderInput: "Lütfen mesajınızı buraya girin",
    minOrder: "Min. Sipariş",
    product: "Ürün",
    read: "Okundu",
    quickActions: {
      rateSeller: "Tedarikçiyi puanlayın",
      viewPaymentMethods: "Tüm ödeme yöntemlerini görüntüleyin",
      fileComplaint: "Şikayet oluşturun",
      sendLogisticsRequest: "Lojistik talebi gönderin",
    },
    context: {
      pin: "Üst tarafa sabitle",
      block: "Engelle",
      delete: "Sil",
      mute: "Sesi kapat",
    },
    subMenu: {
      ...
      callSchedule: "Görüşme planla",
      cardTitle: "Kartvizit gönder",
      cardSend: "Gönder",
      cardEdit: "Düzenle",
    },
    businessCard: {
    ...
    emptyInbox: "Henüz mesajınız yok.",
    ...
    emptyThread: "Henüz mesaj yok. Selamlaşmakla başlayın 👋",
    orderCard: {
      title: "Sipariş Ver",
      status: "Siparişi durumu",
      total: "Toplam",
      shippingDate: "Anlaşılan gönderim tarihi",
