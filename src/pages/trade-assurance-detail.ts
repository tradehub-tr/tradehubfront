    ...
    <section class="relative overflow-hidden" style="background-color:#FFC200; background-image:url('${taShieldPattern}'); background-size:cover; background-position:center; padding:80px 0 110px;">
      <div class="container-boxed px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <!-- 1: Güvenli Ödeme -->
          <a href="/odeme-secenekleri" class="block bg-white rounded-md p-6 pt-7 [@media(hover:hover)_and_(pointer:fine)]:hover:shadow-lg transition-shadow">
          ...
          <a href="/iade-politikasi" class="block bg-white rounded-md p-6 pt-7 [@media(hover:hover)_and_(pointer:fine)]:hover:shadow-lg transition-shadow">
            <div class="w-12 h-12 rounded-full flex items-center justify-center mb-5" style="background:#FFF3C4">
          ...
          <!-- 3: Özel Temsilci -->
          <a href="#" class="block bg-white rounded-md p-6 pt-7 [@media(hover:hover)_and_(pointer:fine)]:hover:shadow-lg transition-shadow">
            <div class="w-12 h-12 rounded-full flex items-center justify-center mb-5" style="background:#FFF3C4">
  ...
  return `
    <section class="bg-[#f5f5f5] py-16 sm:py-20 lg:py-24">
      <div class="container-boxed px-3 sm:px-4 lg:px-6">
        ...
        <div class="mb-10">
          <a href="/kargo-lojistik" class="inline-flex items-center justify-center border-2 border-gray-800 text-gray-800 [@media(hover:hover)_and_(pointer:fine)]:hover:bg-gray-800 [@media(hover:hover)_and_(pointer:fine)]:hover:text-white font-semibold rounded-full px-6 py-3 text-sm sm:text-base transition-colors">
