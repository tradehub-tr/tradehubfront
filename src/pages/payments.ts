      ...
      <div class="relative container-boxed px-3 sm:px-4 lg:px-6 flex flex-col justify-center" style="min-height:320px">
        <div class="max-w-[550px] py-12 sm:py-16 lg:py-20">
          ...
          <h1 class="text-3xl sm:text-4xl lg:text-[42px] font-bold text-white leading-tight mb-4">
            ${t('infoPages.paymentsHeroTitle')}
          </h1>
          <p class="text-white/80 text-base sm:text-lg">
            ${t('infoPages.paymentsHeroSubtitle')}
          </p>
        </div>
      </div>
    </section>
    ...
    <div class="bg-white border-b border-gray-100">
      <div class="container-boxed px-3 sm:px-4 lg:px-6 py-4">
        <nav class="flex items-center gap-2 text-sm text-gray-500">
          <a href="/ticaret-guvencesi/detay" class="hover:text-gray-700 transition-colors">${t('infoPages.tradeAssurance')}</a>
          ...
          <span class="text-gray-700">${t('infoPages.paymentsHeroTitle')}</span>
        </nav>
      </div>
    </div>
    ...
    <section class="bg-white py-12 sm:py-16 lg:py-20">
      <div class="container-boxed px-3 sm:px-4 lg:px-6">
        ...
        <h2 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
          ${t('infoPages.paymentsSafetyTitle')}
        </h2>
        <p class="text-gray-600 text-base sm:text-lg leading-relaxed max-w-[900px] mb-12">
          ${t('infoPages.paymentsSafetyIntro')}
          <strong class="text-gray-900">${t('infoPages.paymentsSafetyWarning')}</strong>
        </p>

        <!-- 4 Payment Methods -->
        <h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-6">${t('infoPages.paymentsMethodsTitle')}</h3>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">

          <!-- Method 1: Banka Havalesi -->
          <div class="border border-gray-200 rounded-md hover:shadow-lg transition-shadow duration-200 p-6">
            ...
            <h3 class="text-lg font-bold text-gray-900 mb-2">${t('infoPages.paymentBankTransferTitle')}</h3>
            <p class="text-gray-600 text-sm leading-relaxed mb-3">
              ${t('infoPages.paymentBankTransferDesc')}
            </p>
            <div class="flex items-center gap-2 text-xs text-gray-500 pt-3 border-t border-gray-100">
              ...
              <span>${t('infoPages.paymentBankTransferTag')}</span>
            </div>
          </div>
          ...
          <div class="border border-gray-200 rounded-md hover:shadow-lg transition-shadow duration-200 p-6">
            ...
            <h3 class="text-lg font-bold text-gray-900 mb-2">${t('infoPages.paymentEftTitle')}</h3>
            <p class="text-gray-600 text-sm leading-relaxed mb-3">
              ${t('infoPages.paymentEftDesc')}
            </p>
            <div class="flex items-center gap-2 text-xs text-gray-500 pt-3 border-t border-gray-100">
              <svg class="w-4 h-4 text-emerald-600" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"/></svg>
              <span>${t('infoPages.paymentEftTag')}</span>
            </div>
          </div>
          ...
          <div class="border border-gray-200 rounded-md hover:shadow-lg transition-shadow duration-200 p-6">
            ...
            <h3 class="text-lg font-bold text-gray-900 mb-2">${t('infoPages.paymentChequeTitle')}</h3>
            <p class="text-gray-600 text-sm leading-relaxed mb-3">
              ${t('infoPages.paymentChequeDesc')}
            </p>
            <div class="flex items-center gap-2 text-xs text-gray-500 pt-3 border-t border-gray-100">
              <svg class="w-4 h-4 text-emerald-600" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"/></svg>
              <span>${t('infoPages.paymentChequeTag')}</span>
            </div>
          </div>
          ...
          <div class="border border-gray-200 rounded-md hover:shadow-lg transition-shadow duration-200 p-6">
            ...
            <h3 class="text-lg font-bold text-gray-900 mb-2">${t('infoPages.paymentInstallmentTitle')}</h3>
            <p class="text-gray-600 text-sm leading-relaxed mb-3">
              ${t('infoPages.paymentInstallmentDesc')}
            </p>
            <div class="flex items-center gap-2 text-xs text-gray-500 pt-3 border-t border-gray-100">
              <svg class="w-4 h-4 text-emerald-600" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"/></svg>
              <span>${t('infoPages.paymentInstallmentTag')}</span>
            </div>
          </div>
        ...
        <div class="bg-gradient-to-r from-amber-50 to-yellow-50 rounded-lg border border-amber-200 p-6 sm:p-8 mb-16">
          <div class="flex flex-col md:flex-row items-start md:items-center gap-5">
            ...
            <div class="flex-1">
              <h3 class="text-lg sm:text-xl font-bold text-gray-900 mb-2">${t('infoPages.currencyBannerTitle')}</h3>
              <p class="text-gray-700 text-sm sm:text-base leading-relaxed mb-3">
                ${t('infoPages.currencyBannerDesc')}
              </p>
        ...
        <h2 id="process" class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-10">
          ${t('infoPages.paymentProcessTitle')}
        </h2>
        ...
        <div class="mb-16">
          ...
          <div class="flex items-stretch gap-7 relative">
            ...
            <div class="pb-10" style="padding-top:10px">
              <h3 class="text-lg sm:text-xl font-bold text-gray-900 mb-2">${t('infoPages.paymentProcessStep1Title')}</h3>
              <p style="color:#444;font-size:16px" class="leading-relaxed">
                ${t('infoPages.paymentProcessStep1Desc')}
              </p>
            </div>
          </div>
          ...
          <div class="flex items-stretch gap-7 relative">
            ...
            <div class="pb-10" style="padding-top:10px">
              <h3 class="text-lg sm:text-xl font-bold text-gray-900 mb-2">${t('infoPages.paymentProcessStep2Title')}</h3>
              <p style="color:#444;font-size:16px" class="leading-relaxed">
                ${t('infoPages.paymentProcessStep2Desc')}
              </p>
            </div>
          </div>
          ...
          <div class="flex items-stretch gap-7 relative">
            ...
            <div class="pb-10" style="padding-top:10px">
              <h3 class="text-lg sm:text-xl font-bold text-gray-900 mb-2">${t('infoPages.paymentProcessStep3Title')}</h3>
              <p style="color:#444;font-size:16px" class="leading-relaxed">
                ${t('infoPages.paymentProcessStep3Desc')}
              </p>
            </div>
          </div>
          ...
          <div class="flex items-start gap-7 relative">
            ...
            <div style="padding-top:10px">
              <h3 class="text-lg sm:text-xl font-bold text-gray-900 mb-2">${t('infoPages.paymentProcessStep4Title')}</h3>
              <p style="color:#444;font-size:16px" class="leading-relaxed">
                ${t('infoPages.paymentProcessStep4Desc')}
              </p>
            </div>
          </div>
