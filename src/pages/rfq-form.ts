    ...
    <div class="border-b border-gray-200">
      <div class="container-boxed flex items-center gap-4 py-3">
        <div class="flex items-center gap-2">
          <span class="inline-flex items-center justify-center w-7 h-7 rounded bg-(--btn-bg,#ff8600) text-(--btn-text,#1a1a1a) text-xs font-bold">RFQ</span>
    ...
    <div class="container-boxed py-8">
      ...
      <form id="rfq-detail-form" novalidate>
            ...
            <div class="w-[300px] max-sm:hidden max-lg:w-full shrink-0 max-lg:shrink">
              <div class="border border-gray-100 rounded-lg bg-[#f5f5f5] px-7 py-6">
                ...
                <div class="space-y-5">
                  ...
                  <div class="flex gap-3"><span class="flex items-center justify-center w-7 h-7 rounded-full bg-(--btn-bg,#ff8600) text-(--btn-text,#1a1a1a) text-sm font-bold shrink-0">3</span><div><p class="text-sm font-semibold text-gray-800">${t('rfq.step3Title')}</p><p class="text-xs text-gray-500 mt-0.5">${t('rfq.step3Desc')}</p></div></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="sticky bottom-0 z-10 mt-5 py-3 flex justify-center bg-white/90 backdrop-blur-sm">
          <button type="submit" class="px-16 h-11 rounded-full bg-(--btn-bg,#ff8600) hover:bg-(--btn-hover-bg,#db7300) active:bg-(--btn-hover-bg,#db7300) text-(--btn-text,#1a1a1a) text-sm font-semibold border border-(--btn-border-color,#db7300) active:scale-[0.97] transition-[transform,background-color] duration-150 motion-reduce:transition-none motion-reduce:active:scale-100">
            ${t('rfq.postRequest')}
          </button>
        </div>
      </form>
