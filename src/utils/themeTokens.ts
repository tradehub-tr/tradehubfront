    ...
    tokens: [
      {
        var: "--shadow-sm",
        type: "text",
        default: "0 1px 2px 0 rgba(0,0,0,0.04), 0 1px 3px 0 rgba(0,0,0,0.06)",
      },
      {
        var: "--shadow-md",
        type: "text",
        default: "0 2px 4px -1px rgba(0,0,0,0.04), 0 4px 8px -1px rgba(0,0,0,0.08)",
      },
      {
        var: "--shadow-lg",
        type: "text",
        default: "0 4px 8px -2px rgba(0,0,0,0.06), 0 12px 24px -4px rgba(0,0,0,0.10)",
      },
      {
        var: "--shadow-xl",
        type: "text",
        default: "0 8px 16px -4px rgba(0,0,0,0.06), 0 24px 48px -8px rgba(0,0,0,0.12)",
      },
    ],
  },
  {
    ...
    tokens: [
      {
        var: "--animate-fade-in",
        type: "text",
        default: "fade-in var(--duration-default) var(--ease-default)",
      },
      {
        var: "--animate-fade-out",
        type: "text",
        default: "fade-out var(--duration-default) var(--ease-default)",
      },
    ],
  },
  {
    ...
    tokens: [
      {
        ...
        options: [
          ...
          },
          {
            ...
            google: "Poppins:wght@100;200;300;400;500;600;700;800;900",
          },
          {
            label: "Montserrat",
          ...
          },
          {
            ...
            google: "Lato:wght@100;300;400;700;900",
          },
          {
            label: "Nunito",
          ...
          },
          {
            ...
            google: "Plus+Jakarta+Sans:wght@200..800",
          },
          {
            label: "DM Sans",
      ...
      },
      {
        ...
        options: [
          {
            label: "System Mono",
            value: "ui-monospace, 'Cascadia Code', 'Fira Code', monospace",
            google: null,
          },
          {
            label: "Fira Code",
          ...
          },
          {
            ...
            google: "Source+Code+Pro:wght@200..900",
          },
          {
            label: "IBM Plex Mono",
            value: "'IBM Plex Mono', ui-monospace, monospace",
            google: "IBM+Plex+Mono:wght@100..700",
          },
          {
            label: "Space Mono",
          ...
          },
          {
            ...
            google: "Inconsolata:wght@200..900",
          },
        ],
      },
    ],
...
export const componentEditors: ComponentEditor[] = [
  {
    ...
    outlineTokens: [
      ...
      },
      {
        ...
        label: "Outline Hover Background",
      },
      {
...
export const sectionEditors: SectionEditor[] = [
  ...
  },
  {
    ...
    tokens: [
      ...
      {
        var: "--search-image-link-color",
        type: "color",
        default: "#6b7280",
        label: "Image Search Link",
      },
      { var: "--search-dropdown-bg", type: "color", default: "#ffffff", label: "Dropdown BG" },
      {
        var: "--search-dropdown-border",
        type: "color",
        default: "#fcd34d",
      ...
      {
        var: "--search-dropdown-muted",
        type: "color",
        default: "#9ca3af",
        label: "Dropdown Muted",
      },
  ...
  },
  {
    ...
    tokens: [
      ...
      {
        var: "--mega-card-hover-border",
        type: "color",
        default: "#fcd34d",
        label: "Card Hover Border",
      },
      {
        var: "--mega-sidebar-active-border",
        type: "color",
        default: "#e1b533",
        label: "Sidebar Active Border",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    tokens: [
      ...
      {
        var: "--mfr-ranking-heading-color",
        type: "color",
        default: "#222222",
        label: "Ranking Heading",
      },
      {
        var: "--mfr-ranking-label-color",
        type: "color",
        default: "#666666",
        label: "Ranking Label",
      },
  ...
  },
  {
    ...
    tokens: [
      ...
      {
        var: "--catpopup-sidebar-active-bg",
        type: "color",
        default: "#ffffff",
        label: "Active BG",
      },
      ...
      { var: "--catpopup-icon", type: "color", default: "#9ca3af", label: "Icon Color" },
      {
        var: "--catpopup-sidebar-font-size",
        type: "range",
        default: 0.6875,
        min: 0.5,
        max: 2,
      ...
      {
        var: "--catpopup-sidebar-font-weight",
        type: "range",
        default: 400,
        min: 100,
        max: 900,
      ...
      {
        var: "--catpopup-sidebar-padding-x",
        type: "range",
        default: 0.125,
        min: 0,
        max: 3,
      ...
      {
        var: "--catpopup-sidebar-padding-y",
        type: "range",
        default: 0.25,
        min: 0,
        max: 2,
  ...
  },
  {
    ...
    tokens: [
      ...
      {
        var: "--topdeals-original-price-color",
        type: "color",
        default: "#9ca3af",
  ...
  },
  {
    ...
    tokens: [
      ...
      {
        var: "--product-font-family",
        type: "text",
        default:
          'Inter, "SF Pro Text", Roboto, "Helvetica Neue", Helvetica, Tahoma, Arial, "PingFang SC", "Microsoft YaHei", sans-serif',
        label: "Card Font Family",
      },
      ...
      {
        var: "--product-lens-shadow",
        type: "text",
        default: "0 2px 6px 2px rgba(0, 0, 0, 0.12)",
        label: "Lens Shadow",
      },
      ...
      {
        var: "--product-title-letter-spacing",
        type: "range",
        default: 0,
        min: -0.08,
        max: 0.1,
      ...
      {
        var: "--product-verified-color",
        type: "color",
        default: "#0b65c2",
        label: "Verified Color",
      },
      {
        var: "--product-verified-size",
        type: "range",
        default: 12,
        min: 8,
        max: 16,
      ...
      {
        var: "--product-supplier-color",
        type: "color",
        default: "#767676",
        label: "Supplier Info Color",
      },
      {
        var: "--product-supplier-size",
        type: "range",
        default: 12,
        min: 8,
        max: 16,
