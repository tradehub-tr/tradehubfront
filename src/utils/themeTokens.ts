...
export const componentEditors: ComponentEditor[] = [
  {
    ...
    outlineTokens: [
      ...
      { var: '--btn-outline-hover-bg', type: 'color', default: 'rgba(204, 153, 0, 0.08)', label: 'Outline Hover Background' },
      { var: '--btn-outline-hover-text', type: 'color', default: '#cc9900', label: 'Outline Hover Text' },
    ],
  },
  {
    id: 'card',
